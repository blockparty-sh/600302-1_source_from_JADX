...
import p015io.grpc.Attributes.Builder;
...
import p015io.grpc.internal.ServiceConfigUtil;

/* renamed from: io.grpc.util.RoundRobinLoadBalancer */
final class RoundRobinLoadBalancer extends LoadBalancer {
    private static final Status EMPTY_OK = Status.f678OK.withDescription("no subchannels ready");
    @VisibleForTesting
    static final C2669Key<Ref<ConnectivityStateInfo>> STATE_INFO = C2669Key.create("state-info");
    static final C2669Key<Ref<Subchannel>> STICKY_REF = C2669Key.create("sticky-ref");
    ...
    static final class ReadyPicker extends RoundRobinPicker {
        ...
        public p015io.grpc.LoadBalancer.PickResult pickSubchannel(p015io.grpc.LoadBalancer.PickSubchannelArgs r3) {
            /*
                r2 = this;
                ...
                boolean r1 = p015io.grpc.util.RoundRobinLoadBalancer.isReady(r0)
            ...
            L_0x0035:
                io.grpc.LoadBalancer$PickResult r3 = p015io.grpc.LoadBalancer.PickResult.withSubchannel(r0)
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.grpc.util.RoundRobinLoadBalancer.ReadyPicker.pickSubchannel(io.grpc.LoadBalancer$PickSubchannelArgs):io.grpc.LoadBalancer$PickResult");
        }
    ...
    public void handleResolvedAddresses(ResolvedAddresses resolvedAddresses) {
        ...
        for (EquivalentAddressGroup equivalentAddressGroup : set) {
            ...
            if (this.stickinessState != null) {
                C2669Key<Ref<Subchannel>> key = STICKY_REF;
