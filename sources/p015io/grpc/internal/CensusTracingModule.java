...
import p015io.grpc.ForwardingClientCall.SimpleForwardingClientCall;
import p015io.grpc.ForwardingClientCallListener.SimpleForwardingClientCallListener;
import p015io.grpc.Metadata;
import p015io.grpc.Metadata.BinaryMarshaller;
import p015io.grpc.Metadata.C2689Key;
import p015io.grpc.MethodDescriptor;
import p015io.grpc.ServerStreamTracer;
import p015io.grpc.ServerStreamTracer.ServerCallInfo;
import p015io.grpc.Status;
import p015io.opencensus.trace.BlankSpan;
import p015io.opencensus.trace.EndSpanOptions;
import p015io.opencensus.trace.MessageEvent;
import p015io.opencensus.trace.MessageEvent.Builder;
...
import p015io.opencensus.trace.Tracer;
import p015io.opencensus.trace.propagation.BinaryFormat;
import p015io.opencensus.trace.unsafe.ContextUtils;
...
final class CensusTracingModule {
    ...
    @VisibleForTesting
    final C2689Key<SpanContext> tracingHeader;
    ...
    private static final class ClientTracer extends ClientStreamTracer {
        ...
        public void outboundMessageSent(int i, long j, long j2) {
            CensusTracingModule.recordMessageEvent(this.span, C2900Type.SENT, i, j, j2);
        }

        public void inboundMessageRead(int i, long j, long j2) {
            CensusTracingModule.recordMessageEvent(this.span, C2900Type.RECEIVED, i, j, j2);
        }
    }
    ...
    CensusTracingModule(Tracer tracer, final BinaryFormat binaryFormat) {
        ...
        this.tracingHeader = C2689Key.m296of("grpc-trace-bin", (BinaryMarshaller<T>) new BinaryMarshaller<SpanContext>() {
    ...
    @VisibleForTesting
    static p015io.opencensus.trace.Status convertStatus(Status status) {
        p015io.opencensus.trace.Status status2;
        switch (status.getCode()) {
            case OK:
                status2 = p015io.opencensus.trace.Status.f685OK;
                break;
            case CANCELLED:
                status2 = p015io.opencensus.trace.Status.CANCELLED;
                break;
            case UNKNOWN:
                status2 = p015io.opencensus.trace.Status.UNKNOWN;
                break;
            case INVALID_ARGUMENT:
                status2 = p015io.opencensus.trace.Status.INVALID_ARGUMENT;
                break;
            case DEADLINE_EXCEEDED:
                status2 = p015io.opencensus.trace.Status.DEADLINE_EXCEEDED;
                break;
            case NOT_FOUND:
                status2 = p015io.opencensus.trace.Status.NOT_FOUND;
                break;
            case ALREADY_EXISTS:
                status2 = p015io.opencensus.trace.Status.ALREADY_EXISTS;
                break;
            case PERMISSION_DENIED:
                status2 = p015io.opencensus.trace.Status.PERMISSION_DENIED;
                break;
            case RESOURCE_EXHAUSTED:
                status2 = p015io.opencensus.trace.Status.RESOURCE_EXHAUSTED;
                break;
            case FAILED_PRECONDITION:
                status2 = p015io.opencensus.trace.Status.FAILED_PRECONDITION;
                break;
            case ABORTED:
                status2 = p015io.opencensus.trace.Status.ABORTED;
                break;
            case OUT_OF_RANGE:
                status2 = p015io.opencensus.trace.Status.OUT_OF_RANGE;
                break;
            case UNIMPLEMENTED:
                status2 = p015io.opencensus.trace.Status.UNIMPLEMENTED;
                break;
            case INTERNAL:
                status2 = p015io.opencensus.trace.Status.INTERNAL;
                break;
            case UNAVAILABLE:
                status2 = p015io.opencensus.trace.Status.UNAVAILABLE;
                break;
            case DATA_LOSS:
                status2 = p015io.opencensus.trace.Status.DATA_LOSS;
                break;
            case UNAUTHENTICATED:
                status2 = p015io.opencensus.trace.Status.UNAUTHENTICATED;
                break;
            default:
    ...
    /* access modifiers changed from: private */
    public static void recordMessageEvent(Span span, C2900Type type, int i, long j, long j2) {
