...
import p015io.grpc.InternalStatus;
import p015io.grpc.Metadata;
import p015io.grpc.Status;

/* renamed from: io.grpc.internal.AbstractServerStream */
public abstract class AbstractServerStream extends AbstractStream implements ServerStream, p015io.grpc.internal.MessageFramer.Sink {
    ...
    protected static abstract class TransportState extends p015io.grpc.internal.AbstractStream.TransportState {
        ...
        public void complete() {
            if (this.deframerClosed) {
                this.deframerClosedTask = null;
                closeListener(Status.f678OK);
                return;
            }
            this.deframerClosedTask = new Runnable() {
                public void run() {
                    TransportState.this.closeListener(Status.f678OK);
                }
            };
            this.immediateCloseRequested = true;
            closeDeframer(true);
