...
public class Context {
    ...
    private static final PersistentHashArrayMappedTrie<C2679Key<?>, Object> EMPTY_ENTRIES = new PersistentHashArrayMappedTrie<>();
    ...
    final PersistentHashArrayMappedTrie<C2679Key<?>, Object> keyValueEntries;
    ...
    public static final class CancellableContext extends Context implements Closeable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:8:0x000d, code lost:
            if (p015io.grpc.Context.super.isCancelled() == false) goto L_0x0017;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:9:0x000f, code lost:
            cancel(p015io.grpc.Context.super.cancellationCause());
         */
        ...
        public boolean isCancelled() {
            ...
            L_0x0008:
                monitor-exit(r2)     // Catch:{ all -> 0x0019 }
                boolean r0 = p015io.grpc.Context.super.isCancelled()
                if (r0 == 0) goto L_0x0017
                java.lang.Throwable r0 = p015io.grpc.Context.super.cancellationCause()
                r2.cancel(r0)
                return r1
            L_0x0017:
                r0 = 0
            ...
            L_0x0019:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.grpc.Context.CancellableContext.isCancelled():boolean");
        }
    ...
    public static final class C2679Key<T> {
    ...
    public static <T> C2679Key<T> key(String str) {
        return new C2679Key<>(str);
    }

    public static <T> C2679Key<T> keyWithDefault(String str, T t) {
        return new C2679Key<>(str, t);
    }
    ...
    private Context(PersistentHashArrayMappedTrie<C2679Key<?>, Object> persistentHashArrayMappedTrie, int i) {
    ...
    private Context(Context context, PersistentHashArrayMappedTrie<C2679Key<?>, Object> persistentHashArrayMappedTrie) {
        int i;
        this.parentListener = new ParentListener();
    ...
    public <V> Context withValue(C2679Key<V> key, V v) {
        return new Context(this, this.keyValueEntries.put(key, v));
    }

    public <V1, V2> Context withValues(C2679Key<V1> key, V1 v1, C2679Key<V2> key2, V2 v2) {
        return new Context(this, this.keyValueEntries.put(key, v1).put(key2, v2));
    }

    public <V1, V2, V3> Context withValues(C2679Key<V1> key, V1 v1, C2679Key<V2> key2, V2 v2, C2679Key<V3> key3, V3 v3) {
        return new Context(this, this.keyValueEntries.put(key, v1).put(key2, v2).put(key3, v3));
    }

    public <V1, V2, V3, V4> Context withValues(C2679Key<V1> key, V1 v1, C2679Key<V2> key2, V2 v2, C2679Key<V3> key3, V3 v3, C2679Key<V4> key4, V4 v4) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0026, code lost:
        if ((((p015io.grpc.Context.ExecutableListener) r0.get(r2)).listener instanceof p015io.grpc.Context.ParentListener) != false) goto L_0x0031;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0028, code lost:
        ((p015io.grpc.Context.ExecutableListener) r0.get(r2)).deliver();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0044, code lost:
        if ((((p015io.grpc.Context.ExecutableListener) r0.get(r1)).listener instanceof p015io.grpc.Context.ParentListener) == false) goto L_0x004f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0046, code lost:
        ((p015io.grpc.Context.ExecutableListener) r0.get(r1)).deliver();
     */
    ...
    public void notifyAndClearListeners() {
        ...
        L_0x0016:
            ...
            io.grpc.Context$ExecutableListener r3 = (p015io.grpc.Context.ExecutableListener) r3
            io.grpc.Context$CancellationListener r3 = r3.listener
            boolean r3 = r3 instanceof p015io.grpc.Context.ParentListener
        ...
        L_0x0034:
            ...
            io.grpc.Context$ExecutableListener r2 = (p015io.grpc.Context.ExecutableListener) r2
            io.grpc.Context$CancellationListener r2 = r2.listener
            boolean r2 = r2 instanceof p015io.grpc.Context.ParentListener
        ...
        L_0x005c:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p015io.grpc.Context.notifyAndClearListeners():void");
    }
    ...
    /* access modifiers changed from: 0000 */
    public Object lookup(C2679Key<?> key) {
