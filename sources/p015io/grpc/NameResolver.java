...
public abstract class NameResolver {
    ...
    public static abstract class Factory {
        @Deprecated
        public static final C2669Key<Integer> PARAMS_DEFAULT_PORT = C2669Key.create("params-default-port");
        @Deprecated
        private static final C2669Key<ServiceConfigParser> PARAMS_PARSER = C2669Key.create("params-parser");
        @ExperimentalApi("https://github.com/grpc/grpc-java/issues/5113")
        @Deprecated
        public static final C2669Key<ProxyDetector> PARAMS_PROXY_DETECTOR = C2669Key.create("params-proxy-detector");
        @Deprecated
        private static final C2669Key<SynchronizationContext> PARAMS_SYNC_CONTEXT = C2669Key.create("params-sync-context");
