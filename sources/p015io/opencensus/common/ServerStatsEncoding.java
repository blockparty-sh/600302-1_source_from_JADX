...
import p015io.opencensus.common.ServerStatsFieldEnums.C2864Id;
...
public final class ServerStatsEncoding {
    ...
    static /* synthetic */ class C28631 {
        static final /* synthetic */ int[] $SwitchMap$io$opencensus$common$ServerStatsFieldEnums$Id = new int[C2864Id.values().length];
        ...
        static {
            /*
                io.opencensus.common.ServerStatsFieldEnums$Id[] r0 = p015io.opencensus.common.ServerStatsFieldEnums.C2864Id.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                ...
                io.opencensus.common.ServerStatsFieldEnums$Id r1 = p015io.opencensus.common.ServerStatsFieldEnums.C2864Id.SERVER_STATS_LB_LATENCY_ID     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$io$opencensus$common$ServerStatsFieldEnums$Id     // Catch:{ NoSuchFieldError -> 0x001f }
                io.opencensus.common.ServerStatsFieldEnums$Id r1 = p015io.opencensus.common.ServerStatsFieldEnums.C2864Id.SERVER_STATS_SERVICE_LATENCY_ID     // Catch:{ NoSuchFieldError -> 0x001f }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001f }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001f }
            L_0x001f:
                int[] r0 = $SwitchMap$io$opencensus$common$ServerStatsFieldEnums$Id     // Catch:{ NoSuchFieldError -> 0x002a }
                io.opencensus.common.ServerStatsFieldEnums$Id r1 = p015io.opencensus.common.ServerStatsFieldEnums.C2864Id.SERVER_STATS_TRACE_OPTION_ID     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p015io.opencensus.common.ServerStatsEncoding.C28631.<clinit>():void");
        }
    }
    ...
    public static byte[] toBytes(ServerStats serverStats) {
        ...
        allocate.put(0);
        allocate.put((byte) C2864Id.SERVER_STATS_LB_LATENCY_ID.value());
        allocate.putLong(serverStats.getLbLatencyNs());
        allocate.put((byte) C2864Id.SERVER_STATS_SERVICE_LATENCY_ID.value());
        allocate.putLong(serverStats.getServiceLatencyNs());
        allocate.put((byte) C2864Id.SERVER_STATS_TRACE_OPTION_ID.value());
    ...
    public static ServerStats parseBytes(byte[] bArr) throws ServerStatsDeserializationException {
        ...
        if (wrap.hasRemaining()) {
            ...
            while (wrap.hasRemaining()) {
                C2864Id valueOf = C2864Id.valueOf((int) wrap.get() & 255);
                if (valueOf == null) {
                    wrap.position(wrap.limit());
                } else {
                    int i = C28631.$SwitchMap$io$opencensus$common$ServerStatsFieldEnums$Id[valueOf.ordinal()];
                    if (i == 1) {
                        j = wrap.getLong();
                    } else if (i == 2) {
                        j2 = wrap.getLong();
