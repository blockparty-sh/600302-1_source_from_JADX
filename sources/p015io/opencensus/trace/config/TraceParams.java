...
import p015io.opencensus.trace.samplers.Samplers;
...
public abstract class TraceParams {
    ...
    public static abstract class Builder {
        ...
        public TraceParams build() {
            ...
            boolean z = true;
            C2865Utils.checkArgument(autoBuild.getMaxNumberOfAttributes() > 0, "maxNumberOfAttributes");
            C2865Utils.checkArgument(autoBuild.getMaxNumberOfAnnotations() > 0, "maxNumberOfAnnotations");
            C2865Utils.checkArgument(autoBuild.getMaxNumberOfMessageEvents() > 0, "maxNumberOfMessageEvents");
            if (autoBuild.getMaxNumberOfLinks() <= 0) {
                z = false;
            }
            C2865Utils.checkArgument(z, "maxNumberOfLinks");
            return autoBuild;
        }
    }
