...
final class AutoValue_MessageEvent extends MessageEvent {
    ...
    static final class Builder extends p015io.opencensus.trace.MessageEvent.Builder {
        ...
        public p015io.opencensus.trace.MessageEvent.Builder setType(C2900Type type2) {
            if (type2 != null) {
                this.type = type2;
                return this;
            }
        ...
        /* access modifiers changed from: 0000 */
        public p015io.opencensus.trace.MessageEvent.Builder setMessageId(long j) {
            this.messageId = Long.valueOf(j);
            return this;
        }

        public p015io.opencensus.trace.MessageEvent.Builder setUncompressedMessageSize(long j) {
            this.uncompressedMessageSize = Long.valueOf(j);
            return this;
        }

        public p015io.opencensus.trace.MessageEvent.Builder setCompressedMessageSize(long j) {
    ...
    private AutoValue_MessageEvent(C2900Type type2, long j, long j2, long j3) {
        this.type = type2;
        this.messageId = j;
