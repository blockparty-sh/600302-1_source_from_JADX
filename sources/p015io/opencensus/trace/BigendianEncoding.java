...
final class BigendianEncoding {
    ...
    static long longFromByteArray(byte[] bArr, int i) {
        C2865Utils.checkArgument(bArr.length >= i + 8, "array too small");
    ...
    static long longFromBase16String(CharSequence charSequence, int i) {
        C2865Utils.checkArgument(charSequence.length() >= i + 16, "chars too small");
    ...
    static byte byteFromBase16String(CharSequence charSequence, int i) {
        C2865Utils.checkArgument(charSequence.length() >= i + 2, "chars too small");
    ...
    private static byte decodeByte(char c, char c2) {
        ...
        sb.append(str);
        sb.append(c2);
        C2865Utils.checkArgument(z2, sb.toString());
        ...
        sb2.append(str);
        sb2.append(c);
        C2865Utils.checkArgument(z, sb2.toString());
        byte[] bArr = DECODING;
