...
import p015io.opencensus.trace.Link.C2899Type;
...
final class AutoValue_Link extends Link {
    ...
    private final C2899Type type;

    AutoValue_Link(TraceId traceId2, SpanId spanId2, C2899Type type2, Map<String, AttributeValue> map) {
        if (traceId2 != null) {
