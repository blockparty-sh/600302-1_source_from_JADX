...
final class AutoValue_NetworkEvent extends NetworkEvent {
    ...
    private final C2901Type type;
    private final long uncompressedMessageSize;

    /* renamed from: io.opencensus.trace.AutoValue_NetworkEvent$Builder */
    static final class Builder extends p015io.opencensus.trace.NetworkEvent.Builder {
        private Long compressedMessageSize;
        private Timestamp kernelTimestamp;
        private Long messageId;
        private C2901Type type;
        private Long uncompressedMessageSize;

        Builder() {
        }

        public p015io.opencensus.trace.NetworkEvent.Builder setKernelTimestamp(@Nullable Timestamp timestamp) {
            this.kernelTimestamp = timestamp;
            return this;
        }

        /* access modifiers changed from: 0000 */
        public p015io.opencensus.trace.NetworkEvent.Builder setType(C2901Type type2) {
            if (type2 != null) {
                this.type = type2;
                return this;
            }
        ...
        /* access modifiers changed from: 0000 */
        public p015io.opencensus.trace.NetworkEvent.Builder setMessageId(long j) {
            this.messageId = Long.valueOf(j);
            return this;
        }

        public p015io.opencensus.trace.NetworkEvent.Builder setUncompressedMessageSize(long j) {
            this.uncompressedMessageSize = Long.valueOf(j);
            return this;
        }

        public p015io.opencensus.trace.NetworkEvent.Builder setCompressedMessageSize(long j) {
    ...
    private AutoValue_NetworkEvent(@Nullable Timestamp timestamp, C2901Type type2, long j, long j2, long j3) {
        this.kernelTimestamp = timestamp;
        this.type = type2;
        this.messageId = j;
    ...
    public boolean equals(java.lang.Object r8) {
        /*
            ...
            return r0
        L_0x0004:
            boolean r1 = r8 instanceof p015io.opencensus.trace.NetworkEvent
            r2 = 0
            if (r1 == 0) goto L_0x004d
            io.opencensus.trace.NetworkEvent r8 = (p015io.opencensus.trace.NetworkEvent) r8
        ...
        L_0x004d:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p015io.opencensus.trace.AutoValue_NetworkEvent.equals(java.lang.Object):boolean");
    }
