...
public abstract class Tracestate {
    ...
    public static final class Builder {
        ...
        private Builder(Tracestate tracestate) {
            C2865Utils.checkNotNull(tracestate, "parent");
    ...
    public static abstract class Entry {
        ...
        public static Entry create(String str, String str2) {
            C2865Utils.checkNotNull(str, "key");
            C2865Utils.checkNotNull(str2, "value");
            C2865Utils.checkArgument(Tracestate.validateKey(str), "Invalid key %s", str);
            C2865Utils.checkArgument(Tracestate.validateValue(str2), "Invalid value %s", str2);
    ...
    public static Tracestate create(List<Entry> list) {
        C2865Utils.checkState(list.size() <= 32, "Invalid size");
