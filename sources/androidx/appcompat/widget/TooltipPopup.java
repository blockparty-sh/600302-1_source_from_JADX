...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0046R.layout.abc_tooltip, null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0046R.C0049id.message);
        ...
        layoutParams.windowAnimations = C0046R.C0051style.Animation_AppCompat_Tooltip;
