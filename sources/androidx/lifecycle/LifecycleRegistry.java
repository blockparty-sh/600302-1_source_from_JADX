...
public class LifecycleRegistry extends Lifecycle {
    ...
    static /* synthetic */ class C03851 {
        ...
        static {
            ...
            L_0x0091:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.LifecycleRegistry.C03851.<clinit>():void");
        }
    }
    ...
    private static Event downEvent(State state) {
        int i = C03851.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
