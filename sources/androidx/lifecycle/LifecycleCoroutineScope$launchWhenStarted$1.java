...
@DebugMetadata(mo37999c = "androidx.lifecycle.LifecycleCoroutineScope$launchWhenStarted$1", mo38000f = "Lifecycle.kt", mo38001i = {0}, mo38002l = {85}, mo38003m = "invokeSuspend", mo38004n = {"$this$launch"}, mo38005s = {"L$0"})
...
final class LifecycleCoroutineScope$launchWhenStarted$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        lifecycleCoroutineScope$launchWhenStarted$1.f60p$ = (CoroutineScope) obj;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            CoroutineScope coroutineScope = this.f60p$;
            Lifecycle lifecycle$lifecycle_runtime_ktx_release = this.this$0.getLifecycle$lifecycle_runtime_ktx_release();
            Function2 function2 = this.$block;
            this.L$0 = coroutineScope;
            this.label = 1;
            if (PausingDispatcherKt.whenStarted(lifecycle$lifecycle_runtime_ktx_release, function2, (Continuation<? super T>) this) == coroutine_suspended) {
