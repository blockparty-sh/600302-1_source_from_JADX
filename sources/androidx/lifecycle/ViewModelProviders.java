...
public class ViewModelProviders {
    ...
    public static ViewModelProvider m16of(@NonNull Fragment fragment) {
        return m17of(fragment, (Factory) null);
    }
    ...
    public static ViewModelProvider m18of(@NonNull FragmentActivity fragmentActivity) {
        return m19of(fragmentActivity, (Factory) null);
    }

    @MainThread
    @NonNull
    /* renamed from: of */
    public static ViewModelProvider m17of(@NonNull Fragment fragment, @Nullable Factory factory) {
    ...
    @NonNull
    /* renamed from: of */
    public static ViewModelProvider m19of(@NonNull FragmentActivity fragmentActivity, @Nullable Factory factory) {
