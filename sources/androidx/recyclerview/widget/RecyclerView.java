...
import androidx.recyclerview.C0558R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        public void offsetChildrenHorizontal(@C0045Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public void offsetChildrenVertical(@C0045Px int i) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0558R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0558R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0558R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0558R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0558R.styleable.RecyclerView_stackFromEnd, false);
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@C0045Px int i, @C0045Px int i2) {
                this(i, i2, Integer.MIN_VALUE, null);
            }

            public Action(@C0045Px int i, @C0045Px int i2, int i3) {
                this(i, i2, i3, null);
            }

            public Action(@C0045Px int i, @C0045Px int i2, int i3, @Nullable Interpolator interpolator) {
            ...
            public void setDx(@C0045Px int i) {
                this.mChanged = true;
                this.mDx = i;
            }
            ...
            public void setDy(@C0045Px int i) {
                this.mChanged = true;
                this.mDy = i;
            }
            ...
            public void update(@C0045Px int i, @C0045Px int i2, int i3, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i2;
                this.mDuration = i3;
                this.mInterpolator = interpolator;
        ...
        /* access modifiers changed from: protected */
        public abstract void onSeekTargetStep(@C0045Px int i, @C0045Px int i2, @NonNull State state, @NonNull Action action);
    ...
    public static abstract class ViewHolder {
        ...
        public void clearPayload() {
            ...
            this.mFlags &= RESULT.E_TEEKM_JSON_OUT_ADDR_LEN;
        }
    ...
    public void onScrolled(@C0045Px int i, @C0045Px int i2) {
    }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet2 != null) {
            TypedArray obtainStyledAttributes2 = context2.obtainStyledAttributes(attributeSet2, C0558R.styleable.RecyclerView, i3, 0);
            if (VERSION.SDK_INT >= 29) {
                i2 = 29;
                saveAttributeDataForStyleable(context, C0558R.styleable.RecyclerView, attributeSet, obtainStyledAttributes2, i, 0);
            } else {
                i2 = 29;
            }
            String string = obtainStyledAttributes2.getString(C0558R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0558R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0558R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0558R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0558R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0558R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0558R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    public void smoothScrollBy(@C0045Px int i, @C0045Px int i2) {
        smoothScrollBy(i, i2, null, Integer.MIN_VALUE, false);
    }

    public void smoothScrollBy(@C0045Px int i, @C0045Px int i2, @Nullable Interpolator interpolator) {
        smoothScrollBy(i, i2, interpolator, Integer.MIN_VALUE, false);
    }

    public void smoothScrollBy(@C0045Px int i, @C0045Px int i2, @Nullable Interpolator interpolator, int i3) {
        smoothScrollBy(i, i2, interpolator, i3, false);
    }

    /* access modifiers changed from: 0000 */
    public void smoothScrollBy(@C0045Px int i, @C0045Px int i2, @Nullable Interpolator interpolator, int i3, boolean z) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            Log.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
        } else if (!this.mLayoutSuppressed) {
    ...
    public View focusSearch(View view, int i) {
        ...
        if (!z2 || !(i == 2 || i == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                int i2 = i == 2 ? ScriptOpCodes.OP_SIZE : 33;
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0558R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0558R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0558R.dimen.fastscroll_margin));
    }
