...
public final class NavInflater {
    ...
    private void inflateArgumentForDestination(@NonNull Resources resources, @NonNull NavDestination navDestination, @NonNull AttributeSet attributeSet, int i) throws XmlPullParserException {
        TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, C0476R.styleable.NavArgument);
        String string = obtainAttributes.getString(C0476R.styleable.NavArgument_android_name);
        if (string != null) {
    ...
    private NavArgument inflateArgument(@NonNull TypedArray typedArray, @NonNull Resources resources, int i) throws XmlPullParserException {
        ...
        boolean z = false;
        builder.setIsNullable(typedArray.getBoolean(C0476R.styleable.NavArgument_nullable, false));
        TypedValue typedValue = (TypedValue) sTmpValue.get();
        if (typedValue == null) {
            typedValue = new TypedValue();
            sTmpValue.set(typedValue);
        }
        String string = typedArray.getString(C0476R.styleable.NavArgument_argType);
        Object obj = null;
        NavType<Integer> fromArgType = string != null ? NavType.fromArgType(string, resources.getResourcePackageName(i)) : null;
        if (typedArray.getValue(C0476R.styleable.NavArgument_android_defaultValue, typedValue)) {
            String str = "' for ";
            ...
            if (fromArgType == NavType.ReferenceType) {
                ...
                obj = typedArray.getString(C0476R.styleable.NavArgument_android_defaultValue);
            } else {
                ...
                if (i2 == 3) {
                    ...
                    fromArgType = checkNavType(typedValue, fromArgType, NavType.FloatType, string, Kinds.FLOAT);
                    ...
                    fromArgType = checkNavType(typedValue, fromArgType, NavType.IntType, string, Kinds.INT);
    ...
    private void inflateDeepLink(@NonNull Resources resources, @NonNull NavDestination navDestination, @NonNull AttributeSet attributeSet) {
        TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, C0476R.styleable.NavDeepLink);
        String string = obtainAttributes.getString(C0476R.styleable.NavDeepLink_uri);
    ...
    private void inflateAction(@NonNull Resources resources, @NonNull NavDestination navDestination, @NonNull AttributeSet attributeSet, XmlResourceParser xmlResourceParser, int i) throws IOException, XmlPullParserException {
        TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, C0476R.styleable.NavAction);
        int resourceId = obtainAttributes.getResourceId(C0476R.styleable.NavAction_android_id, 0);
        NavAction navAction = new NavAction(obtainAttributes.getResourceId(C0476R.styleable.NavAction_destination, 0));
        NavOptions.Builder builder = new NavOptions.Builder();
        builder.setLaunchSingleTop(obtainAttributes.getBoolean(C0476R.styleable.NavAction_launchSingleTop, false));
        builder.setPopUpTo(obtainAttributes.getResourceId(C0476R.styleable.NavAction_popUpTo, -1), obtainAttributes.getBoolean(C0476R.styleable.NavAction_popUpToInclusive, false));
        builder.setEnterAnim(obtainAttributes.getResourceId(C0476R.styleable.NavAction_enterAnim, -1));
        builder.setExitAnim(obtainAttributes.getResourceId(C0476R.styleable.NavAction_exitAnim, -1));
        builder.setPopEnterAnim(obtainAttributes.getResourceId(C0476R.styleable.NavAction_popEnterAnim, -1));
        builder.setPopExitAnim(obtainAttributes.getResourceId(C0476R.styleable.NavAction_popExitAnim, -1));
