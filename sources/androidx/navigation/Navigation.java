...
public final class Navigation {
    ...
    @NonNull
    public static OnClickListener createNavigateOnClickListener(@IdRes int i) {
        return createNavigateOnClickListener(i, null);
    }

    @NonNull
    public static OnClickListener createNavigateOnClickListener(@IdRes final int i, @Nullable final Bundle bundle) {
    ...
    @NonNull
    public static OnClickListener createNavigateOnClickListener(@NonNull final NavDirections navDirections) {
        return new OnClickListener() {
            public void onClick(View view) {
