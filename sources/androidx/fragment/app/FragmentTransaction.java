...
public abstract class FragmentTransaction {
    ...
    @Nullable
    String mName;
    ArrayList<C0331Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0331Op {
        ...
        C0331Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0331Op(int i, @NonNull Fragment fragment, State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    public FragmentTransaction remove(@NonNull Fragment fragment) {
        addOp(new C0331Op(3, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        addOp(new C0331Op(4, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction show(@NonNull Fragment fragment) {
        addOp(new C0331Op(5, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction detach(@NonNull Fragment fragment) {
        addOp(new C0331Op(6, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction attach(@NonNull Fragment fragment) {
        addOp(new C0331Op(7, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0331Op(8, fragment));
        return this;
    }

    @NonNull
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull State state) {
        addOp(new C0331Op(10, fragment, state));
        return this;
    }
