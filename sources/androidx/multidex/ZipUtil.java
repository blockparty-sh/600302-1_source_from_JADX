        ...
        if (length >= 0) {
            ...
            do {
                ...
                if (randomAccessFile.readInt() == reverseBytes) {
                    ...
                    centralDirectory.size = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & TransactionInput.NO_SEQUENCE;
                    centralDirectory.offset = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & TransactionInput.NO_SEQUENCE;
