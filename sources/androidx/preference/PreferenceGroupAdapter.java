...
public class PreferenceGroupAdapter extends Adapter<PreferenceViewHolder> implements OnPreferenceChangeInternalListener, PreferencePositionCallback {
    ...
    public PreferenceViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        TypedArray obtainStyledAttributes = viewGroup.getContext().obtainStyledAttributes(null, C0544R.styleable.BackgroundStyle);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0544R.styleable.BackgroundStyle_android_selectableItemBackground);
        if (drawable == null) {
