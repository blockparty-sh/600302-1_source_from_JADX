...
public abstract class PreferenceGroup extends Preference {
    ...
    public PreferenceGroup(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0544R.styleable.PreferenceGroup, i, i2);
        this.mOrderingAsAdded = TypedArrayUtils.getBoolean(obtainStyledAttributes, C0544R.styleable.PreferenceGroup_orderingFromXml, C0544R.styleable.PreferenceGroup_orderingFromXml, true);
        if (obtainStyledAttributes.hasValue(C0544R.styleable.PreferenceGroup_initialExpandedChildrenCount)) {
            setInitialExpandedChildrenCount(TypedArrayUtils.getInt(obtainStyledAttributes, C0544R.styleable.PreferenceGroup_initialExpandedChildrenCount, C0544R.styleable.PreferenceGroup_initialExpandedChildrenCount, Integer.MAX_VALUE));
        }
    ...
    public <T extends Preference> T findPreference(@NonNull CharSequence charSequence) {
        if (charSequence == null) {
            ...
            for (int i = 0; i < preferenceCount; i++) {
                ...
                if (preference instanceof PreferenceGroup) {
                    T findPreference = ((PreferenceGroup) preference).findPreference(charSequence);
                    if (findPreference != null) {
