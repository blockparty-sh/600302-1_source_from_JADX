...
public class WorkTypeConverters {
    ...
    static /* synthetic */ class C08021 {
        ...
        static {
            ...
            L_0x00a3:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.model.WorkTypeConverters.C08021.<clinit>():void");
        }
    }
    ...
    public static int backoffPolicyToInt(BackoffPolicy backoffPolicy) {
        int i = C08021.$SwitchMap$androidx$work$BackoffPolicy[backoffPolicy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public static int networkTypeToInt(NetworkType networkType) {
        int i = C08021.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
