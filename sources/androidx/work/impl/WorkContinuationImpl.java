...
public class WorkContinuationImpl extends WorkContinuation {
    ...
    public WorkContinuation then(@NonNull List<OneTimeWorkRequest> list) {
        WorkContinuationImpl workContinuationImpl = new WorkContinuationImpl(this.mWorkManagerImpl, this.mName, ExistingWorkPolicy.KEEP, list, Collections.singletonList(this));
    ...
    public WorkContinuation combineInternal(@NonNull List<WorkContinuation> list) {
        ...
        WorkContinuationImpl workContinuationImpl = new WorkContinuationImpl(this.mWorkManagerImpl, null, ExistingWorkPolicy.KEEP, Collections.singletonList(oneTimeWorkRequest), arrayList);
        return workContinuationImpl;
    }
