...
class SystemJobInfoConverter {
    ...
    static /* synthetic */ class C07811 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.background.systemjob.SystemJobInfoConverter.C07811.<clinit>():void");
        }
    }
    ...
    public JobInfo convert(WorkSpec workSpec, int i) {
        ...
        persistableBundle.putString(EXTRA_WORK_SPEC_ID, workSpec.f87id);
    ...
    static int convertNetworkType(NetworkType networkType) {
        int i = C07811.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
