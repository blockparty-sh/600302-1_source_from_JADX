    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new Delegate(6) {
            ...
            public void validateMigration(SupportSQLiteDatabase supportSQLiteDatabase) {
                ...
                String str4 = CommonProperties.f657ID;
                ForeignKey foreignKey = new ForeignKey("WorkSpec", "CASCADE", "CASCADE", asList, Arrays.asList(new String[]{str4}));
                hashSet.add(foreignKey);
                ForeignKey foreignKey2 = new ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList(new String[]{str3}), Arrays.asList(new String[]{str4}));
                ...
                if (tableInfo.equals(read)) {
                    ...
                    hashMap2.put(str4, new Column(str4, str, true, 1));
                    String str7 = Params.STATE;
                    String str8 = "INTEGER";
                    hashMap2.put(str7, new Column(str7, str8, true, 0));
                    String str9 = "worker_class_name";
                    hashMap2.put(str9, new Column(str9, str, true, 0));
                    String str10 = "input_merger_class_name";
                    hashMap2.put(str10, new Column(str10, str, false, 0));
                    String str11 = "BLOB";
                    hashMap2.put("input", new Column("input", str11, true, 0));
                    hashMap2.put("output", new Column("output", str11, true, 0));
                    hashMap2.put("initial_delay", new Column("initial_delay", str8, true, 0));
                    hashMap2.put("interval_duration", new Column("interval_duration", str8, true, 0));
                    hashMap2.put("flex_duration", new Column("flex_duration", str8, true, 0));
                    hashMap2.put("run_attempt_count", new Column("run_attempt_count", str8, true, 0));
                    hashMap2.put("backoff_policy", new Column("backoff_policy", str8, true, 0));
                    hashMap2.put("backoff_delay_duration", new Column("backoff_delay_duration", str8, true, 0));
                    hashMap2.put("period_start_time", new Column("period_start_time", str8, true, 0));
                    hashMap2.put("minimum_retention_duration", new Column("minimum_retention_duration", str8, true, 0));
                    String str12 = "schedule_requested_at";
                    hashMap2.put(str12, new Column(str12, str8, true, 0));
                    hashMap2.put("required_network_type", new Column("required_network_type", str8, false, 0));
                    hashMap2.put("requires_charging", new Column("requires_charging", str8, true, 0));
                    hashMap2.put("requires_device_idle", new Column("requires_device_idle", str8, true, 0));
                    hashMap2.put("requires_battery_not_low", new Column("requires_battery_not_low", str8, true, 0));
                    hashMap2.put("requires_storage_not_low", new Column("requires_storage_not_low", str8, true, 0));
                    hashMap2.put("trigger_content_update_delay", new Column("trigger_content_update_delay", str8, true, 0));
                    hashMap2.put("trigger_max_content_delay", new Column("trigger_max_content_delay", str8, true, 0));
                    hashMap2.put("content_uri_triggers", new Column("content_uri_triggers", str11, false, 0));
                    HashSet hashSet3 = new HashSet(0);
                    HashSet hashSet4 = new HashSet(1);
                    hashSet4.add(new Index("index_WorkSpec_schedule_requested_at", false, Arrays.asList(new String[]{str12})));
                    ...
                    if (tableInfo2.equals(read2)) {
                        ...
                        ForeignKey foreignKey3 = new ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList(new String[]{str2}), Arrays.asList(new String[]{str4}));
                        hashSet5.add(foreignKey3);
                        HashSet hashSet6 = new HashSet(1);
                        hashSet6.add(new Index("index_WorkTag_work_spec_id", false, Arrays.asList(new String[]{str2})));
                        ...
                        if (tableInfo3.equals(read3)) {
                            ...
                            hashMap4.put("system_id", new Column("system_id", str8, true, 0));
                            HashSet hashSet7 = new HashSet(1);
                            ForeignKey foreignKey4 = new ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList(new String[]{str2}), Arrays.asList(new String[]{str4}));
                            ...
                            if (tableInfo4.equals(read4)) {
                                ...
                                hashMap5.put("name", new Column("name", str, true, 1));
                                hashMap5.put(str2, new Column(str2, str, true, 2));
                                HashSet hashSet8 = new HashSet(1);
                                ForeignKey foreignKey5 = new ForeignKey("WorkSpec", "CASCADE", "CASCADE", Arrays.asList(new String[]{str2}), Arrays.asList(new String[]{str4}));
