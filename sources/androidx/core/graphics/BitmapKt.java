...
public final class BitmapKt {
    ...
    @NotNull
    public static /* synthetic */ Bitmap createBitmap$default(int i, int i2, Config config, int i3, Object obj) {
        if ((i3 & 4) != 0) {
    ...
    @NotNull
    public static final Bitmap createBitmap(int i, int i2, @NotNull Config config) {
        Intrinsics.checkParameterIsNotNull(config, "config");
        Bitmap createBitmap = Bitmap.createBitmap(i, i2, config);
        Intrinsics.checkExpressionValueIsNotNull(createBitmap, "Bitmap.createBitmap(width, height, config)");
        return createBitmap;
    ...
    @RequiresApi(26)
    @NotNull
    public static /* synthetic */ Bitmap createBitmap$default(int i, int i2, Config config, boolean z, ColorSpace colorSpace, int i3, Object obj) {
        if ((i3 & 4) != 0) {
            config = Config.ARGB_8888;
        }
        if ((i3 & 8) != 0) {
    ...
    @RequiresApi(26)
    @NotNull
    public static final Bitmap createBitmap(int i, int i2, @NotNull Config config, boolean z, @NotNull ColorSpace colorSpace) {
        Intrinsics.checkParameterIsNotNull(config, "config");
        Intrinsics.checkParameterIsNotNull(colorSpace, "colorSpace");
        Bitmap createBitmap = Bitmap.createBitmap(i, i2, config, z, colorSpace);
        Intrinsics.checkExpressionValueIsNotNull(createBitmap, "Bitmap.createBitmap(widt…ig, hasAlpha, colorSpace)");
