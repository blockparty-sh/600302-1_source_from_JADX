    ...
    public boolean executeKeyEvent(@NonNull KeyEvent keyEvent) {
        ...
        if (!canScroll) {
            if (isFocused() && keyEvent.getKeyCode() != 4) {
                ...
                View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, ScriptOpCodes.OP_SIZE);
                if (!(findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(ScriptOpCodes.OP_SIZE))) {
                    z = true;
                }
            }
            return z;
        ...
        if (keyEvent.getAction() == 0) {
            ...
            if (keyCode == 19) {
                ...
                z = !keyEvent.isAltPressed() ? arrowScroll(ScriptOpCodes.OP_SIZE) : fullScroll(ScriptOpCodes.OP_SIZE);
            } else if (keyCode == 62) {
