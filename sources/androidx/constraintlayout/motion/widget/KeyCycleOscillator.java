...
public abstract class KeyCycleOscillator {
    ...
    static class CycleOscillator {
        ...
        public void setup(float f) {
            this.mPathLength = f;
            double[][] dArr = (double[][]) Array.newInstance(double.class, new int[]{this.mPosition.length, 2});
    ...
    static class ProgressSet extends KeyCycleOscillator {
        ...
        public void setProperty(View view, float f) {
            ...
            String str2 = KeyCycleOscillator.TAG;
    ...
    public String toString() {
        ...
        while (it.hasNext()) {
            ...
            sb.append(" , ");
            sb.append(decimalFormat.format((double) wavePoint.mValue));
            sb.append("] ");
            str = sb.toString();
        }
        return str;
    ...
    public void setup(float f) {
        ...
        if (size != 0) {
            ...
            while (it.hasNext()) {
                ...
                dArr2[i][0] = (double) wavePoint.mValue;
                dArr2[i][1] = (double) wavePoint.mOffset;
