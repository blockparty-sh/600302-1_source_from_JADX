...
public class MonotonicCurveFit extends CurveFit {
    ...
    public MonotonicCurveFit(double[] dArr, double[][] dArr2) {
        ...
        int i = length - 1;
        double[][] dArr5 = (double[][]) Array.newInstance(double.class, new int[]{i, length2});
        double[][] dArr6 = (double[][]) Array.newInstance(double.class, new int[]{length, length2});
    ...
    public void getPos(double d, double[] dArr) {
        ...
        int i = 0;
        int length2 = this.f26mY[0].length;
        if (d <= dArr2[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                dArr[i2] = this.f26mY[0][i2];
            }
            return;
        }
        int i3 = length - 1;
    ...
    public void getPos(double d, float[] fArr) {
        ...
        while (i4 < i3) {
            if (d == this.f25mT[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f26mY[i4][i5];
                }
            }
            double[] dArr2 = this.f25mT;
            int i6 = i4 + 1;
    ...
    public double getPos(double d, int i) {
        ...
        int i2 = 0;
        if (d <= dArr[0]) {
            return this.f26mY[0][i];
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            return this.f26mY[i3][i];
        }
        while (i2 < i3) {
            double[] dArr2 = this.f25mT;
            if (d == dArr2[i2]) {
                return this.f26mY[i2][i];
            }
            int i4 = i2 + 1;
            if (d < dArr2[i4]) {
