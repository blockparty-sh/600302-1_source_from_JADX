...
public class ImageFilterView extends AppCompatImageView {
    ...
    static class ImageMatrix {
        ...
        private void warmth(float f) {
            ...
            float f5 = f4 < 66.0f ? f4 > 19.0f ? (((float) Math.log((double) (f4 - 10.0f))) * 138.51773f) - 305.0448f : 0.0f : 255.0f;
            float min = Math.min(255.0f, Math.max(f3, 0.0f));
            float min2 = Math.min(255.0f, Math.max(f2, 0.0f));
            float min3 = min / Math.min(255.0f, Math.max(255.0f, 0.0f));
            float min4 = min2 / Math.min(255.0f, Math.max((((float) Math.log((double) 50.0f)) * 99.4708f) - 161.11957f, 0.0f));
            float min5 = Math.min(255.0f, Math.max(f5, 0.0f)) / Math.min(255.0f, Math.max((((float) Math.log((double) 40.0f)) * 138.51773f) - 305.0448f, 0.0f));
            float[] fArr = this.f46m;
            fArr[0] = min3;
            fArr[1] = 0.0f;
            fArr[2] = 0.0f;
    ...
    public void draw(Canvas canvas) {
        boolean z;
        if (VERSION.SDK_INT >= 21 || this.mRoundPercent == 0.0f) {
            z = false;
        } else {
            z = true;
            canvas.save();
