...
public class Barrier extends ConstraintHelper {
    ...
    public void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0215R.styleable.ConstraintLayout_Layout_barrierDirection) {
                    setType(obtainStyledAttributes.getInt(index, 0));
                } else if (index == C0215R.styleable.ConstraintLayout_Layout_barrierAllowsGoneWidgets) {
                    this.mBarrier.setAllowsGoneWidget(obtainStyledAttributes.getBoolean(index, true));
                } else if (index == C0215R.styleable.ConstraintLayout_Layout_barrierMargin) {
    ...
    public void setDpMargin(int i) {
        this.mBarrier.setMargin((int) ((((float) i) * getResources().getDisplayMetrics().density) + 0.5f));
    }
