...
public class HorizontalChainReference extends ChainReference {
    ...
    static /* synthetic */ class C01991 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.state.helpers.HorizontalChainReference.C01991.<clinit>():void");
        }
    }

    public HorizontalChainReference(State state) {
        super(state, Helper.HORIZONTAL_CHAIN);
    }
    ...
    public void apply() {
        ...
        int i = C01991.$SwitchMap$androidx$constraintlayout$solver$state$State$Chain[this.mStyle.ordinal()];
        if (i == 1) {
