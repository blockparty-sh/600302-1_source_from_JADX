    ...
    private void defineChainProperties() {
        ...
        while (!z2) {
            ...
            if (constraintWidget2.getVisibility() != 8) {
                ...
                if (constraintWidget2.getDimensionBehaviour(this.mOrientation) != DimensionBehaviour.MATCH_CONSTRAINT) {
                ...
                if (constraintWidget2.mListDimensionBehaviors[this.mOrientation] == DimensionBehaviour.MATCH_CONSTRAINT) {
