...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    static /* synthetic */ class C02061 {
        ...
        static final /* synthetic */ int[] f43xbf6f0c8e = new int[RunType.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f43xbf6f0c8e = r0
                int[] r0 = f43xbf6f0c8e     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f43xbf6f0c8e     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f43xbf6f0c8e     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.widgets.analyzer.HorizontalWidgetRun.C02061.<clinit>():void");
        }
    }
        ...
        if (!this.dimension.resolved) {
            ...
            if (this.dimensionBehavior != DimensionBehaviour.MATCH_CONSTRAINT) {
                if (this.dimensionBehavior == DimensionBehaviour.MATCH_PARENT) {
                    ...
                    if ((parent != null && parent.getHorizontalDimensionBehaviour() == DimensionBehaviour.FIXED) || parent.getHorizontalDimensionBehaviour() == DimensionBehaviour.MATCH_PARENT) {
                        int width = (parent.getWidth() - this.widget.mLeft.getMargin()) - this.widget.mRight.getMargin();
            ...
            if ((parent2 != null && parent2.getHorizontalDimensionBehaviour() == DimensionBehaviour.FIXED) || parent2.getHorizontalDimensionBehaviour() == DimensionBehaviour.MATCH_PARENT) {
    ...
    public void update(androidx.constraintlayout.solver.widgets.analyzer.Dependency r17) {
        /*
            r16 = this;
            r8 = r16
            int[] r0 = androidx.constraintlayout.solver.widgets.analyzer.HorizontalWidgetRun.C02061.f43xbf6f0c8e
