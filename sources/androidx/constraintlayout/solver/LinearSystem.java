...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f32id == -1 || solverVariable.f32id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f32id] == null) {
                ...
                solverVariable.mType = C0194Type.UNRESTRICTED;
    ...
    public SolverVariable createSlackVariable() {
        ...
        SolverVariable acquireSolverVariable = acquireSolverVariable(C0194Type.SLACK, null);
        this.mVariablesID++;
        this.mNumColumns++;
        acquireSolverVariable.f32id = this.mVariablesID;
    ...
    private SolverVariable createVariable(String str, C0194Type type) {
        Metrics metrics = sMetrics;
        if (metrics != null) {
            metrics.variables++;
        }
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        SolverVariable acquireSolverVariable = acquireSolverVariable(C0194Type.ERROR, str);
        this.mVariablesID++;
        this.mNumColumns++;
        acquireSolverVariable.f32id = this.mVariablesID;
    ...
    private SolverVariable acquireSolverVariable(C0194Type type, String str) {
    ...
    public float getValueFor(String str) {
        SolverVariable variable = getVariable(str, C0194Type.UNRESTRICTED);
        if (variable == null) {
            return 0.0f;
        }
    ...
    /* access modifiers changed from: 0000 */
    public SolverVariable getVariable(String str, C0194Type type) {
        if (this.mVariables == null) {
            this.mVariables = new HashMap<>();
        }
        ...
        while (!z2) {
            ...
            if (pivotCandidate != null) {
                ...
                for (int i4 = 0; i4 < this.mNumRows; i4++) {
                    ...
                    if (arrayRow.variable.mType != C0194Type.UNRESTRICTED && !arrayRow.isSimpleDefinition && arrayRow.hasVariable(pivotCandidate)) {
    ...
    private int enforceBFS(Row row) throws Exception {
        ...
        while (true) {
            ...
            if (i >= this.mNumRows) {
                z = false;
                break;
            } else if (this.mRows[i].variable.mType != C0194Type.UNRESTRICTED && this.mRows[i].constantValue < 0.0f) {
                z = true;
                break;
            } else {
                i++;
        ...
        while (!z2) {
            ...
            while (i3 < this.mNumRows) {
                ...
                if (arrayRow.variable.mType != C0194Type.UNRESTRICTED && !arrayRow.isSimpleDefinition && arrayRow.constantValue < f) {
                    int i7 = 1;
    ...
    public void displayVariablesReadableRows() {
        ...
        while (true) {
            String str2 = "\n";
            if (i < this.mNumRows) {
                if (this.mRows[i].variable.mType == C0194Type.UNRESTRICTED) {
                    StringBuilder sb = new StringBuilder();
                    sb.append(str);
                    sb.append(this.mRows[i].toReadableString());
                    String sb2 = sb.toString();
    ...
    public void addGreaterBarrier(SolverVariable solverVariable, SolverVariable solverVariable2, int i, boolean z) {
        ...
        createRow.createRowGreaterThan(solverVariable, solverVariable2, createSlackVariable, i);
        if (z) {
            addSingleError(createRow, (int) (createRow.variables.get(createSlackVariable) * -1.0f), 5);
        }
        addConstraint(createRow);
    }
    ...
    public void addCenterPoint(ConstraintWidget constraintWidget, ConstraintWidget constraintWidget2, float f, int i) {
        ...
        SolverVariable createObjectVariable = createObjectVariable(constraintWidget3.getAnchor(C0202Type.LEFT));
        SolverVariable createObjectVariable2 = createObjectVariable(constraintWidget3.getAnchor(C0202Type.TOP));
        SolverVariable createObjectVariable3 = createObjectVariable(constraintWidget3.getAnchor(C0202Type.RIGHT));
        SolverVariable createObjectVariable4 = createObjectVariable(constraintWidget3.getAnchor(C0202Type.BOTTOM));
        SolverVariable createObjectVariable5 = createObjectVariable(constraintWidget4.getAnchor(C0202Type.LEFT));
        SolverVariable createObjectVariable6 = createObjectVariable(constraintWidget4.getAnchor(C0202Type.TOP));
        SolverVariable createObjectVariable7 = createObjectVariable(constraintWidget4.getAnchor(C0202Type.RIGHT));
        SolverVariable createObjectVariable8 = createObjectVariable(constraintWidget4.getAnchor(C0202Type.BOTTOM));
        ArrayRow createRow = createRow();
        double d = (double) f;
