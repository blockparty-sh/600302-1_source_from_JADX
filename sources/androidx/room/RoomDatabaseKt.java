...
public final class RoomDatabaseKt {
    ...
    @org.jetbrains.annotations.Nullable
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static final /* synthetic */ java.lang.Object createTransactionContext(@org.jetbrains.annotations.NotNull androidx.room.RoomDatabase r6, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.coroutines.CoroutineContext> r7) {
        /*
        ...
        L_0x003a:
            kotlin.ResultKt.throwOnFailure(r7)
            r7 = 0
            kotlinx.coroutines.Job r7 = kotlinx.coroutines.JobKt.Job$default(r7, r3, r7)
    ...
    @Nullable
    static final /* synthetic */ Object acquireTransactionThread(@NotNull Executor executor, @NotNull Job job, @NotNull Continuation<? super ContinuationInterceptor> continuation) {
        CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
        CancellableContinuation cancellableContinuation = cancellableContinuationImpl;
        cancellableContinuation.invokeOnCancellation(new C0626xd529b4c0(executor, job));
        try {
            executor.execute(new C0627xd529b4c1(cancellableContinuation, executor, job));
