...
public abstract class Segment<S extends Segment<S>> {
    ...
    private final void movePrevToLeft(S s) {
        ...
        do {
            ...
            if (segment == null || segment.f776id <= s.f776id) {
                return;
            }
