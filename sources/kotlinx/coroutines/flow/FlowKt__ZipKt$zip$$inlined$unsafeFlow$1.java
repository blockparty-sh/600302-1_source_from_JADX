...
public final class FlowKt__ZipKt$zip$$inlined$unsafeFlow$1 implements Flow<R> {
    final /* synthetic */ Flow $other$inlined;
    final /* synthetic */ Flow $this_zip$inlined;
    final /* synthetic */ Function3 $transform$inlined;

    public FlowKt__ZipKt$zip$$inlined$unsafeFlow$1(Flow flow, Flow flow2, Function3 function3) {
        this.$this_zip$inlined = flow;
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        return CoroutineScopeKt.coroutineScope(new FlowKt__ZipKt$zip$$inlined$unsafeFlow$1$lambda$1(flowCollector, null, this), continuation);
    }
}
