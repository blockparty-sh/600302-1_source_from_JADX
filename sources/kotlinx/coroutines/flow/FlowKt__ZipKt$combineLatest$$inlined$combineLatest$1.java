...
public final class FlowKt__ZipKt$combineLatest$$inlined$combineLatest$1 extends Lambda implements Function0<Object[]> {
    final /* synthetic */ Flow[] $others;

    public FlowKt__ZipKt$combineLatest$$inlined$combineLatest$1(Flow[] flowArr) {
        this.$others = flowArr;
        super(0);
    }
