...
public final class FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public FlowKt__DistinctKt$distinctUntilChangedBy$$inlined$unsafeFlow$1(Flow flow, Function1 function1) {
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        return this.$this_distinctUntilChangedBy$inlined.collect(new C3188x59d1cced(flowCollector, objectRef, this), continuation);
    }
}
