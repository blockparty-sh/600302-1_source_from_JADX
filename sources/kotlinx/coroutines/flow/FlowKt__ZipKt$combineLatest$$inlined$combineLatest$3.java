...
public final class FlowKt__ZipKt$combineLatest$$inlined$combineLatest$3 extends Lambda implements Function0<Object[]> {
    final /* synthetic */ Flow[] $others;

    public FlowKt__ZipKt$combineLatest$$inlined$combineLatest$3(Flow[] flowArr) {
        this.$others = flowArr;
        super(0);
    }
