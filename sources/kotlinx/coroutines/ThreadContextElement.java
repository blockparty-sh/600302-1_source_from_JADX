...
public interface ThreadContextElement<S> extends Element {
    ...
    public static final class DefaultImpls {
        ...
        @Nullable
        public static <S, E extends Element> E get(ThreadContextElement<S> threadContextElement, @NotNull C2916Key<E> key) {
            Intrinsics.checkParameterIsNotNull(key, "key");
            return kotlin.coroutines.CoroutineContext.Element.DefaultImpls.get(threadContextElement, key);
        }

        @NotNull
        public static <S> CoroutineContext minusKey(ThreadContextElement<S> threadContextElement, @NotNull C2916Key<?> key) {
            Intrinsics.checkParameterIsNotNull(key, "key");
