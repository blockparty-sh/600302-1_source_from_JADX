    ...
    public final void resumeCancellable(T t) {
        ...
        try {
            ...
            if (job == null || job.isActive()) {
                ...
                resumeWith(Result.m479constructorimpl(ResultKt.createFailure(cancellationException)));
                z = true;
            }
            if (!z) {
                context = getContext();
