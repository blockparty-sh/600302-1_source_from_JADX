...
public interface Job extends Element {
    ...
    public static final class DefaultImpls {
        ...
        @Nullable
        public static <E extends Element> E get(Job job, @NotNull C2916Key<E> key) {
            Intrinsics.checkParameterIsNotNull(key, "key");
            return kotlin.coroutines.CoroutineContext.Element.DefaultImpls.get(job, key);
        }

        @NotNull
        public static CoroutineContext minusKey(Job job, @NotNull C2916Key<?> key) {
            Intrinsics.checkParameterIsNotNull(key, "key");
    ...
    @Metadata(mo37403bv = {1, 0, 3}, mo37404d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003¨\u0006\u0004"}, mo37405d2 = {"Lkotlinx/coroutines/Job$Key;", "Lkotlin/coroutines/CoroutineContext$Key;", "Lkotlinx/coroutines/Job;", "()V", "kotlinx-coroutines-core"}, mo37406k = 1, mo37407mv = {1, 1, 15})
    /* renamed from: kotlinx.coroutines.Job$Key */
    /* compiled from: Job.kt */
    public static final class C3160Key implements C2916Key<Job> {
        static final /* synthetic */ C3160Key $$INSTANCE = new C3160Key();

        static {
            C3157Key key = CoroutineExceptionHandler.Key;
        }
