...
public final class DispatchedKt {
        ...
        if (continuation instanceof DispatchedContinuation) {
            ...
            try {
                ...
                if (job == null || job.isActive()) {
                    ...
                    dispatchedContinuation.resumeWith(Result.m479constructorimpl(ResultKt.createFailure(cancellationException)));
                    z = true;
                }
                if (!z) {
    ...
    public static final <T> void resumeCancellableWithException(@NotNull Continuation<? super T> continuation, @NotNull Throwable th) {
        ...
        Companion companion3 = Result.Companion;
        continuation.resumeWith(Result.m479constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(th, continuation))));
    }
