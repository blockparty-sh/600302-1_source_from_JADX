...
public interface CoroutineContext {
    ...
    public interface Element extends CoroutineContext {
        ...
        public static final class DefaultImpls {
            ...
            @Nullable
            public static <E extends Element> E get(Element element, @NotNull C2918Key<E> key) {
            ...
            public static kotlin.coroutines.experimental.CoroutineContext minusKey(kotlin.coroutines.experimental.CoroutineContext.Element r1, @org.jetbrains.annotations.NotNull kotlin.coroutines.experimental.CoroutineContext.C2918Key<?> r2) {
                /*
        ...
        @Nullable
        <E extends Element> E get(@NotNull C2918Key<E> key);

        @NotNull
        C2918Key<?> getKey();

        @NotNull
        CoroutineContext minusKey(@NotNull C2918Key<?> key);
    }

    @Metadata(mo37403bv = {1, 0, 3}, mo37404d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\bf\u0018\u0000*\b\b\u0000\u0010\u0001*\u00020\u00022\u00020\u0003¨\u0006\u0004"}, mo37405d2 = {"Lkotlin/coroutines/experimental/CoroutineContext$Key;", "E", "Lkotlin/coroutines/experimental/CoroutineContext$Element;", "", "kotlin-stdlib-coroutines"}, mo37406k = 1, mo37407mv = {1, 1, 15})
    /* renamed from: kotlin.coroutines.experimental.CoroutineContext$Key */
    /* compiled from: CoroutineContext.kt */
    public interface C2918Key<E extends Element> {
    }
