...
public final class EmptyCoroutineContext implements CoroutineContext {
    ...
    @Nullable
    public <E extends Element> E get(@NotNull C2918Key<E> key) {
    ...
    @NotNull
    public CoroutineContext minusKey(@NotNull C2918Key<?> key) {
        Intrinsics.checkParameterIsNotNull(key, "key");
        return this;
    }
}
