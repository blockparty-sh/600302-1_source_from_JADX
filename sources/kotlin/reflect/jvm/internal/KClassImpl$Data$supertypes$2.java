...
@Metadata(mo37403bv = {1, 0, 2}, mo37404d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001\"\b\b\u0000\u0010\u0003*\u00020\u0004H\n¢\u0006\u0002\b\u0005"}, mo37405d2 = {"<anonymous>", "", "Lkotlin/reflect/jvm/internal/KTypeImpl;", "T", "", "invoke"}, mo37406k = 3, mo37407mv = {1, 1, 11})
...
final class KClassImpl$Data$supertypes$2 extends Lambda implements Function0<List<? extends KTypeImpl>> {
    ...
    public final List<KTypeImpl> invoke() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(supertypes, "kotlinTypes");
        ...
        if (!KotlinBuiltIns.isSpecialClassWithNoSupertypes(this.this$0.getDescriptor())) {
            ...
            if (z2) {
                ...
                collection2.add(new KTypeImpl(anyType, C14203.INSTANCE));
            }
        }
