...
public final class ProtoBuf {
        ...
        public static final class Argument extends GeneratedMessageLite implements ArgumentOrBuilder {
            ...
            public static final class Value extends GeneratedMessageLite implements ValueOrBuilder {
                ...
                public static final class Builder extends kotlin.reflect.jvm.internal.impl.protobuf.GeneratedMessageLite.Builder<Value, Builder> implements ValueOrBuilder {
                    ...
                    private C3041Type type_ = C3041Type.BYTE;
                    ...
                    public Builder setType(C3041Type type) {
                        if (type != null) {
                            this.bitField0_ |= 1;
                            this.type_ = type;
                            return this;
                ...
                /* renamed from: kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Annotation$Argument$Value$Type */
                public enum C3041Type implements EnumLite {
                    BYTE(0, 0),
                    CHAR(1, 1),
                    SHORT(2, 2),
                    INT(3, 3),
                    ...
                    private static EnumLiteMap<C3041Type> internalValueMap;
                    private final int value;

                    static {
                        internalValueMap = new EnumLiteMap<C3041Type>() {
                            public C3041Type findValueByNumber(int i) {
                                return C3041Type.valueOf(i);
                            }
                        };
                    }
                    ...
                    public static C3041Type valueOf(int i) {
                        switch (i) {
                            case 0:
                                return BYTE;
                            case 1:
                    ...
                    private C3041Type(int i, int i2) {
                        this.value = i2;
                    }
                }
                        ...
                        try {
                            ...
                            switch (readTag) {
                                ...
                                case 8:
                                    ...
                                    C3041Type valueOf = C3041Type.valueOf(readEnum);
                                    if (valueOf != null) {
                                        this.bitField0_ |= 1;
                                        this.type_ = valueOf;
                                        break;
    ...
    public static final class Class extends ExtendableMessage<Class> implements ClassOrBuilder {
        ...
        /* access modifiers changed from: private */
        public List<C3063Type> supertype_;
        /* access modifiers changed from: private */
        ...
        public static final class Builder extends ExtendableBuilder<Class, Builder> implements ClassOrBuilder {
            ...
            private List<C3063Type> supertype_ = Collections.emptyList();
            ...
            public C3063Type getSupertype(int i) {
                return (C3063Type) this.supertype_.get(i);
            }
        ...
        private Class(kotlin.reflect.jvm.internal.impl.protobuf.CodedInputStream r18, kotlin.reflect.jvm.internal.impl.protobuf.ExtensionRegistryLite r19) throws kotlin.reflect.jvm.internal.impl.protobuf.InvalidProtocolBufferException {
            ...
            L_0x0223:
                ...
                kotlin.reflect.jvm.internal.impl.protobuf.Parser<kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Type> r11 = kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf.C3063Type.PARSER     // Catch:{ InvalidProtocolBufferException -> 0x02df, IOException -> 0x02cf }
                kotlin.reflect.jvm.internal.impl.protobuf.MessageLite r11 = r2.readMessage(r11, r3)     // Catch:{ InvalidProtocolBufferException -> 0x02df, IOException -> 0x02cf }
                r5.add(r11)     // Catch:{ InvalidProtocolBufferException -> 0x02df, IOException -> 0x02cf }
                goto L_0x02b4
            L_0x0230:
        ...
        public List<C3063Type> getSupertypeList() {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (getSealedSubclassFqNameList().size() > 0) {
                codedOutputStream.writeRawVarint32(ScriptOpCodes.OP_SIZE);
    ...
    public static final class Expression extends GeneratedMessageLite implements ExpressionOrBuilder {
        ...
        /* access modifiers changed from: private */
        public C3063Type isInstanceType_;
        private byte memoizedIsInitialized;
        private int memoizedSerializedSize;
        /* access modifiers changed from: private */
        ...
        public static final class Builder extends kotlin.reflect.jvm.internal.impl.protobuf.GeneratedMessageLite.Builder<Expression, Builder> implements ExpressionOrBuilder {
            ...
            private C3063Type isInstanceType_ = C3063Type.getDefaultInstance();
            ...
            public C3063Type getIsInstanceType() {
                return this.isInstanceType_;
            }

            public Builder mergeIsInstanceType(C3063Type type) {
                if ((this.bitField0_ & 8) != 8 || this.isInstanceType_ == C3063Type.getDefaultInstance()) {
                    this.isInstanceType_ = type;
                } else {
                    this.isInstanceType_ = C3063Type.newBuilder(this.isInstanceType_).mergeFrom(type).buildPartial();
                }
                this.bitField0_ |= 8;
                return this;
            }
                ...
                try {
                    ...
                    if (readTag != 0) {
                        if (readTag == 8) {
                            ...
                            this.isInstanceType_ = (C3063Type) codedInputStream.readMessage(C3063Type.PARSER, extensionRegistryLite);
                            if (builder != null) {
        ...
        private void initFields() {
            ...
            this.isInstanceType_ = C3063Type.getDefaultInstance();
    ...
    public static final class Function extends ExtendableMessage<Function> implements FunctionOrBuilder {
        ...
        /* access modifiers changed from: private */
        public C3063Type receiverType_;
        /* access modifiers changed from: private */
        public int returnTypeId_;
        /* access modifiers changed from: private */
        public C3063Type returnType_;
        /* access modifiers changed from: private */
        public List<TypeParameter> typeParameter_;
        /* access modifiers changed from: private */
        public TypeTable typeTable_;
        ...
        public static final class Builder extends ExtendableBuilder<Function, Builder> implements FunctionOrBuilder {
            ...
            private C3063Type receiverType_ = C3063Type.getDefaultInstance();
            private int returnTypeId_;
            private C3063Type returnType_ = C3063Type.getDefaultInstance();
            private List<TypeParameter> typeParameter_ = Collections.emptyList();
            private TypeTable typeTable_ = TypeTable.getDefaultInstance();
            private List<ValueParameter> valueParameter_ = Collections.emptyList();
            private List<Integer> versionRequirement_ = Collections.emptyList();
            ...
            public C3063Type getReturnType() {
                return this.returnType_;
            }

            public Builder mergeReturnType(C3063Type type) {
                if ((this.bitField0_ & 8) != 8 || this.returnType_ == C3063Type.getDefaultInstance()) {
                    this.returnType_ = type;
                } else {
                    this.returnType_ = C3063Type.newBuilder(this.returnType_).mergeFrom(type).buildPartial();
                }
                this.bitField0_ |= 8;
                return this;
            }
            ...
            public C3063Type getReceiverType() {
                return this.receiverType_;
            }

            public Builder mergeReceiverType(C3063Type type) {
                if ((this.bitField0_ & 64) != 64 || this.receiverType_ == C3063Type.getDefaultInstance()) {
                    this.receiverType_ = type;
                } else {
                    this.receiverType_ = C3063Type.newBuilder(this.receiverType_).mergeFrom(type).buildPartial();
                }
                this.bitField0_ |= 64;
                return this;
            }
        ...
        private Function(kotlin.reflect.jvm.internal.impl.protobuf.CodedInputStream r12, kotlin.reflect.jvm.internal.impl.protobuf.ExtensionRegistryLite r13) throws kotlin.reflect.jvm.internal.impl.protobuf.InvalidProtocolBufferException {
            ...
            L_0x011c:
                kotlin.reflect.jvm.internal.impl.protobuf.Parser<kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Type> r8 = kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf.C3063Type.PARSER     // Catch:{ InvalidProtocolBufferException -> 0x01b2, IOException -> 0x01a3 }
                kotlin.reflect.jvm.internal.impl.protobuf.MessageLite r8 = r12.readMessage(r8, r13)     // Catch:{ InvalidProtocolBufferException -> 0x01b2, IOException -> 0x01a3 }
                kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Type r8 = (kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf.C3063Type) r8     // Catch:{ InvalidProtocolBufferException -> 0x01b2, IOException -> 0x01a3 }
        ...
        private void initFields() {
            ...
            this.oldFlags_ = 6;
            this.name_ = 0;
            this.returnType_ = C3063Type.getDefaultInstance();
            this.returnTypeId_ = 0;
            this.typeParameter_ = Collections.emptyList();
            this.receiverType_ = C3063Type.getDefaultInstance();
    ...
    public static final class Property extends ExtendableMessage<Property> implements PropertyOrBuilder {
        ...
        private Property(kotlin.reflect.jvm.internal.impl.protobuf.CodedInputStream r11, kotlin.reflect.jvm.internal.impl.protobuf.ExtensionRegistryLite r12) throws kotlin.reflect.jvm.internal.impl.protobuf.InvalidProtocolBufferException {
            ...
            L_0x00f1:
                kotlin.reflect.jvm.internal.impl.protobuf.Parser<kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Type> r7 = kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf.C3063Type.PARSER     // Catch:{ InvalidProtocolBufferException -> 0x0187, IOException -> 0x0178 }
                kotlin.reflect.jvm.internal.impl.protobuf.MessageLite r7 = r11.readMessage(r7, r12)     // Catch:{ InvalidProtocolBufferException -> 0x0187, IOException -> 0x0178 }
                kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Type r7 = (kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf.C3063Type) r7     // Catch:{ InvalidProtocolBufferException -> 0x0187, IOException -> 0x0178 }
    ...
    /* renamed from: kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Type */
    public static final class C3063Type extends ExtendableMessage<C3063Type> implements TypeOrBuilder {
        public static Parser<C3063Type> PARSER = new AbstractParser<C3063Type>() {
            public C3063Type parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
                return new C3063Type(codedInputStream, extensionRegistryLite);
            }
        };
        private static final C3063Type defaultInstance = new C3063Type(true);
        /* access modifiers changed from: private */
        public int abbreviatedTypeId_;
        /* access modifiers changed from: private */
        public C3063Type abbreviatedType_;
        /* access modifiers changed from: private */
        public List<Argument> argument_;
        /* access modifiers changed from: private */
        public int bitField0_;
        ...
        /* access modifiers changed from: private */
        public C3063Type flexibleUpperBound_;
        private byte memoizedIsInitialized;
        private int memoizedSerializedSize;
        /* access modifiers changed from: private */
        ...
        /* renamed from: kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Type$Argument */
        public static final class Argument extends GeneratedMessageLite implements ArgumentOrBuilder {
            public static Parser<Argument> PARSER = new AbstractParser<Argument>() {
                public Argument parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
                    return new Argument(codedInputStream, extensionRegistryLite);
            ...
            public int typeId_;
            /* access modifiers changed from: private */
            public C3063Type type_;
            /* access modifiers changed from: private */
            public final ByteString unknownFields;

            /* renamed from: kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Type$Argument$Builder */
            public static final class Builder extends kotlin.reflect.jvm.internal.impl.protobuf.GeneratedMessageLite.Builder<Argument, Builder> implements ArgumentOrBuilder {
                private int bitField0_;
                private Projection projection_ = Projection.INV;
                private int typeId_;
                private C3063Type type_ = C3063Type.getDefaultInstance();
                ...
                public C3063Type getType() {
                    return this.type_;
                }

                public Builder mergeType(C3063Type type) {
                    if ((this.bitField0_ & 2) != 2 || this.type_ == C3063Type.getDefaultInstance()) {
                        this.type_ = type;
                    } else {
                        this.type_ = C3063Type.newBuilder(this.type_).mergeFrom(type).buildPartial();
                    }
                    this.bitField0_ |= 2;
                    return this;
                }
            ...
            /* renamed from: kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Type$Argument$Projection */
                    ...
                    try {
                        ...
                        if (readTag != 0) {
                            if (readTag == 8) {
                                ...
                                this.type_ = (C3063Type) codedInputStream.readMessage(C3063Type.PARSER, extensionRegistryLite);
                                if (builder != null) {
            ...
            private void initFields() {
                ...
                this.type_ = C3063Type.getDefaultInstance();
                this.typeId_ = 0;
            }
        ...
        /* renamed from: kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Type$ArgumentOrBuilder */
        public interface ArgumentOrBuilder extends MessageLiteOrBuilder {
        }

        /* renamed from: kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$Type$Builder */
        public static final class Builder extends ExtendableBuilder<C3063Type, Builder> implements TypeOrBuilder {
            private int abbreviatedTypeId_;
            private C3063Type abbreviatedType_ = C3063Type.getDefaultInstance();
            private List<Argument> argument_ = Collections.emptyList();
            private int bitField0_;
            ...
            private C3063Type flexibleUpperBound_ = C3063Type.getDefaultInstance();
            private boolean nullable_;
            private int outerTypeId_;
            private C3063Type outerType_ = C3063Type.getDefaultInstance();
            ...
            public C3063Type getDefaultInstanceForType() {
                return C3063Type.getDefaultInstance();
            }

            public C3063Type build() {
                C3063Type buildPartial = buildPartial();
                if (buildPartial.isInitialized()) {
                    return buildPartial;
                }
                throw newUninitializedMessageException(buildPartial);
            ...
            public C3063Type buildPartial() {
                C3063Type type = new C3063Type((ExtendableBuilder) this);
                int i = this.bitField0_;
                int i2 = 1;
                if ((i & 1) == 1) {
                    this.argument_ = Collections.unmodifiableList(this.argument_);
            ...
            public Builder mergeFrom(C3063Type type) {
                if (type == C3063Type.getDefaultInstance()) {
                    return this;
                }
            ...
            public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
                C3063Type type;
                C3063Type type2 = null;
                try {
                    C3063Type type3 = (C3063Type) C3063Type.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                    if (type3 != null) {
                        mergeFrom(type3);
                    }
                    return this;
                } catch (InvalidProtocolBufferException e) {
                    type = (C3063Type) e.getUnfinishedMessage();
                    throw e;
                } catch (Throwable th) {
                    th = th;
                    type2 = type;
            ...
            public C3063Type getFlexibleUpperBound() {
                return this.flexibleUpperBound_;
            }

            public Builder mergeFlexibleUpperBound(C3063Type type) {
                if ((this.bitField0_ & 8) != 8 || this.flexibleUpperBound_ == C3063Type.getDefaultInstance()) {
                    this.flexibleUpperBound_ = type;
                } else {
                    this.flexibleUpperBound_ = C3063Type.newBuilder(this.flexibleUpperBound_).mergeFrom(type).buildPartial();
                }
                this.bitField0_ |= 8;
                return this;
            }
            ...
            public C3063Type getOuterType() {
                return this.outerType_;
            }

            public Builder mergeOuterType(C3063Type type) {
                if ((this.bitField0_ & 512) != 512 || this.outerType_ == C3063Type.getDefaultInstance()) {
                    this.outerType_ = type;
                } else {
                    this.outerType_ = C3063Type.newBuilder(this.outerType_).mergeFrom(type).buildPartial();
                }
                this.bitField0_ |= 512;
                return this;
            }
            ...
            public C3063Type getAbbreviatedType() {
                return this.abbreviatedType_;
            }

            public Builder mergeAbbreviatedType(C3063Type type) {
                if ((this.bitField0_ & 2048) != 2048 || this.abbreviatedType_ == C3063Type.getDefaultInstance()) {
                    this.abbreviatedType_ = type;
                } else {
                    this.abbreviatedType_ = C3063Type.newBuilder(this.abbreviatedType_).mergeFrom(type).buildPartial();
                }
                this.bitField0_ |= 2048;
                return this;
            }
        ...
        private C3063Type(ExtendableBuilder<C3063Type, ?> extendableBuilder) {
            super(extendableBuilder);
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = extendableBuilder.getUnknownFields();
        ...
        private C3063Type(boolean z) {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            this.unknownFields = ByteString.EMPTY;
        }

        public static C3063Type getDefaultInstance() {
            return defaultInstance;
        }
        ...
        private C3063Type(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            this.memoizedIsInitialized = -1;
            this.memoizedSerializedSize = -1;
            initFields();
            Output newOutput = ByteString.newOutput();
                ...
                try {
                    ...
                    switch (readTag) {
                        ...
                        case 42:
                            ...
                            this.flexibleUpperBound_ = (C3063Type) codedInputStream.readMessage(PARSER, extensionRegistryLite);
                            if (builder != null) {
                        ...
                        case 82:
                            ...
                            this.outerType_ = (C3063Type) codedInputStream.readMessage(PARSER, extensionRegistryLite);
                            if (builder != null) {
                        ...
                        case 106:
                            ...
                            this.abbreviatedType_ = (C3063Type) codedInputStream.readMessage(PARSER, extensionRegistryLite);
                            if (builder != null) {
        ...
        public Parser<C3063Type> getParserForType() {
            return PARSER;
        }
        ...
        public static Builder newBuilder(C3063Type type) {
    ...
    public static final class TypeAlias extends ExtendableMessage<TypeAlias> implements TypeAliasOrBuilder {
        ...
        /* access modifiers changed from: private */
        public C3063Type expandedType_;
        /* access modifiers changed from: private */
        public int flags_;
        private byte memoizedIsInitialized;
        private int memoizedSerializedSize;
        ...
        /* access modifiers changed from: private */
        public C3063Type underlyingType_;
        /* access modifiers changed from: private */
        public final ByteString unknownFields;
        /* access modifiers changed from: private */
        public List<Integer> versionRequirement_;
        ...
        public static final class Builder extends ExtendableBuilder<TypeAlias, Builder> implements TypeAliasOrBuilder {
            ...
            private C3063Type expandedType_ = C3063Type.getDefaultInstance();
            private int flags_ = 6;
            private int name_;
            private List<TypeParameter> typeParameter_ = Collections.emptyList();
            private int underlyingTypeId_;
            private C3063Type underlyingType_ = C3063Type.getDefaultInstance();
            private List<Integer> versionRequirement_ = Collections.emptyList();
            ...
            public C3063Type getUnderlyingType() {
                return this.underlyingType_;
            }

            public Builder mergeUnderlyingType(C3063Type type) {
                if ((this.bitField0_ & 8) != 8 || this.underlyingType_ == C3063Type.getDefaultInstance()) {
                    this.underlyingType_ = type;
                } else {
                    this.underlyingType_ = C3063Type.newBuilder(this.underlyingType_).mergeFrom(type).buildPartial();
                }
                this.bitField0_ |= 8;
                return this;
            }
            ...
            public C3063Type getExpandedType() {
                return this.expandedType_;
            }

            public Builder mergeExpandedType(C3063Type type) {
                if ((this.bitField0_ & 32) != 32 || this.expandedType_ == C3063Type.getDefaultInstance()) {
                    this.expandedType_ = type;
                } else {
                    this.expandedType_ = C3063Type.newBuilder(this.expandedType_).mergeFrom(type).buildPartial();
                }
                this.bitField0_ |= 32;
                return this;
            }
                ...
                try {
                    ...
                    switch (readTag) {
                        ...
                        case 34:
                            ...
                            this.underlyingType_ = (C3063Type) codedInputStream.readMessage(C3063Type.PARSER, extensionRegistryLite);
                            if (builder != null) {
                        ...
                        case 50:
                            ...
                            this.expandedType_ = (C3063Type) codedInputStream.readMessage(C3063Type.PARSER, extensionRegistryLite);
                            if (builder != null) {
        ...
        private void initFields() {
            ...
            this.name_ = 0;
            this.typeParameter_ = Collections.emptyList();
            this.underlyingType_ = C3063Type.getDefaultInstance();
            this.underlyingTypeId_ = 0;
            this.expandedType_ = C3063Type.getDefaultInstance();
    ...
    public static final class TypeParameter extends ExtendableMessage<TypeParameter> implements TypeParameterOrBuilder {
        ...
        /* access modifiers changed from: private */
        public List<C3063Type> upperBound_;
        /* access modifiers changed from: private */
        ...
        public static final class Builder extends ExtendableBuilder<TypeParameter, Builder> implements TypeParameterOrBuilder {
            ...
            private List<C3063Type> upperBound_ = Collections.emptyList();
            ...
            public C3063Type getUpperBound(int i) {
                return (C3063Type) this.upperBound_.get(i);
            }
                ...
                try {
                    ...
                    if (readTag != 0) {
                        if (readTag == 8) {
                            ...
                            this.upperBound_.add(codedInputStream.readMessage(C3063Type.PARSER, extensionRegistryLite));
                        } else if (readTag == 48) {
                            if (!(z2 & true)) {
        ...
        public List<C3063Type> getUpperBoundList() {
    ...
    public static final class TypeTable extends GeneratedMessageLite implements TypeTableOrBuilder {
        ...
        public static final class Builder extends kotlin.reflect.jvm.internal.impl.protobuf.GeneratedMessageLite.Builder<TypeTable, Builder> implements TypeTableOrBuilder {
            ...
            private List<C3063Type> type_ = Collections.emptyList();
            ...
            public C3063Type getType(int i) {
                return (C3063Type) this.type_.get(i);
            }
                ...
                try {
                    ...
                    if (readTag != 0) {
                        if (readTag == 10) {
                            ...
                            this.type_.add(codedInputStream.readMessage(C3063Type.PARSER, extensionRegistryLite));
                        } else if (readTag == 16) {
                            this.bitField0_ |= 1;
        ...
        public List<C3063Type> getTypeList() {
            return this.type_;
        }
    ...
    public static final class ValueParameter extends ExtendableMessage<ValueParameter> implements ValueParameterOrBuilder {
        ...
        /* access modifiers changed from: private */
        public C3063Type varargElementType_;
        ...
        public static final class Builder extends ExtendableBuilder<ValueParameter, Builder> implements ValueParameterOrBuilder {
            ...
            private C3063Type varargElementType_ = C3063Type.getDefaultInstance();
            ...
            public Builder mergeType(C3063Type type) {
                if ((this.bitField0_ & 4) != 4 || this.type_ == C3063Type.getDefaultInstance()) {
                    this.type_ = type;
                } else {
                    this.type_ = C3063Type.newBuilder(this.type_).mergeFrom(type).buildPartial();
                }
            ...
            public C3063Type getVarargElementType() {
                return this.varargElementType_;
            }

            public Builder mergeVarargElementType(C3063Type type) {
                if ((this.bitField0_ & 16) != 16 || this.varargElementType_ == C3063Type.getDefaultInstance()) {
                    this.varargElementType_ = type;
                } else {
                    this.varargElementType_ = C3063Type.newBuilder(this.varargElementType_).mergeFrom(type).buildPartial();
                }
                this.bitField0_ |= 16;
                return this;
            }
                    ...
                    if (readTag != 0) {
                        if (readTag == 8) {
                            ...
                            if (readTag == 26) {
                                ...
                                this.varargElementType_ = (C3063Type) codedInputStream.readMessage(C3063Type.PARSER, extensionRegistryLite);
                                if (builder != null) {
        ...
        private void initFields() {
            ...
            this.type_ = C3063Type.getDefaultInstance();
            this.typeId_ = 0;
            this.varargElementType_ = C3063Type.getDefaultInstance();
