...
public final class LazyJavaTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    @NotNull
    private final LazyJavaAnnotations annotations = new LazyJavaAnnotations(this.f709c, this.javaTypeParameter);

    /* renamed from: c */
    private final LazyJavaResolverContext f709c;
    @NotNull
    ...
    public LazyJavaTypeParameterDescriptor(@NotNull LazyJavaResolverContext lazyJavaResolverContext, @NotNull JavaTypeParameter javaTypeParameter2, int i, @NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        this.f709c = lazyJavaResolverContext;
    ...
    public List<KotlinType> resolveUpperBounds() {
        ...
        if (upperBounds.isEmpty()) {
            SimpleType anyType = this.f709c.getModule().getBuiltIns().getAnyType();
            Intrinsics.checkExpressionValueIsNotNull(anyType, "c.module.builtIns.anyType");
            SimpleType nullableAnyType = this.f709c.getModule().getBuiltIns().getNullableAnyType();
        ...
        for (JavaClassifierType transformJavaType : iterable) {
            arrayList.add(this.f709c.getTypeResolver().transformJavaType(transformJavaType, JavaTypeResolverKt.toAttributes$default(TypeUsage.COMMON, false, this, 1, null)));
        }
