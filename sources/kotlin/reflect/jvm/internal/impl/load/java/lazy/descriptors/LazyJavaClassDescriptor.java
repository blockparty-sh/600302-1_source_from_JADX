...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    /* renamed from: c */
    public final LazyJavaResolverContext f702c;
    ...
    private final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public LazyJavaClassTypeConstructor() {
            super(LazyJavaClassDescriptor.this.f702c.getStorageManager());
            this.parameters = LazyJavaClassDescriptor.this.f702c.getStorageManager().createLazyValue(new C2990xbaf55d8a(this));
        }
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                KotlinType transformJavaType = LazyJavaClassDescriptor.this.f702c.getTypeResolver().transformJavaType(javaClassifierType, JavaTypeResolverKt.toAttributes$default(TypeUsage.SUPERTYPE, false, null, 3, null));
            ...
            if (!arrayList2.isEmpty()) {
                ErrorReporter errorReporter = LazyJavaClassDescriptor.this.f702c.getComponents().getErrorReporter();
            ...
            return collection.isEmpty() ^ true ? kotlin.collections.CollectionsKt.toList(arrayList) : kotlin.collections.CollectionsKt.listOf(LazyJavaClassDescriptor.this.f702c.getModule().getBuiltIns().getAnyType());
        }
        ...
        private final kotlin.reflect.jvm.internal.impl.types.KotlinType getPurelyImplementedSupertype() {
            ...
            L_0x002d:
                ...
                kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor r4 = kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor.this
                kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r4 = r4.f702c
        ...
        public SupertypeLoopChecker getSupertypeLoopChecker() {
            return LazyJavaClassDescriptor.this.f702c.getComponents().getSupertypeLoopChecker();
        }
    ...
    public LazyJavaClassDescriptor(@NotNull LazyJavaResolverContext lazyJavaResolverContext, @NotNull DeclarationDescriptor declarationDescriptor, @NotNull JavaClass javaClass, @Nullable ClassDescriptor classDescriptor) {
        ...
        this.f702c = ContextKt.childForClassOrPackage$default(lazyJavaResolverContext, this, this.jClass, 0, 4, null);
        ClassDescriptor classDescriptor2 = this;
        this.f702c.getComponents().getJavaResolverCache().recordClass(this.jClass, classDescriptor2);
        boolean z = false;
        ...
        if (!_Assertions.ENABLED || z2) {
            ...
            this.unsubstitutedMemberScope = new LazyJavaClassMemberScope(this.f702c, classDescriptor2, this.jClass);
            this.innerClassesScope = new InnerClassesScopeWrapper(getUnsubstitutedMemberScope());
            this.staticScope = new LazyJavaStaticClassScope(this.f702c, this.jClass, this);
            this.annotations = LazyJavaAnnotationsKt.resolveAnnotations(this.f702c, this.jClass);
            this.declaredParameters = this.f702c.getStorageManager().createLazyValue(new LazyJavaClassDescriptor$declaredParameters$1(this));
            return;
        }
    ...
    public Visibility getVisibility() {
        return (!Intrinsics.areEqual((Object) this.visibility, (Object) Visibilities.PRIVATE) || this.jClass.getOuterClass() != null) ? this.visibility : JavaVisibilities.PACKAGE_VISIBILITY;
    }
    ...
    public final LazyJavaClassDescriptor copy$descriptors_jvm(@NotNull JavaResolverCache javaResolverCache, @Nullable ClassDescriptor classDescriptor) {
        ...
        LazyJavaResolverContext lazyJavaResolverContext = this.f702c;
