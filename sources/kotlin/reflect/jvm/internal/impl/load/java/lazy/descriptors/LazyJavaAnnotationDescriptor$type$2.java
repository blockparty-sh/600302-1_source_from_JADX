...
final class LazyJavaAnnotationDescriptor$type$2 extends Lambda implements Function0<SimpleType> {
    ...
    public final SimpleType invoke() {
        ...
        if (fqName != null) {
            ...
            ClassDescriptor mapJavaToKotlin$default = JavaToKotlinClassMap.mapJavaToKotlin$default(javaToKotlinClassMap, fqName, this.this$0.f701c.getModule().getBuiltIns(), null, 4, null);
            if (mapJavaToKotlin$default == null) {
                JavaClass resolve = this.this$0.javaAnnotation.resolve();
                mapJavaToKotlin$default = resolve != null ? this.this$0.f701c.getComponents().getModuleClassResolver().resolveClass(resolve) : null;
            }
            if (mapJavaToKotlin$default == null) {
