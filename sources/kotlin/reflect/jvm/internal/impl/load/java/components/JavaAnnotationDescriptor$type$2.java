...
final class JavaAnnotationDescriptor$type$2 extends Lambda implements Function0<SimpleType> {
    ...
    /* renamed from: $c */
    final /* synthetic */ LazyJavaResolverContext f696$c;
    ...
    JavaAnnotationDescriptor$type$2(JavaAnnotationDescriptor javaAnnotationDescriptor, LazyJavaResolverContext lazyJavaResolverContext) {
        ...
        this.f696$c = lazyJavaResolverContext;
        super(0);
    }

    @NotNull
    public final SimpleType invoke() {
        ClassDescriptor builtInClassByFqName = this.f696$c.getModule().getBuiltIns().getBuiltInClassByFqName(this.this$0.getFqName());
