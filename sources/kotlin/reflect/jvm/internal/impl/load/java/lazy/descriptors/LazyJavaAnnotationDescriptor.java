...
public final class LazyJavaAnnotationDescriptor implements AnnotationDescriptor {
    ...
    @NotNull
    private final NotNullLazyValue allValueArguments$delegate = this.f701c.getStorageManager().createLazyValue(new LazyJavaAnnotationDescriptor$allValueArguments$2(this));
    /* access modifiers changed from: private */

    /* renamed from: c */
    public final LazyJavaResolverContext f701c;
    @Nullable
    private final NullableLazyValue fqName$delegate = this.f701c.getStorageManager().createNullableLazyValue(new LazyJavaAnnotationDescriptor$fqName$2(this));
    /* access modifiers changed from: private */
    public final JavaAnnotation javaAnnotation;
    @NotNull
    private final JavaSourceElement source = this.f701c.getComponents().getSourceElementFactory().source(this.javaAnnotation);
    @NotNull
    private final NotNullLazyValue type$delegate = this.f701c.getStorageManager().createLazyValue(new LazyJavaAnnotationDescriptor$type$2(this));
    ...
    public LazyJavaAnnotationDescriptor(@NotNull LazyJavaResolverContext lazyJavaResolverContext, @NotNull JavaAnnotation javaAnnotation2) {
        ...
        this.f701c = lazyJavaResolverContext;
    ...
    private final ConstantValue<?> resolveFromAnnotation(JavaAnnotation javaAnnotation2) {
        return new AnnotationValue<>(new LazyJavaAnnotationDescriptor(this.f701c, javaAnnotation2));
    }
    ...
    private final kotlin.reflect.jvm.internal.impl.resolve.constants.ConstantValue<?> resolveFromArray(kotlin.reflect.jvm.internal.impl.name.Name r3, java.util.List<? extends kotlin.reflect.jvm.internal.impl.load.java.structure.JavaAnnotationArgument> r4) {
        ...
        L_0x001c:
            ...
            goto L_0x0047
        L_0x0029:
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r3 = r2.f701c
    ...
    private final ConstantValue<?> resolveFromJavaClassObjectType(JavaType javaType) {
        KotlinType makeNotNullable = TypeUtils.makeNotNullable(this.f701c.getTypeResolver().transformJavaType(javaType, JavaTypeResolverKt.toAttributes$default(TypeUsage.COMMON, false, null, 3, null)));
        ClassDescriptor resolveTopLevelClass = DescriptorUtilsKt.resolveTopLevelClass(this.f701c.getModule(), new FqName("java.lang.Class"), NoLookupLocation.FOR_NON_TRACKED_SCOPE);
    ...
    public final ClassDescriptor createTypeForMissingDependencies(FqName fqName) {
        ModuleDescriptor module = this.f701c.getModule();
        ClassId classId = ClassId.topLevel(fqName);
        Intrinsics.checkExpressionValueIsNotNull(classId, "ClassId.topLevel(fqName)");
        return FindClassInModuleKt.findNonGenericClassAcrossDependencies(module, classId, this.f701c.getComponents().getDeserializedDescriptorResolver().getComponents().getNotFoundClasses());
    }
}
