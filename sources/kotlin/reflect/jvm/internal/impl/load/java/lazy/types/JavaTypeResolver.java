...
public final class JavaTypeResolver {
    ...
    /* renamed from: c */
    private final LazyJavaResolverContext f710c;
    ...
    public JavaTypeResolver(@NotNull LazyJavaResolverContext lazyJavaResolverContext, @NotNull TypeParameterResolver typeParameterResolver2) {
        ...
        this.f710c = lazyJavaResolverContext;
    ...
    public final KotlinType transformJavaType(@NotNull JavaType javaType, @NotNull JavaTypeAttributes javaTypeAttributes) {
        ...
        if (javaType instanceof JavaPrimitiveType) {
            ...
            if (type != null) {
                simpleType = this.f710c.getModule().getBuiltIns().getPrimitiveKotlinType(type);
            } else {
                simpleType = this.f710c.getModule().getBuiltIns().getUnitType();
            }
            ...
            if (javaType instanceof JavaArrayType) {
                ...
                SimpleType defaultBound = this.f710c.getModule().getBuiltIns().getDefaultBound();
    ...
    public final KotlinType transformArrayType(@NotNull JavaArrayType javaArrayType, @NotNull JavaTypeAttributes javaTypeAttributes, boolean z) {
        ...
        if (type != null) {
            SimpleType primitiveArrayKotlinType = this.f710c.getModule().getBuiltIns().getPrimitiveArrayKotlinType(type);
            String str = "jetType";
            if (javaTypeAttributes.isForAnnotationParameter()) {
                Intrinsics.checkExpressionValueIsNotNull(primitiveArrayKotlinType, str);
        ...
        if (javaTypeAttributes.isForAnnotationParameter()) {
            SimpleType arrayType = this.f710c.getModule().getBuiltIns().getArrayType(z ? Variance.OUT_VARIANCE : Variance.INVARIANT, transformJavaType);
            Intrinsics.checkExpressionValueIsNotNull(arrayType, "c.module.builtIns.getArr…ctionKind, componentType)");
            return arrayType;
        }
        SimpleType arrayType2 = this.f710c.getModule().getBuiltIns().getArrayType(Variance.INVARIANT, transformJavaType);
        Intrinsics.checkExpressionValueIsNotNull(arrayType2, "c.module.builtIns.getArr…INVARIANT, componentType)");
        return KotlinTypeFactory.flexibleType(arrayType2, this.f710c.getModule().getBuiltIns().getArrayType(Variance.OUT_VARIANCE, transformJavaType).makeNullableAsSpecified(true));
    }
    ...
    private final KotlinType transformJavaClassifierType(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes) {
        ...
        if (isRaw || z) {
            ...
            if (computeSimpleJavaClassifierType != null) {
                ...
                Intrinsics.checkExpressionValueIsNotNull(invoke, str);
                return invoke;
            }
            SimpleType invoke2 = javaTypeResolver$transformJavaClassifierType$1.invoke();
            Intrinsics.checkExpressionValueIsNotNull(invoke2, str);
            return invoke2;
        }
        ...
        if (computeSimpleJavaClassifierType3 == null) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(computeSimpleJavaClassifierType3, str);
        }
    ...
    private final kotlin.reflect.jvm.internal.impl.types.SimpleType computeSimpleJavaClassifierType(kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClassifierType r5, kotlin.reflect.jvm.internal.impl.load.java.lazy.types.JavaTypeAttributes r6, kotlin.reflect.jvm.internal.impl.types.SimpleType r7) {
        ...
        L_0x0009:
            ...
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r1 = r4.f710c
            r2 = r5
    ...
    private final kotlin.reflect.jvm.internal.impl.types.TypeConstructor computeTypeConstructor(kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClassifierType r4, kotlin.reflect.jvm.internal.impl.load.java.lazy.types.JavaTypeAttributes r5) {
        /*
            ...
            goto L_0x0028
        L_0x001a:
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r5 = r3.f710c
    ...
    private final TypeConstructor createNotFoundClass(JavaClassifierType javaClassifierType) {
        ...
        NotFoundClasses notFoundClasses = this.f710c.getComponents().getDeserializedDescriptorResolver().getComponents().getNotFoundClasses();
        Intrinsics.checkExpressionValueIsNotNull(classId, "classId");
        TypeConstructor typeConstructor = notFoundClasses.getClass(classId, CollectionsKt.listOf(Integer.valueOf(0))).getTypeConstructor();
    ...
    private final ClassDescriptor mapKotlinClass(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes, FqName fqName) {
        if (javaTypeAttributes.isForAnnotationParameter() && Intrinsics.areEqual((Object) fqName, (Object) JavaTypeResolverKt.JAVA_LANG_CLASS_FQ_NAME)) {
            return this.f710c.getComponents().getReflectionTypes().getKClass();
        }
        JavaToKotlinClassMap javaToKotlinClassMap = JavaToKotlinClassMap.INSTANCE;
        ClassDescriptor mapJavaToKotlin$default = JavaToKotlinClassMap.mapJavaToKotlin$default(javaToKotlinClassMap, fqName, this.f710c.getModule().getBuiltIns(), null, 4, null);
    ...
    private final List<TypeProjection> computeArguments(JavaClassifierType javaClassifierType, JavaTypeAttributes javaTypeAttributes, TypeConstructor typeConstructor) {
        ...
        if (z) {
            Intrinsics.checkExpressionValueIsNotNull(parameters, str2);
            ...
            for (TypeParameterDescriptor typeParameterDescriptor : iterable) {
                StorageManager storageManager = this.f710c.getStorageManager();
                ...
                Intrinsics.checkExpressionValueIsNotNull(typeParameterDescriptor, str);
                if (isRaw) {
            ...
            for (IndexedValue indexedValue : withIndex) {
                ...
                if (!_Assertions.ENABLED || z2) {
                    ...
                    Intrinsics.checkExpressionValueIsNotNull(typeParameterDescriptor3, str);
