...
public class ReadKotlinClassHeaderAnnotationVisitor implements AnnotationVisitor {
    ...
    /* access modifiers changed from: private */
    public JvmMetadataVersion metadataVersion = null;
    /* access modifiers changed from: private */
    ...
    public KotlinClassHeader createHeader() {
        ...
        KotlinClassHeader kotlinClassHeader = new KotlinClassHeader(kind, jvmMetadataVersion3, jvmBytecodeBinaryVersion, this.data, this.incompatibleData, this.strings, this.extraString, this.extraInt, this.packageName);
