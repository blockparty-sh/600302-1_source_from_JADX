...
public class SerializerExtensionProtocol {
    ...
    @NotNull
    private final GeneratedExtension<C3063Type, List<Annotation>> typeAnnotation;
    @NotNull
    private final GeneratedExtension<TypeParameter, List<Annotation>> typeParameterAnnotation;

    public SerializerExtensionProtocol(@NotNull ExtensionRegistryLite extensionRegistryLite, @NotNull GeneratedExtension<Package, Integer> generatedExtension, @NotNull GeneratedExtension<Constructor, List<Annotation>> generatedExtension2, @NotNull GeneratedExtension<Class, List<Annotation>> generatedExtension3, @NotNull GeneratedExtension<Function, List<Annotation>> generatedExtension4, @NotNull GeneratedExtension<Property, List<Annotation>> generatedExtension5, @NotNull GeneratedExtension<EnumEntry, List<Annotation>> generatedExtension6, @NotNull GeneratedExtension<Property, Value> generatedExtension7, @NotNull GeneratedExtension<ValueParameter, List<Annotation>> generatedExtension8, @NotNull GeneratedExtension<C3063Type, List<Annotation>> generatedExtension9, @NotNull GeneratedExtension<TypeParameter, List<Annotation>> generatedExtension10) {
    ...
    @NotNull
    public final GeneratedExtension<C3063Type, List<Annotation>> getTypeAnnotation() {
