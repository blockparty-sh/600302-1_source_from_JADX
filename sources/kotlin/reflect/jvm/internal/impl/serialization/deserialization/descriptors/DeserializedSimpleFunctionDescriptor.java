...
public final class DeserializedSimpleFunctionDescriptor extends SimpleFunctionDescriptorImpl implements DeserializedCallableMemberDescriptor {
    ...
    @NotNull
    public final SimpleFunctionDescriptorImpl initialize(@Nullable KotlinType kotlinType, @Nullable ReceiverParameterDescriptor receiverParameterDescriptor, @NotNull List<? extends TypeParameterDescriptor> list, @NotNull List<? extends ValueParameterDescriptor> list2, @Nullable KotlinType kotlinType2, @Nullable Modality modality, @NotNull Visibility visibility, @NotNull Map<? extends UserDataKey<?>, ?> map, boolean z) {
        ...
        SimpleFunctionDescriptorImpl initialize = super.initialize(kotlinType, receiverParameterDescriptor, list, list2, kotlinType2, modality, visibility, map);
