...
public final class DeserializedTypeAliasDescriptor extends AbstractTypeAliasDescriptor implements DeserializedMemberDescriptor {
    ...
    public final void initialize(@NotNull List<? extends TypeParameterDescriptor> list, @NotNull SimpleType simpleType, @NotNull SimpleType simpleType2, boolean z) {
    ...
    public TypeAliasDescriptor substitute(@NotNull TypeSubstitutor typeSubstitutor) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(safeSubstitute, str);
        ...
        Intrinsics.checkExpressionValueIsNotNull(safeSubstitute2, str);
        deserializedTypeAliasDescriptor.initialize(declaredTypeParameters, asSimpleType, TypeSubstitutionKt.asSimpleType(safeSubstitute2), isExperimentalCoroutineInReleaseEnvironment());
