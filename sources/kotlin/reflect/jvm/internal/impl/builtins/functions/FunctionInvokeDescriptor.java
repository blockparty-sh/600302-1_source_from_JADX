...
public final class FunctionInvokeDescriptor extends SimpleFunctionDescriptorImpl {
    ...
    public static final class Factory {
        ...
        public final FunctionInvokeDescriptor create(@NotNull FunctionClassDescriptor functionClassDescriptor, boolean z) {
            ...
            functionInvokeDescriptor.initialize((KotlinType) null, thisAsReceiverParameter, emptyList, (List) arrayList2, (KotlinType) ((TypeParameterDescriptor) CollectionsKt.last(declaredTypeParameters)).getDefaultType(), Modality.ABSTRACT, Visibilities.PUBLIC);
        ...
        private final ValueParameterDescriptor createValueParameter(FunctionInvokeDescriptor functionInvokeDescriptor, int i, TypeParameterDescriptor typeParameterDescriptor) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(asString, "typeParameterName");
            if (asString != null) {
    ...
    public FunctionDescriptor doSubstitute(@NotNull CopyConfiguration copyConfiguration) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(valueParameters, str);
        ...
        if (!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) {
            ...
            while (true) {
                ...
                Intrinsics.checkExpressionValueIsNotNull(valueParameterDescriptor, str3);
                KotlinType type = valueParameterDescriptor.getType();
                Intrinsics.checkExpressionValueIsNotNull(type, str2);
        ...
        Intrinsics.checkExpressionValueIsNotNull(valueParameters2, str);
        ...
        for (ValueParameterDescriptor valueParameterDescriptor2 : iterable2) {
            Intrinsics.checkExpressionValueIsNotNull(valueParameterDescriptor2, str3);
    ...
    private final FunctionDescriptor replaceParameterNames(List<Name> list) {
        ...
        if (!_Assertions.ENABLED || z3) {
            ...
            for (ValueParameterDescriptor valueParameterDescriptor : iterable) {
                ...
                Intrinsics.checkExpressionValueIsNotNull(name, "newName");
            ...
            FunctionDescriptor doSubstitute = super.doSubstitute(newCopyBuilder.setHasSynthesizedParameterNames(z2).setValueParameters(list2).setOriginal(getOriginal()));
