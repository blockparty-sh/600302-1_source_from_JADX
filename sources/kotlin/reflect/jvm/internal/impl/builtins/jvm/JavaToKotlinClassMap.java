...
public final class JavaToKotlinClassMap {
    private static final ClassId FUNCTION_N_CLASS_ID = ClassId.topLevel(new FqName("kotlin.jvm.functions.FunctionN"));
    ...
    static {
        ...
        String str3 = "kotlinReadOnly.packageFqName";
        Intrinsics.checkExpressionValueIsNotNull(packageFqName2, str3);
        FqName tail = FqNamesUtilKt.tail(fqName, packageFqName2);
        ClassId classId2 = new ClassId(packageFqName, tail, false);
        ...
        Intrinsics.checkExpressionValueIsNotNull(packageFqName4, str3);
        ClassId classId4 = new ClassId(packageFqName3, FqNamesUtilKt.tail(fqName2, packageFqName4), false);
        ClassId classId5 = ClassId.topLevel(KotlinBuiltIns.FQ_NAMES.collection);
        Intrinsics.checkExpressionValueIsNotNull(classId5, "ClassId.topLevel(FQ_NAMES.collection)");
        ...
        Intrinsics.checkExpressionValueIsNotNull(packageFqName6, str3);
        ClassId classId6 = new ClassId(packageFqName5, FqNamesUtilKt.tail(fqName3, packageFqName6), false);
        ...
        FqName packageFqName8 = classId7.getPackageFqName();
        Intrinsics.checkExpressionValueIsNotNull(packageFqName8, str3);
        ClassId classId8 = new ClassId(packageFqName7, FqNamesUtilKt.tail(fqName4, packageFqName8), false);
        ClassId classId9 = ClassId.topLevel(KotlinBuiltIns.FQ_NAMES.set);
        Intrinsics.checkExpressionValueIsNotNull(classId9, "ClassId.topLevel(FQ_NAMES.set)");
        FqName fqName5 = KotlinBuiltIns.FQ_NAMES.mutableSet;
        Intrinsics.checkExpressionValueIsNotNull(fqName5, "FQ_NAMES.mutableSet");
        FqName packageFqName9 = classId9.getPackageFqName();
        FqName packageFqName10 = classId9.getPackageFqName();
        Intrinsics.checkExpressionValueIsNotNull(packageFqName10, str3);
        ClassId classId10 = new ClassId(packageFqName9, FqNamesUtilKt.tail(fqName5, packageFqName10), false);
        ClassId classId11 = ClassId.topLevel(KotlinBuiltIns.FQ_NAMES.listIterator);
        Intrinsics.checkExpressionValueIsNotNull(classId11, "ClassId.topLevel(FQ_NAMES.listIterator)");
        ...
        FqName packageFqName11 = classId11.getPackageFqName();
        FqName packageFqName12 = classId11.getPackageFqName();
        Intrinsics.checkExpressionValueIsNotNull(packageFqName12, str3);
        ClassId classId12 = new ClassId(packageFqName11, FqNamesUtilKt.tail(fqName6, packageFqName12), false);
        ClassId classId13 = ClassId.topLevel(KotlinBuiltIns.FQ_NAMES.map);
        Intrinsics.checkExpressionValueIsNotNull(classId13, "ClassId.topLevel(FQ_NAMES.map)");
        FqName fqName7 = KotlinBuiltIns.FQ_NAMES.mutableMap;
        Intrinsics.checkExpressionValueIsNotNull(fqName7, "FQ_NAMES.mutableMap");
        FqName packageFqName13 = classId13.getPackageFqName();
        FqName packageFqName14 = classId13.getPackageFqName();
        Intrinsics.checkExpressionValueIsNotNull(packageFqName14, str3);
        ClassId classId14 = new ClassId(packageFqName13, FqNamesUtilKt.tail(fqName7, packageFqName14), false);
        ...
        Intrinsics.checkExpressionValueIsNotNull(packageFqName16, str3);
        mutabilityMappings = CollectionsKt.listOf(new PlatformMutabilityMapping(javaToKotlinClassMap.classId(Iterable.class), classId, classId2), new PlatformMutabilityMapping(javaToKotlinClassMap.classId(Iterator.class), classId3, classId4), new PlatformMutabilityMapping(javaToKotlinClassMap.classId(Collection.class), classId5, classId6), new PlatformMutabilityMapping(javaToKotlinClassMap.classId(List.class), classId7, classId8), new PlatformMutabilityMapping(javaToKotlinClassMap.classId(Set.class), classId9, classId10), new PlatformMutabilityMapping(javaToKotlinClassMap.classId(ListIterator.class), classId11, classId12), new PlatformMutabilityMapping(javaToKotlinClassMap.classId(Map.class), classId13, classId14), new PlatformMutabilityMapping(javaToKotlinClassMap.classId(Entry.class), createNestedClassId, new ClassId(packageFqName15, FqNamesUtilKt.tail(fqName8, packageFqName16), false)));
        ...
        for (JvmPrimitiveType jvmPrimitiveType : JvmPrimitiveType.values()) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(classId15, "ClassId.topLevel(jvmType.wrapperFqName)");
            ClassId classId16 = ClassId.topLevel(KotlinBuiltIns.getPrimitiveFqName(jvmPrimitiveType.getPrimitiveType()));
            Intrinsics.checkExpressionValueIsNotNull(classId16, "ClassId.topLevel(KotlinB…e(jvmType.primitiveType))");
        ...
        for (ClassId classId17 : CompanionObjectMapping.INSTANCE.allClassesWithIntrinsicCompanions()) {
            ...
            sb3.append("kotlin.jvm.internal.");
            sb3.append(classId17.getShortClassName().asString());
            sb3.append("CompanionObject");
            ClassId classId18 = ClassId.topLevel(new FqName(sb3.toString()));
            Intrinsics.checkExpressionValueIsNotNull(classId18, "ClassId.topLevel(FqName(…g() + \"CompanionObject\"))");
            ClassId createNestedClassId2 = classId17.createNestedClassId(SpecialNames.DEFAULT_NAME_FOR_COMPANION_OBJECT);
            Intrinsics.checkExpressionValueIsNotNull(createNestedClassId2, "classId.createNestedClas…AME_FOR_COMPANION_OBJECT)");
            javaToKotlinClassMap.add(classId18, createNestedClassId2);
        }
        int i = 0;
        while (true) {
            str = "K_FUNCTION_CLASS_ID";
            if (i >= 23) {
                break;
            }
            StringBuilder sb4 = new StringBuilder();
            sb4.append("kotlin.jvm.functions.Function");
            sb4.append(i);
            ClassId classId19 = ClassId.topLevel(new FqName(sb4.toString()));
            Intrinsics.checkExpressionValueIsNotNull(classId19, "ClassId.topLevel(FqName(…m.functions.Function$i\"))");
            ...
            javaToKotlinClassMap.add(classId19, functionClassId);
            StringBuilder sb5 = new StringBuilder();
            sb5.append(NUMBERED_K_FUNCTION_PREFIX);
            sb5.append(i);
            FqName fqName12 = new FqName(sb5.toString());
            ClassId classId20 = K_FUNCTION_CLASS_ID;
            Intrinsics.checkExpressionValueIsNotNull(classId20, str);
            javaToKotlinClassMap.addKotlinToJava(fqName12, classId20);
            i++;
        }
        for (int i2 = 0; i2 < 22; i2++) {
            Kind kind = Kind.KSuspendFunction;
            StringBuilder sb6 = new StringBuilder();
            sb6.append(kind.getPackageFqName().toString());
            sb6.append(str2);
            sb6.append(kind.getClassNamePrefix());
            String sb7 = sb6.toString();
            StringBuilder sb8 = new StringBuilder();
            sb8.append(sb7);
            sb8.append(i2);
            FqName fqName13 = new FqName(sb8.toString());
            ClassId classId21 = K_FUNCTION_CLASS_ID;
            Intrinsics.checkExpressionValueIsNotNull(classId21, str);
            javaToKotlinClassMap.addKotlinToJava(fqName13, classId21);
        }
    ...
    public final ClassDescriptor convertMutableToReadOnly(@NotNull ClassDescriptor classDescriptor) {
        String str = "mutable";
        Intrinsics.checkParameterIsNotNull(classDescriptor, str);
        return convertToOppositeMutability(classDescriptor, mutableToReadOnly, str);
    }
