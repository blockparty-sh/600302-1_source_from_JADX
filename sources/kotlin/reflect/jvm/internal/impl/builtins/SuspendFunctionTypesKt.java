...
public final class SuspendFunctionTypesKt {
    ...
    static {
        ...
        Intrinsics.checkExpressionValueIsNotNull(errorModule, str);
        ...
        mutableClassDescriptor.setTypeParameterDescriptors(CollectionsKt.listOf(TypeParameterDescriptorImpl.createWithDefaultBound(declarationDescriptor, empty, false, variance, Name.identifier(str2), 0)));
        ...
        Intrinsics.checkExpressionValueIsNotNull(errorModule2, str);
        ...
        mutableClassDescriptor2.setTypeParameterDescriptors(CollectionsKt.listOf(TypeParameterDescriptorImpl.createWithDefaultBound(mutableClassDescriptor2, Annotations.Companion.getEMPTY(), false, Variance.IN_VARIANCE, Name.identifier(str2), 0)));
