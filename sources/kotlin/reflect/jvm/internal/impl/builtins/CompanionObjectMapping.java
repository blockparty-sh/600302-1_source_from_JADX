...
public final class CompanionObjectMapping {
    ...
    static {
        ...
        Iterable<FqName> plus = CollectionsKt.plus((Collection<? extends T>) CollectionsKt.plus((Collection<? extends T>) (List) arrayList, KotlinBuiltIns.FQ_NAMES.string.toSafe()), KotlinBuiltIns.FQ_NAMES._enum.toSafe());
