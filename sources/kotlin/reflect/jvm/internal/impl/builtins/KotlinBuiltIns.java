...
public abstract class KotlinBuiltIns {
    ...
    public static final Set<FqName> BUILT_INS_PACKAGE_FQ_NAMES = SetsKt.setOf(BUILT_INS_PACKAGE_FQ_NAME, COLLECTIONS_PACKAGE_FQ_NAME, RANGES_PACKAGE_FQ_NAME, ANNOTATION_PACKAGE_FQ_NAME, ReflectionTypesKt.getKOTLIN_REFLECT_FQ_NAME(), BUILT_INS_PACKAGE_FQ_NAME.child(Name.identifier("internal")));
    ...
    public static final FqName TEXT_PACKAGE_FQ_NAME = BUILT_INS_PACKAGE_FQ_NAME.child(Name.identifier(TextBundle.TEXT_ENTRY));
    ...
    protected KotlinBuiltIns(@NotNull StorageManager storageManager2) {
        ...
        this.unsignedPrimitives = storageManager2.createMemoizedFunction(new Function1<ModuleDescriptor, UnsignedPrimitives>() {
            public UnsignedPrimitives invoke(ModuleDescriptor moduleDescriptor) {
                UnsignedType[] values;
                HashMap hashMap = new HashMap();
                HashMap hashMap2 = new HashMap();
                for (UnsignedType unsignedType : UnsignedType.values()) {
                    ClassDescriptor findClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedType.getClassId());
                    if (findClassAcrossModuleDependencies != null) {
                        ClassDescriptor findClassAcrossModuleDependencies2 = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedType.getArrayClassId());
        ...
        this.suspendFunctionClasses = storageManager2.createMemoizedFunction(new Function1<Integer, ClassDescriptor>() {
    ...
    public kotlin.reflect.jvm.internal.impl.descriptors.PackageFragmentDescriptor createPackage(@org.jetbrains.annotations.NotNull kotlin.reflect.jvm.internal.impl.descriptors.PackageFragmentProvider r7, @org.jetbrains.annotations.Nullable java.util.Map<kotlin.reflect.jvm.internal.impl.name.FqName, kotlin.reflect.jvm.internal.impl.descriptors.PackageFragmentDescriptor> r8, @org.jetbrains.annotations.NotNull kotlin.reflect.jvm.internal.impl.name.FqName r9) {
        ...
        L_0x0012:
            ...
            goto L_0x002f
        L_0x0024:
            kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns$7 r7 = new kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns$7
    ...
    public KotlinType getArrayElementType(@NotNull KotlinType kotlinType) {
        if (!isArray(kotlinType)) {
            ...
            if (containingModuleOrNull != null) {
                SimpleType simpleType = (SimpleType) ((UnsignedPrimitives) this.unsignedPrimitives.invoke(containingModuleOrNull)).kotlinArrayTypeToUnsignedKotlinType.get(makeNotNullable);
                if (simpleType != null) {
                    return simpleType;
                }
            }
    ...
    public SimpleType getPrimitiveArrayKotlinTypeByPrimitiveKotlinType(@NotNull KotlinType kotlinType) {
        ...
        return (SimpleType) ((UnsignedPrimitives) this.unsignedPrimitives.invoke(containingModuleOrNull)).unsignedKotlinTypeToKotlinArrayType.get(kotlinType);
    }
