...
public final class TypeParameterUtilsKt {
    ...
    public static final List<TypeParameterDescriptor> computeConstructorTypeParameters(@NotNull ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters) {
        List list;
        Object obj;
        Intrinsics.checkParameterIsNotNull(classifierDescriptorWithTypeParameters, "$receiver");
        List<TypeParameterDescriptor> declaredTypeParameters = classifierDescriptorWithTypeParameters.getDeclaredTypeParameters();
        String str = "declaredParameters";
        if (classifierDescriptorWithTypeParameters.isInner() || (classifierDescriptorWithTypeParameters.getContainingDeclaration() instanceof CallableDescriptor)) {
            DeclarationDescriptor declarationDescriptor = classifierDescriptorWithTypeParameters;
            List list2 = SequencesKt.toList(SequencesKt.flatMap(SequencesKt.takeWhile(DescriptorUtilsKt.getParents(declarationDescriptor), C2950x246a49e2.INSTANCE), C2951x246a49e3.INSTANCE));
            ...
            if (!list2.isEmpty() || !list.isEmpty()) {
                ...
                Intrinsics.checkExpressionValueIsNotNull(declaredTypeParameters, str);
                return CollectionsKt.plus((Collection<? extends T>) declaredTypeParameters, (Iterable<? extends T>) list3);
            }
