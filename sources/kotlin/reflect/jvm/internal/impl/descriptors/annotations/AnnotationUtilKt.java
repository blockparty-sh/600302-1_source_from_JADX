...
public final class AnnotationUtilKt {
    private static final Name DEPRECATED_LEVEL_NAME = Name.identifier(Param.LEVEL);
    ...
    public static final AnnotationDescriptor createDeprecatedAnnotation(@NotNull KotlinBuiltIns kotlinBuiltIns, @NotNull String str, @NotNull String str2, @NotNull String str3) {
        ...
        BuiltInAnnotationDescriptor builtInAnnotationDescriptor = new BuiltInAnnotationDescriptor(kotlinBuiltIns, fqName, MapsKt.mapOf(TuplesKt.m309to(REPLACE_WITH_EXPRESSION_NAME, new StringValue(str2)), TuplesKt.m309to(REPLACE_WITH_IMPORTS_NAME, new ArrayValue(CollectionsKt.emptyList(), new C2964xf14e0c1a(kotlinBuiltIns)))));
        ...
        return new BuiltInAnnotationDescriptor(kotlinBuiltIns, fqName2, MapsKt.mapOf(TuplesKt.m309to(DEPRECATED_MESSAGE_NAME, new StringValue(str)), TuplesKt.m309to(DEPRECATED_REPLACE_WITH_NAME, new AnnotationValue(builtInAnnotationDescriptor)), TuplesKt.m309to(name, new EnumValue(classId, identifier))));
    }
