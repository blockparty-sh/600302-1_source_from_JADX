...
public final class FilteredAnnotations implements Annotations {
    ...
    public List<AnnotationWithTarget> getUseSiteTargetedAnnotations() {
        Iterable useSiteTargetedAnnotations = this.delegate.getUseSiteTargetedAnnotations();
        Collection arrayList = new ArrayList();
        for (Object next : useSiteTargetedAnnotations) {
    ...
    public List<AnnotationWithTarget> getAllAnnotations() {
        Iterable allAnnotations = this.delegate.getAllAnnotations();
        Collection arrayList = new ArrayList();
        for (Object next : allAnnotations) {
            if (shouldBeReturned(((AnnotationWithTarget) next).getAnnotation())) {
                arrayList.add(next);
            }
        }
