...
public final class CompositeAnnotations implements Annotations {
    ...
    public List<AnnotationWithTarget> getUseSiteTargetedAnnotations() {
        ...
        for (Annotations useSiteTargetedAnnotations : iterable) {
            CollectionsKt.addAll(arrayList, (Iterable<? extends T>) useSiteTargetedAnnotations.getUseSiteTargetedAnnotations());
        }
    ...
    public List<AnnotationWithTarget> getAllAnnotations() {
        Iterable<Annotations> iterable = this.delegates;
        Collection arrayList = new ArrayList();
        for (Annotations allAnnotations : iterable) {
            CollectionsKt.addAll(arrayList, (Iterable<? extends T>) allAnnotations.getAllAnnotations());
        }
        return (List) arrayList;
    }
