...
public final class TypeAliasConstructorDescriptorImpl extends FunctionDescriptorImpl implements TypeAliasConstructorDescriptor {
                ...
                if (substitute != null) {
                    ...
                    if (substitutedValueParameters != null) {
                        ...
                        if (dispatchReceiverParameter != null) {
                            ...
                            kotlinType = typeSubstitutorForUnderlyingClass.safeSubstitute(dispatchReceiverParameter.getType(), Variance.INVARIANT);
                        }
                        typeAliasConstructorDescriptorImpl.initialize(kotlinType, null, typeAliasDescriptor.getDeclaredTypeParameters(), substitutedValueParameters, withAbbreviation, Modality.FINAL, typeAliasDescriptor.getVisibility());
    ...
    public TypeAliasConstructorDescriptor substitute(@NotNull TypeSubstitutor typeSubstitutor) {
        ...
        if (substitute != null) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(create, "underlyingConstructorSubstitutor");
            ClassConstructorDescriptor substitute2 = original.substitute(create);
            if (substitute2 == null) {
                return null;
            }
