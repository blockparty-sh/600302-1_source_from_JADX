...
public abstract class TypeConstructorSubstitution extends TypeSubstitution {
    ...
    public static final class Companion {
        ...
        @NotNull
        @JvmOverloads
        public static /* bridge */ /* synthetic */ TypeConstructorSubstitution createByConstructorsMap$default(Companion companion, Map map, boolean z, int i, Object obj) {
            if ((i & 2) != 0) {
                z = false;
            }
        ...
        public final TypeSubstitution create(@NotNull TypeConstructor typeConstructor, @NotNull List<? extends TypeProjection> list) {
            ...
            return createByConstructorsMap$default(companion, MapsKt.toMap((Iterable<? extends Pair<? extends K, ? extends V>>) CollectionsKt.zip((Iterable<? extends T>) (List) arrayList, (Iterable<? extends R>) list)), false, 2, null);
        }
    }
