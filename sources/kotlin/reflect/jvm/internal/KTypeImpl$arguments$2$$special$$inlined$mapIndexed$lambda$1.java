...
@Metadata(mo37403bv = {1, 0, 2}, mo37404d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002¨\u0006\u0003"}, mo37405d2 = {"<anonymous>", "Ljava/lang/reflect/Type;", "invoke", "kotlin/reflect/jvm/internal/KTypeImpl$arguments$2$1$type$1"}, mo37406k = 3, mo37407mv = {1, 1, 11})
/* compiled from: KTypeImpl.kt */
final class KTypeImpl$arguments$2$$special$$inlined$mapIndexed$lambda$1 extends Lambda implements Function0<Type> {

    /* renamed from: $i */
    final /* synthetic */ int f491$i;
    ...
    public final Type invoke() {
        ...
        if (javaType$kotlin_reflect_api instanceof Class) {
            ...
            Type type = (Type) ((List) lazy.getValue()).get(this.f491$i);
