...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl {
    ...
    public final class Data extends kotlin.reflect.jvm.internal.KDeclarationContainerImpl.Data {
        ...
        public final String calculateLocalClassName(Class<?> cls) {
            ...
            if (enclosingMethod != null) {
                Intrinsics.checkExpressionValueIsNotNull(simpleName, str2);
    ...
    public Collection<PropertyDescriptor> getProperties(@NotNull Name name) {
        ...
        return CollectionsKt.plus(getMemberScope$kotlin_reflect_api().getContributedVariables(name, NoLookupLocation.FROM_REFLECTION), (Iterable) getStaticScope$kotlin_reflect_api().getContributedVariables(name, NoLookupLocation.FROM_REFLECTION));
    }

    @NotNull
    public Collection<FunctionDescriptor> getFunctions(@NotNull Name name) {
        Intrinsics.checkParameterIsNotNull(name, "name");
        return CollectionsKt.plus(getMemberScope$kotlin_reflect_api().getContributedFunctions(name, NoLookupLocation.FROM_REFLECTION), (Iterable) getStaticScope$kotlin_reflect_api().getContributedFunctions(name, NoLookupLocation.FROM_REFLECTION));
    }
    ...
    public PropertyDescriptor getLocalProperty(int i) {
        ...
        if (deserializedClassDescriptor != null) {
            ExtendableMessage classProto = deserializedClassDescriptor.getClassProto();
