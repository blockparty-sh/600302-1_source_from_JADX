...
public final class Options {
    ...
    public static int DECRYPTION_BLOCK_SIZE = 0;
    public static int ENCRYPTION_BLOCK_SIZE = 0;
    ...
    static {
        if (C2652Utils.isJellyBean()) {
            ENCRYPTION_BLOCK_SIZE = RSA_ECB_PKCS1PADDING_ENCRYPTION_BLOCK_SIZE_FOR_JELLY_BEAN;
            DECRYPTION_BLOCK_SIZE = 256;
            return;
        }
        ENCRYPTION_BLOCK_SIZE = 117;
        DECRYPTION_BLOCK_SIZE = 128;
    }
}
