...
public class RequestCreator {
    ...
    public Bitmap get() throws IOException {
        ...
        if (this.deferred) {
            ...
            GetAction getAction = new GetAction(this.picasso, createRequest, this.memoryPolicy, this.networkPolicy, this.tag, C2643Utils.createKey(createRequest, new StringBuilder()));
    ...
    public void fetch(@Nullable Callback callback) {
        ...
        if (!this.deferred) {
            if (this.data.hasImage()) {
                ...
                Request createRequest = createRequest(nanoTime);
                String createKey = C2643Utils.createKey(createRequest, new StringBuilder());
                if (!MemoryPolicy.shouldReadFromMemoryCache(this.memoryPolicy) || this.picasso.quickMemoryCacheCheck(createKey) == null) {
                    ...
                    if (this.picasso.loggingEnabled) {
                        ...
                        C2643Utils.log("Main", "completed", plainId, sb.toString());
                    }
                    if (callback != null) {
                        callback.onSuccess();
                    }
    ...
    public void into(@NonNull Target target) {
        ...
        if (target == null) {
            ...
            Request createRequest = createRequest(nanoTime);
            String createKey = C2643Utils.createKey(createRequest);
    ...
    public void into(@NonNull RemoteViews remoteViews, @IdRes int i, int i2, @NonNull Notification notification, @Nullable String str, Callback callback) {
        ...
        if (remoteViews == null) {
            ...
            String str2 = str;
            NotificationAction notificationAction = new NotificationAction(this.picasso, createRequest, remoteViews2, i3, i4, notification2, str2, this.memoryPolicy, this.networkPolicy, C2643Utils.createKey(createRequest, new StringBuilder()), this.tag, this.errorResId, callback);
    ...
    public void into(@NonNull RemoteViews remoteViews, @IdRes int i, @NonNull int[] iArr, Callback callback) {
        ...
        if (remoteViews == null) {
            ...
            int i2 = i;
            int[] iArr2 = iArr;
            AppWidgetAction appWidgetAction = new AppWidgetAction(this.picasso, createRequest, remoteViews2, i2, iArr2, this.memoryPolicy, this.networkPolicy, C2643Utils.createKey(createRequest, new StringBuilder()), this.tag, this.errorResId, callback);
    ...
    private Request createRequest(long j) {
        ...
        build.f670id = andIncrement;
        build.started = j;
        boolean z = this.picasso.loggingEnabled;
        String str = "Main";
        if (z) {
            C2643Utils.log(str, "created", build.plainId(), build.toString());
        }
        Request transformRequest = this.picasso.transformRequest(build);
        if (transformRequest != build) {
            transformRequest.f670id = andIncrement;
            ...
            if (z) {
                ...
                C2643Utils.log(str, "changed", logId, sb.toString());
            }
        }
