...
public abstract class RequestHandler {
    ...
    public static final class Result {
        ...
        public Result(@NonNull Bitmap bitmap2, @NonNull LoadedFrom loadedFrom2) {
            this((Bitmap) C2643Utils.checkNotNull(bitmap2, "bitmap == null"), null, loadedFrom2, 0);
        }

        public Result(@NonNull Source source2, @NonNull LoadedFrom loadedFrom2) {
            this(null, (Source) C2643Utils.checkNotNull(source2, "source == null"), loadedFrom2, 0);
        }
        ...
        Result(@Nullable Bitmap bitmap2, @Nullable Source source2, @NonNull LoadedFrom loadedFrom2, int i) {
            ...
            if (z2 != z) {
                this.bitmap = bitmap2;
                this.source = source2;
                this.loadedFrom = (LoadedFrom) C2643Utils.checkNotNull(loadedFrom2, "loadedFrom == null");
