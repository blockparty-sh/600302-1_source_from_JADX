...
class ResourceRequestHandler extends RequestHandler {
    ...
    public Result load(Request request, int i) throws IOException {
        Resources resources = C2643Utils.getResources(this.context, request);
        return new Result(decodeResource(resources, C2643Utils.getResourceId(resources, request), request), LoadedFrom.DISK);
    }
