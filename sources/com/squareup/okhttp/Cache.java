...
import com.squareup.okhttp.internal.p013io.FileSystem;
...
public final class Cache {
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) throws IOException {
            try {
                ...
                for (int i = 0; i < size; i++) {
                    bufferedSink.writeUtf8(ByteString.m329of(((Certificate) list.get(i)).getEncoded()).base64());
                    bufferedSink.writeByte(10);
                }
    ...
    public CacheRequest put(Response response) throws IOException {
        ...
        if (HttpMethod.invalidatesCache(response.request().method())) {
            ...
            return null;
        } else if (!method.equals(DefaultHttpClient.METHOD_GET) || OkHeaders.hasVaryAll(response)) {
            return null;
        } else {
