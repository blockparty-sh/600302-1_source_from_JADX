...
public final class MultipartBuilder {
    ...
    /* access modifiers changed from: private */
    public static final byte[] CRLF = {Ascii.f519CR, 10};
    /* access modifiers changed from: private */
    public static final byte[] DASHDASH = {Framer.STDIN_FRAME_PREFIX, Framer.STDIN_FRAME_PREFIX};
    ...
    public MultipartBuilder addFormDataPart(String str, String str2, RequestBody requestBody) {
        if (str != null) {
            ...
            return addPart(Headers.m291of(HttpHeaders.CONTENT_DISPOSITION, sb.toString()), requestBody);
        }
