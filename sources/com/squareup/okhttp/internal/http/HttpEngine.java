...
public final class HttpEngine {
    ...
    private Connection createNextConnection() throws RouteException {
        ...
        while (true) {
            ...
            } else if (this.networkRequest.method().equals(DefaultHttpClient.METHOD_GET) || Internal.instance.isReadable(connection2)) {
                return connection2;
            } else {
    ...
    private Response unzip(Response response) throws IOException {
        if (this.transparentGzip) {
            ...
            if ("gzip".equalsIgnoreCase(response2.header(str))) {
                ...
                Headers build = response.headers().newBuilder().removeAll(str).removeAll("Content-Length").build();
    ...
    private Request networkRequest(Request request) throws IOException {
        ...
        Connection connection2 = this.connection;
        if (connection2 == null || connection2.getProtocol() != Protocol.HTTP_1_0) {
                    ...
                    if (this.sentRequestMillis == -1) {
                        if (OkHeaders.contentLength(this.networkRequest) == -1) {
                            ...
                            if (sink instanceof RetryableSink) {
                                ...
                                this.networkRequest = this.networkRequest.newBuilder().header(str, Long.toString(((RetryableSink) sink).contentLength())).build();
                            }
                        }
                        this.transport.writeRequestHeaders(this.networkRequest);
                    }
    ...
    public Request followUpRequest() throws IOException {
        ...
        if (this.userResponse != null) {
            ...
            String str = DefaultHttpClient.METHOD_GET;
            ...
            } else if (!this.userRequest.method().equals(str) && !this.userRequest.method().equals("HEAD")) {
                return null;
            }
