...
public final class FramedTransport implements Transport {
    ...
    static {
        ...
        String str5 = "transfer-encoding";
        SPDY_3_PROHIBITED_HEADERS = Util.immutableList((T[]) new ByteString[]{ByteString.encodeUtf8(str), ByteString.encodeUtf8(str2), ByteString.encodeUtf8(str3), ByteString.encodeUtf8(str4), ByteString.encodeUtf8(str5)});
        HTTP_2_PROHIBITED_HEADERS = Util.immutableList((T[]) new ByteString[]{ByteString.encodeUtf8(str), ByteString.encodeUtf8(str2), ByteString.encodeUtf8(str3), ByteString.encodeUtf8(str4), ByteString.encodeUtf8("te"), ByteString.encodeUtf8(str5), ByteString.encodeUtf8("encoding"), ByteString.encodeUtf8("upgrade")});
    }
