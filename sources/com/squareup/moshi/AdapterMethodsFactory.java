...
final class AdapterMethodsFactory implements Factory {
    ...
    public JsonAdapter<?> create(Type type, Set<? extends Annotation> set, Moshi moshi) {
        ...
        C25421 r1 = new JsonAdapter<Object>() {
            ...
            for (Method method : cls.getDeclaredMethods()) {
                ...
                if (method.isAnnotationPresent(ToJson.class)) {
                    ...
                    if (adapterMethod == null) {
                        ...
                        sb.append(adapterMethod.method);
                        sb.append(str);
                        sb.append(adapter.method);
                ...
                if (method.isAnnotationPresent(FromJson.class)) {
                    ...
                    if (adapterMethod2 == null) {
                        ...
                        sb2.append(adapterMethod2.method);
                        sb2.append(str);
                        sb2.append(fromAdapter.method);
    ...
    static AdapterMethod toAdapter(Object obj, Method method) {
        ...
        if (genericParameterTypes.length >= 2 && genericParameterTypes[0] == JsonWriter.class && genericReturnType == Void.TYPE && parametersAreJsonAdapters(2, genericParameterTypes)) {
            C25432 r0 = new AdapterMethod(genericParameterTypes[1], Util.jsonAnnotations(parameterAnnotations[1]), obj, method, genericParameterTypes.length, 2, true) {
                public void toJson(Moshi moshi, JsonWriter jsonWriter, @Nullable Object obj) throws IOException, InvocationTargetException {
            ...
            final Set jsonAnnotations = Util.jsonAnnotations((AnnotatedElement) method);
            final Set jsonAnnotations2 = Util.jsonAnnotations(parameterAnnotations[0]);
            Set set = jsonAnnotations2;
            Object obj2 = obj;
            Method method2 = method;
            C25443 r02 = new AdapterMethod(genericParameterTypes[0], set, obj2, method2, genericParameterTypes.length, 1, Util.hasNullable(parameterAnnotations[0])) {
    ...
    static AdapterMethod fromAdapter(Object obj, Method method) {
        ...
        if (genericParameterTypes.length >= 1 && genericParameterTypes[0] == JsonReader.class && genericReturnType != Void.TYPE && parametersAreJsonAdapters(1, genericParameterTypes)) {
            C25454 r1 = new AdapterMethod(genericReturnType, jsonAnnotations, obj, method, genericParameterTypes.length, 1, true) {
                public Object fromJson(Moshi moshi, JsonReader jsonReader) throws IOException, InvocationTargetException {
            ...
            Set set = jsonAnnotations;
            Object obj2 = obj;
            Method method2 = method;
            C25465 r12 = new AdapterMethod(type, set, obj2, method2, genericParameterTypes.length, 1, Util.hasNullable(parameterAnnotations[0])) {
