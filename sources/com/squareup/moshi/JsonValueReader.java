...
final class JsonValueReader extends JsonReader {
    ...
    static final class JsonIterator implements Iterator<Object>, Cloneable {
        ...
        JsonIterator(Token token, Object[] objArr, int i) {
            this.endToken = token;
            this.array = objArr;
            this.next = i;
        }
    ...
    public boolean nextBoolean() throws IOException {
        Boolean bool = (Boolean) require(Boolean.class, Token.BOOLEAN);
        remove();
    ...
    public void skipValue() throws IOException {
        if (!this.failOnUnknown) {
            ...
            if ((this.stackSize != 0 ? this.stack[this.stackSize - 1] : null) instanceof Entry) {
                this.stack[this.stackSize - 1] = ((Entry) this.stack[this.stackSize - 1]).getValue();
