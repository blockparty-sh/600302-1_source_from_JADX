...
final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    LinkedHashTreeMap(java.util.Comparator r2) {
        ...
        L_0x000d:
            r1.comparator = r2
            com.squareup.moshi.LinkedHashTreeMap$Node r2 = new com.squareup.moshi.LinkedHashTreeMap$Node
            r2.<init>()
            r1.header = r2
            r2 = 16
            com.squareup.moshi.LinkedHashTreeMap$Node[] r2 = new com.squareup.moshi.LinkedHashTreeMap.Node[r2]
            r1.table = r2
            com.squareup.moshi.LinkedHashTreeMap$Node<K, V>[] r2 = r1.table
            int r0 = r2.length
            int r0 = r0 / 2
            int r2 = r2.length
            int r2 = r2 / 4
