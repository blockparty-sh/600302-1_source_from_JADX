...
public class CustomProperties {
    ...
    private boolean isValidKey(String str) {
        ...
        if (str == null || !KEY_PATTERN.matcher(str).matches()) {
            ...
            AppCenterLog.error(str3, sb2.toString());
            return false;
        } else {
            if (this.mProperties.containsKey(str)) {
                ...
                AppCenterLog.warn(str3, sb3.toString());
            }
            return true;
        }
    }
    ...
    private boolean isValidStringValue(String str, String str2) {
        String str3 = "AppCenter";
        if (str2 == null) {
            AppCenterLog.error(str3, VALUE_NULL_ERROR_MESSAGE);
            return false;
    ...
    private boolean isValidNumberValue(String str, Number number) {
        ...
        if (number == null) {
            AppCenterLog.error(str2, VALUE_NULL_ERROR_MESSAGE);
            return false;
        }
