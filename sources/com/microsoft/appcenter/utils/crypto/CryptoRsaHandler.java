...
class CryptoRsaHandler implements CryptoHandler {
    ...
    public void generateKey(ICryptoFactory iCryptoFactory, String str, Context context) throws Exception {
        ...
        instance.add(1, 1);
        KeyPairGenerator instance2 = KeyPairGenerator.getInstance(Options.ALGORITHM_RSA, SecureStorageKt.ANDROID_KEY_STORE);
    ...
    private ICipher getCipher(ICryptoFactory iCryptoFactory, int i) throws Exception {
        return iCryptoFactory.getCipher(Options.RSA_ECB_PKCS1PADDING, i >= 23 ? "AndroidKeyStoreBCWorkaround" : "AndroidOpenSSL");
    }
