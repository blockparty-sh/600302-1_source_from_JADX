...
public class AppCenter {
    ...
    @IntRange(from = 2, mo644to = 8)
    public static int getLogLevel() {
        return AppCenterLog.getLogLevel();
    }

    public static void setLogLevel(@IntRange(from = 2, mo644to = 8) int i) {
    ...
    private synchronized boolean configureInstance(android.app.Application r4, java.lang.String r5, final boolean r6) {
        /*
            ...
            com.microsoft.appcenter.utils.AppCenterLog.error(r4, r5)     // Catch:{ all -> 0x008d }
            monitor-exit(r3)
            return r0
        L_0x000d:
            boolean r1 = r3.mLogLevelConfigured     // Catch:{ all -> 0x008d }
            if (r1 != 0) goto L_0x001f
            android.content.pm.ApplicationInfo r1 = r4.getApplicationInfo()     // Catch:{ all -> 0x008d }
            int r1 = r1.flags     // Catch:{ all -> 0x008d }
            r2 = 2
            r1 = r1 & r2
            if (r1 != r2) goto L_0x001f
            r1 = 5
            com.microsoft.appcenter.utils.AppCenterLog.setLogLevel(r1)     // Catch:{ all -> 0x008d }
        L_0x001f:
            java.lang.String r1 = r3.mAppSecret     // Catch:{ all -> 0x008d }
            if (r6 == 0) goto L_0x002b
            boolean r5 = r3.configureSecretString(r5)     // Catch:{ all -> 0x008d }
            if (r5 != 0) goto L_0x002b
            monitor-exit(r3)
            return r0
        L_0x002b:
            android.os.Handler r5 = r3.mHandler     // Catch:{ all -> 0x008d }
            r0 = 1
            if (r5 == 0) goto L_0x0048
            java.lang.String r4 = r3.mAppSecret     // Catch:{ all -> 0x008d }
            if (r4 == 0) goto L_0x0046
            java.lang.String r4 = r3.mAppSecret     // Catch:{ all -> 0x008d }
            boolean r4 = r4.equals(r1)     // Catch:{ all -> 0x008d }
            if (r4 != 0) goto L_0x0046
            android.os.Handler r4 = r3.mHandler     // Catch:{ all -> 0x008d }
            com.microsoft.appcenter.AppCenter$4 r5 = new com.microsoft.appcenter.AppCenter$4     // Catch:{ all -> 0x008d }
            r5.<init>()     // Catch:{ all -> 0x008d }
            r4.post(r5)     // Catch:{ all -> 0x008d }
        L_0x0046:
            monitor-exit(r3)
            return r0
        L_0x0048:
            r3.mApplication = r4     // Catch:{ all -> 0x008d }
            android.os.HandlerThread r4 = new android.os.HandlerThread     // Catch:{ all -> 0x008d }
            java.lang.String r5 = "AppCenter.Looper"
            r4.<init>(r5)     // Catch:{ all -> 0x008d }
            r3.mHandlerThread = r4     // Catch:{ all -> 0x008d }
            android.os.HandlerThread r4 = r3.mHandlerThread     // Catch:{ all -> 0x008d }
            r4.start()     // Catch:{ all -> 0x008d }
            android.os.Handler r4 = new android.os.Handler     // Catch:{ all -> 0x008d }
            android.os.HandlerThread r5 = r3.mHandlerThread     // Catch:{ all -> 0x008d }
            android.os.Looper r5 = r5.getLooper()     // Catch:{ all -> 0x008d }
            r4.<init>(r5)     // Catch:{ all -> 0x008d }
            r3.mHandler = r4     // Catch:{ all -> 0x008d }
            com.microsoft.appcenter.AppCenter$5 r4 = new com.microsoft.appcenter.AppCenter$5     // Catch:{ all -> 0x008d }
            r4.<init>()     // Catch:{ all -> 0x008d }
            r3.mAppCenterHandler = r4     // Catch:{ all -> 0x008d }
            java.util.HashSet r4 = new java.util.HashSet     // Catch:{ all -> 0x008d }
            r4.<init>()     // Catch:{ all -> 0x008d }
            r3.mServices = r4     // Catch:{ all -> 0x008d }
            java.util.HashSet r4 = new java.util.HashSet     // Catch:{ all -> 0x008d }
            r4.<init>()     // Catch:{ all -> 0x008d }
            r3.mServicesStartedFromLibrary = r4     // Catch:{ all -> 0x008d }
            android.os.Handler r4 = r3.mHandler     // Catch:{ all -> 0x008d }
            com.microsoft.appcenter.AppCenter$6 r5 = new com.microsoft.appcenter.AppCenter$6     // Catch:{ all -> 0x008d }
            r5.<init>(r6)     // Catch:{ all -> 0x008d }
            r4.post(r5)     // Catch:{ all -> 0x008d }
            java.lang.String r4 = "AppCenter"
            java.lang.String r5 = "App Center SDK configured successfully."
            com.microsoft.appcenter.utils.AppCenterLog.info(r4, r5)     // Catch:{ all -> 0x008d }
            monitor-exit(r3)
            return r0
        L_0x008d:
            r4 = move-exception
    ...
    public void finishConfiguration(boolean z) {
        ...
        this.mChannel = new DefaultChannel(this.mApplication, this.mAppSecret, this.mLogSerializer, this.mHandler);
        if (z) {
            applyStorageMaxSize();
        } else {
        ...
        this.mOneCollectorChannelListener = new OneCollectorChannelListener((Context) this.mApplication, this.mChannel, this.mLogSerializer, IdHelper.getInstallId());
        String str = "AppCenter";
        ...
        AppCenterLog.debug(str, "App Center initialized.");
    }
    ...
    private void startOrUpdateServiceFromApp(AppCenterService appCenterService, Collection<AppCenterService> collection, Collection<AppCenterService> collection2) {
        ...
        if (this.mServices.contains(appCenterService)) {
            ...
            sb2.append(".");
            AppCenterLog.error(str, sb2.toString());
        }
    }
    ...
    public void setInstanceEnabled(boolean z) {
        ...
        if (z2) {
            AppCenterLog.info(str2, "App Center has been disabled.");
        } else if (z3) {
            AppCenterLog.info(str2, "App Center has been enabled.");
        } else {
            StringBuilder sb = new StringBuilder();
            ...
            sb.append(str);
            sb.append(".");
            AppCenterLog.info(str2, sb.toString());
        }
    }
