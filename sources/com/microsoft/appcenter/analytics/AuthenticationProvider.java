...
public class AuthenticationProvider {
    ...
    /* renamed from: com.microsoft.appcenter.analytics.AuthenticationProvider$Type */
    public enum C2490Type {
        MSA_COMPACT("p"),
        MSA_DELEGATE("d");
    ...
    public AuthenticationProvider(C2490Type type, String str, TokenProvider tokenProvider) {
        String str2;
        this.mType = type;
        this.mTicketKey = str;
        if (str == null) {
