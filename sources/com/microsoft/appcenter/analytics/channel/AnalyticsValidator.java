...
public class AnalyticsValidator extends AbstractChannelListener {
    ...
    private static String validateName(String str, String str2) {
        ...
        if (str.length() > 256) {
            AppCenterLog.warn(str3, String.format("%s '%s' : name length cannot be longer than %s characters. Name will be truncated.", new Object[]{str2, str, Integer.valueOf(256)}));
    ...
    private static Map<String, String> validateProperties(Map<String, String> map, String str, String str2) {
        ...
        while (true) {
            ...
            if (size >= 20) {
                AppCenterLog.warn(str5, String.format("%s '%s' : properties cannot contain more than %s items. Skipping other properties.", new Object[]{str2, str, Integer.valueOf(20)}));
                break;
            } else if (str3 == null || str3.isEmpty()) {
                AppCenterLog.warn(str5, String.format("%s '%s' : a property key cannot be null or empty. Property will be skipped.", new Object[]{str2, str}));
            } else if (str4 == null) {
                AppCenterLog.warn(str5, String.format("%s '%s' : property '%s' : property value cannot be null. Property '%s' will be skipped.", new Object[]{str2, str, str3, str3}));
            } else {
                if (str3.length() > 125) {
                    AppCenterLog.warn(str5, String.format("%s '%s' : property '%s' : property key length cannot be longer than %s characters. Property key will be truncated.", new Object[]{str2, str, str3, Integer.valueOf(125)}));
                    str3 = str3.substring(0, 125);
                }
                if (str4.length() > 125) {
                    AppCenterLog.warn(str5, String.format("%s '%s' : property '%s' : property value cannot be longer than %s characters. Property value will be truncated.", new Object[]{str2, str, str3, Integer.valueOf(125)}));
    ...
    private static void validateProperties(List<TypedProperty> list) {
        ...
        if (list != null) {
            ...
            while (listIterator.hasNext()) {
                ...
                if (i >= 20) {
                    if (!z2) {
                        AppCenterLog.warn(str, String.format("Typed properties cannot contain more than %s items. Skipping other properties.", new Object[]{Integer.valueOf(20)}));
                        z2 = true;
                    }
                    listIterator.remove();
                    ...
                    if (name.length() > 125) {
                        AppCenterLog.warn(str, String.format("Typed property '%s' : property key length cannot be longer than %s characters. Property key will be truncated.", new Object[]{name, Integer.valueOf(125)}));
                    ...
                    if (typedProperty instanceof StringTypedProperty) {
                        ...
                        if (value == null) {
                            AppCenterLog.warn(str, String.format("Typed property '%s' : property value cannot be null. Property '%s' will be skipped.", new Object[]{name, name}));
                            listIterator.remove();
                        } else if (value.length() > 125) {
                            AppCenterLog.warn(str, String.format("A String property '%s' : property value cannot be longer than %s characters. Property value will be truncated.", new Object[]{name, Integer.valueOf(125)}));
