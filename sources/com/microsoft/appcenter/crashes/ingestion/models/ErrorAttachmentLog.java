...
public class ErrorAttachmentLog extends AbstractLog {
    @VisibleForTesting
    static final Charset CHARSET = Charset.forName(Utf8Charset.NAME);
    ...
    public void write(JSONStringer jSONStringer) throws JSONException {
        ...
        JSONUtils.write(jSONStringer, CommonProperties.f657ID, getId());
    ...
    public boolean equals(Object obj) {
        ...
        UUID uuid = this.f653id;
        if (uuid == null ? errorAttachmentLog.f653id != null : !uuid.equals(errorAttachmentLog.f653id)) {
            return false;
        }
