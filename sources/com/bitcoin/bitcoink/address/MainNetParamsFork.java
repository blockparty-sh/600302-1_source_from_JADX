...
public class MainNetParamsFork extends AbstractBitcoinNetParams {
    public static final int MAINNET_MAJORITY_ENFORCE_BLOCK_UPGRADE = 750;
    public static final int MAINNET_MAJORITY_REJECT_BLOCK_OUTDATED = 950;
    public static final int MAINNET_MAJORITY_WINDOW = 1000;
    private static MainNetParamsFork instance;

    public String getPaymentProtocolId() {
        return NetworkParameters.PAYMENT_PROTOCOL_ID_MAINNET;
    }

    public MainNetParamsFork() {
        ...
        this.p2shHeader = 5;
        this.acceptableAddressCodes = new int[]{this.addressHeader, this.p2shHeader, 8};
        this.port = 8333;
    ...
    public static synchronized MainNetParamsFork get() {
        MainNetParamsFork mainNetParamsFork;
        synchronized (MainNetParamsFork.class) {
            if (instance == null) {
                instance = new MainNetParamsFork();
            }
            mainNetParamsFork = instance;
        }
        return mainNetParamsFork;
    }
}
