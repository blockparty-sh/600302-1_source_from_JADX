...
public final class UtxoSelector$SlpTokenUtxoSelector$select$$inlined$sortedBy$2<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(Long.valueOf(((Utxo) t).getSatoshis().getSatoshis()), Long.valueOf(((Utxo) t2).getSatoshis().getSatoshis()));
    }
}
