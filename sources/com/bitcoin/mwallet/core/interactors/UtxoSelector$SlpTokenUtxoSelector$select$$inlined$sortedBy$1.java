...
public final class UtxoSelector$SlpTokenUtxoSelector$select$$inlined$sortedBy$1<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(Long.valueOf(((SlpUtxo) t).getTokenAmount()), Long.valueOf(((SlpUtxo) t2).getTokenAmount()));
    }
}
