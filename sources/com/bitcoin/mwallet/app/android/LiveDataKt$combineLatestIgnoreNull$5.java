...
final class LiveDataKt$combineLatestIgnoreNull$5<T> implements Observer<S> {
    ...
    LiveDataKt$combineLatestIgnoreNull$5(Function3 function3, LiveData liveData, LiveData liveData2, LiveData liveData3, MediatorLiveData mediatorLiveData) {
        this.$func = function3;
    ...
    public final void onChanged(T3 t3) {
        Object invoke = this.$func.invoke(this.$source1.getValue(), this.$source2.getValue(), this.$source3.getValue());
        if (invoke != null) {
