...
final class LiveDataKt$combineLatestIgnoreNull$1<T> implements Observer<S> {
    final /* synthetic */ Function2 $func;
    final /* synthetic */ MediatorLiveData $result;
    final /* synthetic */ LiveData $source1;
    final /* synthetic */ LiveData $source2;

    LiveDataKt$combineLatestIgnoreNull$1(Function2 function2, LiveData liveData, LiveData liveData2, MediatorLiveData mediatorLiveData) {
        this.$func = function2;
    ...
    public final void onChanged(T1 t1) {
        Object invoke = this.$func.invoke(this.$source1.getValue(), this.$source2.getValue());
        if (invoke != null) {
