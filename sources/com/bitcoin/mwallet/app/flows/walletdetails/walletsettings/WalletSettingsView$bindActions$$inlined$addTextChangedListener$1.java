...
public final class WalletSettingsView$bindActions$$inlined$addTextChangedListener$1 implements TextWatcher {
    ...
    public WalletSettingsView$bindActions$$inlined$addTextChangedListener$1(WalletSettingsView walletSettingsView) {
        this.this$0 = walletSettingsView;
    }

    public void afterTextChanged(@Nullable Editable editable) {
        ((WalletSettingsPresenter) this.this$0.getPresenter()).modifyWalletName(String.valueOf(editable));
    }
}
