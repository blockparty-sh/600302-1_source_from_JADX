...
final class WalletSettingsView$bindColorDots$2 implements OnClickListener {
    final /* synthetic */ ImageView $blueDot;
    final /* synthetic */ WalletSettingsView this$0;

    WalletSettingsView$bindColorDots$2(WalletSettingsView walletSettingsView, ImageView imageView) {
    ...
    public final void onClick(View view) {
        ...
        walletSettingsView.dotSelected(this.$blueDot, ContextCompat.getColor(walletSettingsView.requireContext(), C1018R.C1019color.walletColorBlue));
    }
}
