...
final class WalletSettingsView$bindColorDots$1 implements OnClickListener {
    final /* synthetic */ ImageView $greenDot;
    final /* synthetic */ WalletSettingsView this$0;

    WalletSettingsView$bindColorDots$1(WalletSettingsView walletSettingsView, ImageView imageView) {
    ...
    public final void onClick(View view) {
        ...
        walletSettingsView.dotSelected(this.$greenDot, ContextCompat.getColor(walletSettingsView.requireContext(), C1018R.C1019color.cashGreen));
    }
}
