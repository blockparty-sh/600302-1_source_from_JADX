...
final class OverviewView$bindActions$1 implements OnClickListener {
    final /* synthetic */ OverviewView this$0;

    OverviewView$bindActions$1(OverviewView overviewView) {
    ...
    public final void onClick(View view) {
        ...
        if (activity != null) {
            overviewPresenter.toSend(activity);
            return;
        }
