...
public final class DeleteWalletView$bindActions$$inlined$addTextChangedListener$1 implements TextWatcher {
    ...
    public DeleteWalletView$bindActions$$inlined$addTextChangedListener$1(DeleteWalletView deleteWalletView) {
        this.this$0 = deleteWalletView;
    }

    public void afterTextChanged(@Nullable Editable editable) {
        ((DeletewalletPresenter) this.this$0.getPresenter()).setWalletNameText(String.valueOf(editable));
    }
}
