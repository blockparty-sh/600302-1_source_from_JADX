...
final class AdvancedDetailsView$bindCells$1 implements OnClickListener {
    final /* synthetic */ AdvancedDetailsView this$0;

    AdvancedDetailsView$bindCells$1(AdvancedDetailsView advancedDetailsView) {
    ...
    public final void onClick(View view) {
        ...
        if (walletIdCell != null) {
            TextView textView = (TextView) walletIdCell.findViewById(C1018R.C1021id.advancedWalletSubtitle);
            if (textView != null) {
