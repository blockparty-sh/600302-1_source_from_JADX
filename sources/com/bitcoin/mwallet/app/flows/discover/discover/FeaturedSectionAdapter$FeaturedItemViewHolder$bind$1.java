...
final class FeaturedSectionAdapter$FeaturedItemViewHolder$bind$1 implements OnClickListener {
    final /* synthetic */ FeaturedBusiness $item;
    final /* synthetic */ FeaturedItemViewHolder this$0;

    FeaturedSectionAdapter$FeaturedItemViewHolder$bind$1(FeaturedItemViewHolder featuredItemViewHolder, FeaturedBusiness featuredBusiness) {
        this.this$0 = featuredItemViewHolder;
        this.$item = featuredBusiness;
    }

    public final void onClick(View view) {
        String str = "shop_screen_tap_on_featured_business";
