...
final class SendAmountSelectionView$bindButtonActions$4 implements OnClickListener {
    final /* synthetic */ SendAmountSelectionView this$0;

    SendAmountSelectionView$bindButtonActions$4(SendAmountSelectionView sendAmountSelectionView) {
    ...
    public final void onClick(View view) {
        ...
        if (fragmentManager != null) {
            ...
            sendAmountSelectionPresenter.onCurrencySelectTapped(fragmentManager);
        }
    }
}
