...
public final class SelectAddressView$onActivityCreated$1 implements BarcodeCallback {
    ...
    SelectAddressView$onActivityCreated$1(SelectAddressView selectAddressView) {
    ...
    public void barcodeResult(@Nullable BarcodeResult barcodeResult) {
        if ((barcodeResult != null ? barcodeResult.getText() : null) != null) {
            ...
            if (creator.parse(text).isValid()) {
                ...
                selectAddressPresenter.pasteTapped(text2);
            }
        }
    }
}
