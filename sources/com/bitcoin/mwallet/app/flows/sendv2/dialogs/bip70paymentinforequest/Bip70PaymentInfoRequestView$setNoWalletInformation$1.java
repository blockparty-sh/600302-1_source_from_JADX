...
final class Bip70PaymentInfoRequestView$setNoWalletInformation$1 implements OnClickListener {
    final /* synthetic */ Bip70PaymentInfoRequestView this$0;

    Bip70PaymentInfoRequestView$setNoWalletInformation$1(Bip70PaymentInfoRequestView bip70PaymentInfoRequestView) {
        this.this$0 = bip70PaymentInfoRequestView;
    }

    public final void onClick(View view) {
        CreateWalletDialogView createWalletDialogView = new CreateWalletDialogView(this.this$0.getPresenter().getCoin());
        FragmentManager fragmentManager = this.this$0.getFragmentManager();
        if (fragmentManager == null) {
            Intrinsics.throwNpe();
        }
        createWalletDialogView.show(fragmentManager, "create_new_wallet");
