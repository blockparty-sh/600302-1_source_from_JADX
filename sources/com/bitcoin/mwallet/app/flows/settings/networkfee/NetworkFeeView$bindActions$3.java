...
final class NetworkFeeView$bindActions$3 implements OnClickListener {
    final /* synthetic */ NetworkFeeView this$0;

    NetworkFeeView$bindActions$3(NetworkFeeView networkFeeView) {
        this.this$0 = networkFeeView;
    }

    public final void onClick(View view) {
        PreferenceManager.getDefaultSharedPreferences(this.this$0.getContext()).edit().putString(SharedPreference.NETWORK_FEE.getKey(), NetworkFeeLevel.NORMAL.name()).apply();
        this.this$0.feeSelected(NetworkFeeLevel.NORMAL);
    }
}
