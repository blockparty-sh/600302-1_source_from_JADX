...
final class NetworkFeeView$bindActions$1 implements OnClickListener {
    final /* synthetic */ NetworkFeeView this$0;

    NetworkFeeView$bindActions$1(NetworkFeeView networkFeeView) {
        this.this$0 = networkFeeView;
    }

    public final void onClick(View view) {
        this.this$0.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("https://bitcoinfees.cash/")));
    }
}
