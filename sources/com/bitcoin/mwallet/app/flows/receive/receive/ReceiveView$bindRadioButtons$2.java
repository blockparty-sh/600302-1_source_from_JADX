...
final class ReceiveView$bindRadioButtons$2 implements OnCheckedChangeListener {
    final /* synthetic */ ReceiveView this$0;

    ReceiveView$bindRadioButtons$2(ReceiveView receiveView) {
        this.this$0 = receiveView;
    }

    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        if (z) {
            ((ReceivePresenter) this.this$0.getPresenter()).setWalletType(WalletType.BTC);
        }
    }
}
