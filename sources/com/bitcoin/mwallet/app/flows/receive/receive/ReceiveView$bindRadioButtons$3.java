...
final class ReceiveView$bindRadioButtons$3 implements OnCheckedChangeListener {
    final /* synthetic */ ReceiveView this$0;

    ReceiveView$bindRadioButtons$3(ReceiveView receiveView) {
        this.this$0 = receiveView;
    }

    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        if (z) {
            ((ReceivePresenter) this.this$0.getPresenter()).setWalletType(WalletType.SLP);
        }
    }
}
