...
final class ReceiveView$bindRadioButtons$5 implements OnTouchListener {
    final /* synthetic */ ReceiveView this$0;

    ReceiveView$bindRadioButtons$5(ReceiveView receiveView) {
        this.this$0 = receiveView;
    }

    public final boolean onTouch(View view, MotionEvent motionEvent) {
        if (!((ReceivePresenter) this.this$0.getPresenter()).checkWalletsExist(WalletType.BTC)) {
            this.this$0.getChildFragmentManager();
            new MissingWalletDialogView(WalletType.BTC).show(this.this$0.getChildFragmentManager(), "missing_btc_wallets");
            return false;
        }
        view.performClick();
        return true;
