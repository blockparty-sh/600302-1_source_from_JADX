...
final class ReceiveAmountSelectionView$bindButtonActions$2 implements OnClickListener {
    final /* synthetic */ ReceiveAmountSelectionView this$0;

    ReceiveAmountSelectionView$bindButtonActions$2(ReceiveAmountSelectionView receiveAmountSelectionView) {
    ...
    public final void onClick(View view) {
        ...
        if (fragmentManager != null) {
            ...
            receiveAmountSelectionPresenter.onCurrencySelectTapped(fragmentManager);
        }
    }
}
