...
final class ReceiveSendButtonsView$onActivityCreated$1 implements OnClickListener {
    final /* synthetic */ ReceiveSendButtonsView this$0;

    ReceiveSendButtonsView$onActivityCreated$1(ReceiveSendButtonsView receiveSendButtonsView) {
        this.this$0 = receiveSendButtonsView;
    }

    public final void onClick(View view) {
        ReceiveSendButtonsView.access$getPresenter$p(this.this$0).onReceive();
    }
}
