...
final class WalletSelectorDialogView$bindObservers$5 implements OnCheckedChangeListener {
    final /* synthetic */ WalletSelectorPresenter $presenter;

    WalletSelectorDialogView$bindObservers$5(WalletSelectorPresenter walletSelectorPresenter) {
        this.$presenter = walletSelectorPresenter;
    }

    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        if (z) {
            this.$presenter.getSelectedCoin().postValue(WalletType.BCH);
        }
    }
}
