...
final class WalletSelectorDialogView$bindObservers$7 implements OnCheckedChangeListener {
    final /* synthetic */ WalletSelectorPresenter $presenter;

    WalletSelectorDialogView$bindObservers$7(WalletSelectorPresenter walletSelectorPresenter) {
        this.$presenter = walletSelectorPresenter;
    }

    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        if (z) {
            this.$presenter.getSelectedCoin().postValue(WalletType.SLP);
        }
    }
}
