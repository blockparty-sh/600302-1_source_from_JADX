...
/* renamed from: com.bitcoin.mwallet.app.components.walletselector.WalletSelectorDialogView$bindObservers$2$$special$$inlined$sortedBy$1 */
/* compiled from: Comparisons.kt */
public final class C1091x52dce5a4<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        String name = ((WalletSummaryView) t).getName();
        ...
        if (name != null) {
            ...
            String name2 = ((WalletSummaryView) t2).getName();
            if (name2 != null) {
