...
final class AddContactView$bindButtons$2 implements OnClickListener {
    final /* synthetic */ EditText $address;
    final /* synthetic */ AddContactView this$0;

    AddContactView$bindButtons$2(AddContactView addContactView, EditText editText) {
    ...
    public final void onClick(View view) {
        ...
        if (presenter != null) {
            ...
            presenter.setRawInput(String.valueOf(editText != null ? editText.getText() : null), WalletType.BTC);
        }
    }
}
