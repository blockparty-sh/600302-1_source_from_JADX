...
final class ContactListView$onViewCreated$5 implements OnClickListener {
    final /* synthetic */ ObjectRef $searchView;
    final /* synthetic */ ContactListView this$0;

    ContactListView$onViewCreated$5(ContactListView contactListView, ObjectRef objectRef) {
        this.this$0 = contactListView;
        this.$searchView = objectRef;
    }

    public final void onClick(View view) {
        this.this$0.adapter.setWalletType(WalletType.SLP);
        ...
        filter.filter(searchView.getQuery(), new FilterListener(this) {
            final /* synthetic */ ContactListView$onViewCreated$5 this$0;
        ...
        if (access$getListener$p != null) {
            access$getListener$p.onWalletTypeClicked(WalletType.SLP);
        }
    }
}
