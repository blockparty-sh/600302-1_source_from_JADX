package com.bitcoin.mwallet.app.components.contacts.builder;
...
@Metadata(mo37403bv = {1, 0, 3}, mo37404d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u001b\u0010\u0005\u001a\u00020\u00068BX\u0002¢\u0006\f\n\u0004\b\t\u0010\n\u001a\u0004\b\u0007\u0010\bR\u001b\u0010\u000b\u001a\u00020\f8BX\u0002¢\u0006\f\n\u0004\b\u000f\u0010\n\u001a\u0004\b\r\u0010\u000eR\u000e\u0010\u0010\u001a\u00020\u0011X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0012\u001a\u00020\u0013X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0014\u0010\u0015R\u0011\u0010\u0016\u001a\u00020\u0017¢\u0006\b\n\u0000\u001a\u0004\b\u0018\u0010\u0019¨\u0006\u001a"}, mo37405d2 = {"Lcom/bitcoin/mwallet/app/components/contacts/builder/ContactsBuilder;", "Lcom/bitcoin/mwallet/app/viper/ComponentBuilderBase;", "application", "Landroid/app/Application;", "(Landroid/app/Application;)V", "analyticsService", "Lcom/bitcoin/mwallet/core/services/AnalyticsService;", "getAnalyticsService", "()Lcom/bitcoin/mwallet/core/services/AnalyticsService;", "analyticsService$delegate", "Lkotlin/Lazy;", "contactService", "Lcom/bitcoin/mwallet/core/repositories/ContactRepository;", "getContactService", "()Lcom/bitcoin/mwallet/core/repositories/ContactRepository;", "contactService$delegate", "interactor", "Lcom/bitcoin/mwallet/app/components/contacts/interactor/ContactsInteractor;", "presenter", "Lcom/bitcoin/mwallet/app/components/contacts/presenter/ContactsPresenter;", "getPresenter", "()Lcom/bitcoin/mwallet/app/components/contacts/presenter/ContactsPresenter;", "router", "Lcom/bitcoin/mwallet/app/flows/settings/settings/SettingsRouter;", "getRouter", "()Lcom/bitcoin/mwallet/app/flows/settings/settings/SettingsRouter;", "app_replaceRelease"}, mo37406k = 1, mo37407mv = {1, 1, 15})
/* compiled from: ContactsBuilder.kt */
public final class ContactsBuilder extends ComponentBuilderBase {
    static final /* synthetic */ KProperty[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(ContactsBuilder.class), "contactService", "getContactService()Lcom/bitcoin/mwallet/core/repositories/ContactRepository;")), Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(ContactsBuilder.class), "analyticsService", "getAnalyticsService()Lcom/bitcoin/mwallet/core/services/AnalyticsService;"))};
    ...
    public ContactsBuilder(@NotNull Application application) {
        Intrinsics.checkParameterIsNotNull(application, "application");
        super(application);
        Qualifier qualifier = null;
        Function0 function0 = null;
        this.contactService$delegate = LazyKt.lazy(new ContactsBuilder$$special$$inlined$inject$1(getKoin().getRootScope(), qualifier, function0));
        this.analyticsService$delegate = LazyKt.lazy(new ContactsBuilder$$special$$inlined$inject$2(getKoin().getRootScope(), qualifier, function0));
        this.presenter = new ContactsPresenter(application, ViewModelKt.getViewModelScope(this), this.interactor, getAnalyticsService());
    }
