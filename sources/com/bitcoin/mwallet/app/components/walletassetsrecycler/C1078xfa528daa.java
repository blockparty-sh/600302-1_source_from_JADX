...
/* renamed from: com.bitcoin.mwallet.app.components.walletassetsrecycler.WalletAssetsRecyclerAdapter$MultipleWalletsAssetsViewHolder$WalletAssetsSingleAdapter$WalletAssetsSingleViewHolder$bind$1 */
/* compiled from: WalletAssetsRecyclerAdapter.kt */
final class C1078xfa528daa implements OnClickListener {
    final /* synthetic */ WalletInfoBalance $wallet;
    final /* synthetic */ WalletAssetsSingleViewHolder this$0;

    C1078xfa528daa(WalletAssetsSingleViewHolder walletAssetsSingleViewHolder, WalletInfoBalance walletInfoBalance) {
        this.this$0 = walletAssetsSingleViewHolder;
        this.$wallet = walletInfoBalance;
    }

    public final void onClick(View view) {
        C1261Wallet wallet = this.this$0.getPresenter().getWallet(this.$wallet.getWalletId());
        if (wallet == null) {
            Intrinsics.throwNpe();
        }
        ...
        if (wallet.getCredentialId().getType() == CredentialType.ENCRYPTED_MNEMONIC) {
            LockedWalletDialog lockedWalletDialog = new LockedWalletDialog(this.$wallet.getWalletId());
        ...
        } else if (this.$wallet.getMultiSig()) {
            MultiSigWalletDialog multiSigWalletDialog = new MultiSigWalletDialog(this.$wallet.getWalletId());
            ...
            C1261Wallet wallet2 = this.this$0.getPresenter().getWallet(this.$wallet.getWalletId());
            if (wallet2 == null) {
                Intrinsics.throwNpe();
            }
            if (wallet2.getCredentialId().getType() == CredentialType.MNEMONIC_AND_PROTECTED) {
                LockedMnemonicWalletDialog lockedMnemonicWalletDialog = new LockedMnemonicWalletDialog(this.$wallet.getWalletId());
            ...
            intent.putExtra("wallet_id", this.$wallet.getWalletId());
