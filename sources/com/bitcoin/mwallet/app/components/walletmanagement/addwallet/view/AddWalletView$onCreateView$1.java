...
final class AddWalletView$onCreateView$1 implements OnClickListener {
    final /* synthetic */ AddWalletView this$0;

    AddWalletView$onCreateView$1(AddWalletView addWalletView) {
        this.this$0 = addWalletView;
    }

    public final void onClick(View view) {
        CreateWalletDialogView createWalletDialogView = new CreateWalletDialogView(this.this$0.getCoin());
