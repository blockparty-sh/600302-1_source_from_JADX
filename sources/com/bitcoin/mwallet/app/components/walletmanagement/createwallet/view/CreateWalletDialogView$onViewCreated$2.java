...
final class CreateWalletDialogView$onViewCreated$2 implements OnCheckedChangeListener {
    final /* synthetic */ CreateWalletDialogView this$0;

    CreateWalletDialogView$onViewCreated$2(CreateWalletDialogView createWalletDialogView) {
    ...
    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        if (z) {
            ...
            if (presenter != null) {
                presenter.onCoinSelected(Coin.BTC);
            }
        }
    }
}
