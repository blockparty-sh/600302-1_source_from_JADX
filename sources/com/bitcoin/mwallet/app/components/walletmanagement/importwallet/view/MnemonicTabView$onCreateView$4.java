...
final class MnemonicTabView$onCreateView$4 implements OnCheckedChangeListener {
    final /* synthetic */ MnemonicTabView this$0;

    MnemonicTabView$onCreateView$4(MnemonicTabView mnemonicTabView) {
        this.this$0 = mnemonicTabView;
    }

    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        if (z) {
            this.this$0.getPresenter().onCoinSelected(Coin.BTC);
        }
    }
}
