...
final class MnemonicTabView$onCreateView$7 implements OnClickListener {
    final /* synthetic */ MnemonicTabView this$0;

    MnemonicTabView$onCreateView$7(MnemonicTabView mnemonicTabView) {
        this.this$0 = mnemonicTabView;
    }

    public final void onClick(View view) {
        this.this$0.getPresenter().onImportByMnemonic();
