...
final class BackupFileTabView$onCreateView$4 implements OnClickListener {
    final /* synthetic */ BackupFileTabView this$0;

    BackupFileTabView$onCreateView$4(BackupFileTabView backupFileTabView) {
    ...
    public final void onClick(View view) {
        ...
        if (presenter != null) {
            presenter.onImportByBackupCode();
        }
    }
}
