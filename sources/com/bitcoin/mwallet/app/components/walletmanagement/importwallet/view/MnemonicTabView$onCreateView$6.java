...
final class MnemonicTabView$onCreateView$6 implements OnClickListener {
    final /* synthetic */ MnemonicTabView this$0;

    MnemonicTabView$onCreateView$6(MnemonicTabView mnemonicTabView) {
        this.this$0 = mnemonicTabView;
    }

    public final void onClick(View view) {
        this.this$0.dismissKeyboard();
        new MnemonicScannerView(this.this$0).show(this.this$0.getChildFragmentManager(), "mnemonic_qr_code_scanner");
    }
}
