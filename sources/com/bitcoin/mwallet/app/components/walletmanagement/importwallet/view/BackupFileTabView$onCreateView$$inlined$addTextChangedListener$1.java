...
public final class BackupFileTabView$onCreateView$$inlined$addTextChangedListener$1 implements TextWatcher {
    ...
    public BackupFileTabView$onCreateView$$inlined$addTextChangedListener$1(BackupFileTabView backupFileTabView) {
    ...
    public void afterTextChanged(@Nullable Editable editable) {
        ...
        if (presenter != null) {
            presenter.onSetPassword(String.valueOf(editable));
        }
    }
}
