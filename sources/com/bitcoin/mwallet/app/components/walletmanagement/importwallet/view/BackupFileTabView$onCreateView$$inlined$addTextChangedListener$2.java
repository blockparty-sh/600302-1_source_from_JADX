...
public final class BackupFileTabView$onCreateView$$inlined$addTextChangedListener$2 implements TextWatcher {
    final /* synthetic */ BackupFileTabView this$0;
    ...
    public BackupFileTabView$onCreateView$$inlined$addTextChangedListener$2(BackupFileTabView backupFileTabView) {
        this.this$0 = backupFileTabView;
    }

    public void afterTextChanged(@Nullable Editable editable) {
        ImportWalletPresenter presenter = this.this$0.getPresenter();
        if (presenter != null) {
            presenter.onSetBackupCode(String.valueOf(editable));
        }
    }
}
