...
final class pinpadView$bindPinPadButtons$1 implements OnClickListener {
    final /* synthetic */ pinpadView this$0;

    pinpadView$bindPinPadButtons$1(pinpadView pinpadview) {
        this.this$0 = pinpadview;
    }

    public final void onClick(View view) {
        pinpadView.access$getPresenter$p(this.this$0).digitTapped(BuildConfig.BUILD_NUMBER);
    }
}
