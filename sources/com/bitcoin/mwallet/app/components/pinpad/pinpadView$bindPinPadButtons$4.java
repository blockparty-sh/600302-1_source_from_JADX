...
final class pinpadView$bindPinPadButtons$4 implements OnClickListener {
    final /* synthetic */ pinpadView this$0;

    pinpadView$bindPinPadButtons$4(pinpadView pinpadview) {
        this.this$0 = pinpadview;
    }

    public final void onClick(View view) {
        pinpadView.access$getPresenter$p(this.this$0).digitTapped(ExifInterface.GPS_MEASUREMENT_3D);
    }
}
