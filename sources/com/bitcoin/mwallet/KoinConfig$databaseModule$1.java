...
final class KoinConfig$databaseModule$1 extends Lambda implements Function1<Module, Unit> {
    public static final KoinConfig$databaseModule$1 INSTANCE = new KoinConfig$databaseModule$1();

    KoinConfig$databaseModule$1() {
        super(1);
    }
    ...
    public final void invoke(@NotNull Module module) {
        ...
        Function2 function2 = C09521.INSTANCE;
        Qualifier qualifier = null;
        DefinitionFactory definitionFactory = DefinitionFactory.INSTANCE;
        Kind kind = Kind.Single;
        BeanDefinition beanDefinition = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(CredentialDao.class));
        beanDefinition.setDefinition(function2);
        beanDefinition.setKind(kind);
        module.declareDefinition(beanDefinition, new Options(false, false));
        Function2 function22 = C09612.INSTANCE;
        DefinitionFactory definitionFactory2 = DefinitionFactory.INSTANCE;
        Kind kind2 = Kind.Single;
        BeanDefinition beanDefinition2 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(UserDao.class));
        beanDefinition2.setDefinition(function22);
        beanDefinition2.setKind(kind2);
        module.declareDefinition(beanDefinition2, new Options(false, false));
        Function2 function23 = C09623.INSTANCE;
        DefinitionFactory definitionFactory3 = DefinitionFactory.INSTANCE;
        Kind kind3 = Kind.Single;
        BeanDefinition beanDefinition3 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(UtxoDao.class));
        beanDefinition3.setDefinition(function23);
        beanDefinition3.setKind(kind3);
        module.declareDefinition(beanDefinition3, new Options(false, false));
        Function2 function24 = C09634.INSTANCE;
        DefinitionFactory definitionFactory4 = DefinitionFactory.INSTANCE;
        Kind kind4 = Kind.Single;
        BeanDefinition beanDefinition4 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(ExchangeRateDao.class));
        beanDefinition4.setDefinition(function24);
        beanDefinition4.setKind(kind4);
        module.declareDefinition(beanDefinition4, new Options(false, false));
        Function2 function25 = C09645.INSTANCE;
        DefinitionFactory definitionFactory5 = DefinitionFactory.INSTANCE;
        Kind kind5 = Kind.Single;
        BeanDefinition beanDefinition5 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(NetworkFeeDao.class));
        beanDefinition5.setDefinition(function25);
        beanDefinition5.setKind(kind5);
        module.declareDefinition(beanDefinition5, new Options(false, false));
        Function2 function26 = C09656.INSTANCE;
        DefinitionFactory definitionFactory6 = DefinitionFactory.INSTANCE;
        Kind kind6 = Kind.Single;
        BeanDefinition beanDefinition6 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(WalletAddressInfoDao.class));
        beanDefinition6.setDefinition(function26);
        beanDefinition6.setKind(kind6);
        module.declareDefinition(beanDefinition6, new Options(false, false));
        Function2 function27 = C09667.INSTANCE;
        DefinitionFactory definitionFactory7 = DefinitionFactory.INSTANCE;
        Kind kind7 = Kind.Single;
        BeanDefinition beanDefinition7 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(WalletDao.class));
        beanDefinition7.setDefinition(function27);
        beanDefinition7.setKind(kind7);
        module.declareDefinition(beanDefinition7, new Options(false, false));
        Function2 function28 = C09678.INSTANCE;
        DefinitionFactory definitionFactory8 = DefinitionFactory.INSTANCE;
        Kind kind8 = Kind.Single;
        BeanDefinition beanDefinition8 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(TransactionHistoryDao.class));
        beanDefinition8.setDefinition(function28);
        beanDefinition8.setKind(kind8);
        module.declareDefinition(beanDefinition8, new Options(false, false));
        Function2 function29 = C09689.INSTANCE;
        DefinitionFactory definitionFactory9 = DefinitionFactory.INSTANCE;
        Kind kind9 = Kind.Single;
        BeanDefinition beanDefinition9 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(ContactDao.class));
        beanDefinition9.setDefinition(function29);
        beanDefinition9.setKind(kind9);
        module.declareDefinition(beanDefinition9, new Options(false, false));
        Function2 function210 = C095310.INSTANCE;
        DefinitionFactory definitionFactory10 = DefinitionFactory.INSTANCE;
        Kind kind10 = Kind.Single;
        BeanDefinition beanDefinition10 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(ZionNameDao.class));
        beanDefinition10.setDefinition(function210);
        beanDefinition10.setKind(kind10);
        module.declareDefinition(beanDefinition10, new Options(false, false));
        Function2 function211 = C095411.INSTANCE;
        DefinitionFactory definitionFactory11 = DefinitionFactory.INSTANCE;
        Kind kind11 = Kind.Single;
        BeanDefinition beanDefinition11 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(SlpDao.class));
        beanDefinition11.setDefinition(function211);
        beanDefinition11.setKind(kind11);
        module.declareDefinition(beanDefinition11, new Options(false, false));
        Function2 function212 = C095512.INSTANCE;
        DefinitionFactory definitionFactory12 = DefinitionFactory.INSTANCE;
        Kind kind12 = Kind.Single;
        BeanDefinition beanDefinition12 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(SlpUtxoDao.class));
        beanDefinition12.setDefinition(function212);
        beanDefinition12.setKind(kind12);
        module.declareDefinition(beanDefinition12, new Options(false, false));
        Function2 function213 = C095613.INSTANCE;
        DefinitionFactory definitionFactory13 = DefinitionFactory.INSTANCE;
        Kind kind13 = Kind.Single;
        BeanDefinition beanDefinition13 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(MerchantDao.class));
        beanDefinition13.setDefinition(function213);
        beanDefinition13.setKind(kind13);
        module.declareDefinition(beanDefinition13, new Options(false, false));
        Function2 function214 = C095714.INSTANCE;
        DefinitionFactory definitionFactory14 = DefinitionFactory.INSTANCE;
        Kind kind14 = Kind.Single;
        BeanDefinition beanDefinition14 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(VerifiedTokenDao.class));
        beanDefinition14.setDefinition(function214);
        beanDefinition14.setKind(kind14);
        module.declareDefinition(beanDefinition14, new Options(false, false));
        Function2 function215 = C095815.INSTANCE;
        DefinitionFactory definitionFactory15 = DefinitionFactory.INSTANCE;
        Kind kind15 = Kind.Single;
        BeanDefinition beanDefinition15 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(SpentUtxoDao.class));
        beanDefinition15.setDefinition(function215);
        beanDefinition15.setKind(kind15);
        module.declareDefinition(beanDefinition15, new Options(false, false));
        Function2 function216 = C095916.INSTANCE;
        DefinitionFactory definitionFactory16 = DefinitionFactory.INSTANCE;
        Kind kind16 = Kind.Single;
        BeanDefinition beanDefinition16 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(PrivateKeyRepository.class));
        beanDefinition16.setDefinition(function216);
        beanDefinition16.setKind(kind16);
        module.declareDefinition(beanDefinition16, new Options(false, false));
        Function2 function217 = C096017.INSTANCE;
        DefinitionFactory definitionFactory17 = DefinitionFactory.INSTANCE;
        Kind kind17 = Kind.Single;
        BeanDefinition beanDefinition17 = new BeanDefinition(qualifier, Reflection.getOrCreateKotlinClass(SecureStringEncrypter.class));
