...
public class SharedPreferencesDumperPlugin implements DumperPlugin {
    ...
    /* renamed from: com.facebook.stetho.dumpapp.plugins.SharedPreferencesDumperPlugin$Type */
    private enum C1309Type {
        BOOLEAN(BooleanTypedProperty.TYPE),
        INT("int"),
        LONG(LongTypedProperty.TYPE),
        FLOAT(Kinds.FLOAT),
        STRING("string"),
        SET("set");
        ...
        private C1309Type(String str) {
            this.name = str;
        }

        @Nullable
        /* renamed from: of */
        public static C1309Type m54of(String str) {
            C1309Type[] values;
            for (C1309Type type : values()) {
    ...
    private void doWrite(List<String> list) throws DumpUsageException {
        ...
        C1309Type of = C1309Type.m54of(nextArg(it, "Expected <type>"));
        if (of != null) {
        ...
        throw new DumpUsageException(C1309Type.appendNamesList(new StringBuilder("Usage: prefs write <path> <key> <type> <value>, where type is one of: "), ", ").toString());
    }
    ...
    private void doUsage(PrintStream printStream) {
        ...
        StringBuilder appendNamesList = C1309Type.appendNamesList(sb3, "|");
