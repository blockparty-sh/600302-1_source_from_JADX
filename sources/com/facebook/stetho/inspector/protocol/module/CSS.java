...
public class CSS implements ChromeDevtoolsDomain {
    ...
    public SetPropertyTextResult setPropertyText(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (setPropertyTextRequest.text != null) {
            ...
            String str5 = Constants.COMMON_SCHEMA_PREFIX_SEPARATOR;
        ...
        setPropertyTextResult3.style.styleSheetId = setPropertyTextRequest.styleSheetId;
        setPropertyTextResult3.style.cssProperties = new ArrayList();
