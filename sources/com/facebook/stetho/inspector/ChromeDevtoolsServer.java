...
public class ChromeDevtoolsServer implements SimpleEndpoint {
    ...
    static /* synthetic */ class C13101 {
        ...
        static final /* synthetic */ int[] f477x978b462 = new int[ErrorCode.values().length];

        static {
            try {
                f477x978b462[ErrorCode.METHOD_NOT_FOUND.ordinal()] = 1;
    ...
    public void onClose(SimpleSession simpleSession, int i, String str) {
        ...
        sb.append(" ");
        sb.append(str);
        LogRedirector.m24d(TAG, sb.toString());
    ...
    public void onMessage(SimpleSession simpleSession, String str) {
        ...
        if (LogRedirector.isLoggable(str2, 2)) {
            ...
            sb.append(str);
            LogRedirector.m30v(str2, sb.toString());
        }
        try {
            ...
            if (LogRedirector.isLoggable(str2, 2)) {
                ...
                sb2.append(e);
                LogRedirector.m30v(str2, sb2.toString());
            }
            ...
            sb3.append(e2);
            LogRedirector.m28i(str2, sb3.toString());
            closeSafely(simpleSession, 1011, e2.getClass().getSimpleName());
        } catch (JSONException e3) {
            LogRedirector.m31v(str2, "Unexpected JSON exception processing message", e3);
    ...
    private void handleRemoteRequest(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) throws MessageHandlingException {
        ...
        if (jsonRpcRequest.f478id != null) {
            JsonRpcResponse jsonRpcResponse = new JsonRpcResponse();
            jsonRpcResponse.f479id = jsonRpcRequest.f478id.longValue();
    ...
    private static void logDispatchException(JsonRpcException jsonRpcException) {
        ...
        int i = C13101.f477x978b462[errorMessage.code.ordinal()];
        String str = TAG;
        if (i != 1) {
            LogRedirector.m33w(str, "Error processing remote message", jsonRpcException);
            return;
        }
        StringBuilder sb = new StringBuilder();
        sb.append("Method not implemented: ");
        sb.append(errorMessage.message);
        LogRedirector.m24d(str, sb.toString());
    }
    ...
    private void handleRemoteResponse(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) throws MismatchedResponseException {
        ...
        PendingRequest andRemovePendingRequest = jsonRpcPeer.getAndRemovePendingRequest(jsonRpcResponse.f479id);
        if (andRemovePendingRequest == null) {
            throw new MismatchedResponseException(jsonRpcResponse.f479id);
    ...
    public void onError(SimpleSession simpleSession, Throwable th) {
        ...
        LogRedirector.m26e(TAG, sb.toString());
    }
}
