...
public final class Document extends ThreadBoundProxy {
            ...
            while (!this.mCachedUpdateQueue.isEmpty()) {
                ...
                while (i < size) {
                    ...
                    if (obj != null) {
                        ...
                        LogUtil.m39e("%s.getChildren() emitted a null child at position %s for element %s", nodeDescriptor.getClass().getName(), Integer.toString(i), remove);
    ...
    public void updateTree() {
        ...
        LogUtil.m35d("Document.updateTree() completed in %s ms%s", objArr);
    }
            ...
            private Accumulator<Object> insertedElements = new Accumulator<Object>() {
                public void store(Object obj) {
                    if (update.isElementChanged(obj)) {
                        C13195.this.listenerInsertedElements.add(obj);
                    }
                }
            };
            /* access modifiers changed from: private */
