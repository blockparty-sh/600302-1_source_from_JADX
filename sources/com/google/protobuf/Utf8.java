            ...
            while (access$200 < i2) {
                ...
                if (b < 0) {
                    if (b < -32) {
                        ...
                        if (b3 <= -65 && (((b << Ascii.f522FS) + (b3 + 112)) >> 30) == 0) {
                            int i6 = i5 + 1;
                    ...
                    if (i3 != length) {
                        try {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                int i4 = position + 1;
                                try {
                                    byteBuffer.put(position, (byte) ((codePoint >>> 18) | TorDiscovery.RESOLVE_ERROR));
                                    position = i4 + 1;
        ...
        public int encodeUtf8(CharSequence charSequence, byte[] bArr, int i, int i2) {
            ...
            while (i5 < length) {
                ...
                if (charAt2 < 128 && i7 < i4) {
                    ...
                    int i9 = i7 + 1;
                    bArr[i7] = (byte) ((charAt2 >>> 12) | C239114.DENSITY_XXHIGH);
                    int i10 = i9 + 1;
                    ...
                    if (i11 != charSequence.length()) {
                        ...
                        if (Character.isSurrogatePair(charAt2, charAt3)) {
                            int codePoint = Character.toCodePoint(charAt2, charAt3);
                            int i12 = i7 + 1;
                            bArr[i7] = (byte) ((codePoint >>> 18) | TorDiscovery.RESOLVE_ERROR);
                            int i13 = i12 + 1;
            ...
            if (i5 == length) {
                ...
                while (i5 < length) {
                    ...
                    if (charAt2 < c && arrayBaseOffset2 < j4) {
                        ...
                        UnsafeUtil.putByte(bArr2, arrayBaseOffset2, (byte) ((charAt2 >>> 12) | C239114.DENSITY_XXHIGH));
                        long j11 = j10 + j;
                        ...
                        if (i6 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                UnsafeUtil.putByte(bArr2, arrayBaseOffset2, (byte) ((codePoint >>> 18) | TorDiscovery.RESOLVE_ERROR));
                                long j14 = j13 + 1;
                ...
                while (i < length) {
                    ...
                    if (charAt2 < c && j < limit) {
                        ...
                        if ((charAt2 < 55296 || 57343 < charAt2) && j <= limit - 3) {
                            long j5 = j + 1;
                            UnsafeUtil.putByte(j, (byte) ((charAt2 >>> 12) | C239114.DENSITY_XXHIGH));
                            long j6 = j5 + 1;
                            ...
                            if (i2 != length) {
                                ...
                                if (Character.isSurrogatePair(charAt2, charAt3)) {
                                    int codePoint = Character.toCodePoint(charAt2, charAt3);
                                    long j8 = j + 1;
                                    UnsafeUtil.putByte(j, (byte) ((codePoint >>> 18) | TorDiscovery.RESOLVE_ERROR));
                                    long j9 = j8 + 1;
