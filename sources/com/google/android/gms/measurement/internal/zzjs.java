...
public final class zzjs extends zzge {
    ...
    private static final List<String> zzua = Collections.unmodifiableList(Arrays.asList(new String[]{Param.SOURCE, Param.MEDIUM, Param.CAMPAIGN, Param.TERM, Param.CONTENT}));
    private int zzag;
    ...
    public final void zzb(zzp zzp, String str) {
        Bundle bundle = new Bundle();
        bundle.putString(BitcoinURI.FIELD_PAYMENT_REQUEST_URL, str);
        try {
            zzp.zzb(bundle);
    ...
    public final void zza(zzp zzp, long j) {
        Bundle bundle = new Bundle();
        bundle.putLong(BitcoinURI.FIELD_PAYMENT_REQUEST_URL, j);
        try {
            zzp.zzb(bundle);
        } catch (RemoteException e) {
    ...
    public final void zza(zzp zzp, int i) {
        Bundle bundle = new Bundle();
        bundle.putInt(BitcoinURI.FIELD_PAYMENT_REQUEST_URL, i);
        try {
            zzp.zzb(bundle);
        } catch (RemoteException e) {
    ...
    public final void zza(zzp zzp, byte[] bArr) {
        Bundle bundle = new Bundle();
        bundle.putByteArray(BitcoinURI.FIELD_PAYMENT_REQUEST_URL, bArr);
        try {
            zzp.zzb(bundle);
        } catch (RemoteException e) {
    ...
    public final void zza(zzp zzp, boolean z) {
        Bundle bundle = new Bundle();
        bundle.putBoolean(BitcoinURI.FIELD_PAYMENT_REQUEST_URL, z);
        try {
            zzp.zzb(bundle);
        } catch (RemoteException e) {
    ...
    public final void zza(zzp zzp, ArrayList<Bundle> arrayList) {
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(BitcoinURI.FIELD_PAYMENT_REQUEST_URL, arrayList);
        try {
            zzp.zzb(bundle);
        } catch (RemoteException e) {
