...
public final class zzhq extends zzg {
    ...
    public final void onActivityCreated(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (bundle2 != null) {
                this.zzqr.put(activity, new zzhr(bundle2.getString("name"), bundle2.getString("referrer_name"), bundle2.getLong(CommonProperties.f657ID)));
            }
        }
    }
    ...
    public final void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (zzhr != null) {
                ...
                bundle2.putLong(CommonProperties.f657ID, zzhr.zzqw);
