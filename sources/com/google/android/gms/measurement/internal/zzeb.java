...
public final class zzeb extends zzg {
    ...
    public final void resetAnalyticsData() {
        ...
        zzo();
        try {
            int delete = getWritableDatabase().delete(Keys.MESSAGES, null, null) + 0;
            if (delete > 0) {
    ...
    private static long zza(SQLiteDatabase sQLiteDatabase) {
        Cursor cursor = null;
        try {
            Cursor query = sQLiteDatabase.query(Keys.MESSAGES, new String[]{"rowid"}, "type=?", new String[]{ExifInterface.GPS_MEASUREMENT_3D}, null, null, "rowid desc", "1");
