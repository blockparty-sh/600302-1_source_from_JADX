...
public class AppMeasurementDynamiteService extends zzn {
    ...
    public void registerOnMeasurementEventListener(zzq zzq) throws RemoteException {
        zzbi();
        zzgn zzgn = (zzgn) this.zzdk.get(Integer.valueOf(zzq.mo20976id()));
        if (zzgn == null) {
            zzgn = new zza(zzq);
            this.zzdk.put(Integer.valueOf(zzq.mo20976id()), zzgn);
        }
    ...
    public void unregisterOnMeasurementEventListener(zzq zzq) throws RemoteException {
        zzbi();
        zzgn zzgn = (zzgn) this.zzdk.remove(Integer.valueOf(zzq.mo20976id()));
        if (zzgn == null) {
            zzgn = new zza(zzq);
        }
