...
public final class zzk extends AbstractSafeParcelable {
    ...
    @Field(getter = "getAllowTestKeys", mo19055id = 3)
    private final boolean zzaa;
    @Field(defaultValue = "false", getter = "getForbidTestKeys", mo19055id = 4)
    private final boolean zzab;
    @Field(getter = "getCallingPackage", mo19055id = 1)
    private final String zzy;
    @Field(getter = "getCallingCertificateBinder", mo19055id = 2, type = "android.os.IBinder")
    @Nullable
    private final zze zzz;

    @Constructor
    zzk(@Param(mo19058id = 1) String str, @Param(mo19058id = 2) @Nullable IBinder iBinder, @Param(mo19058id = 3) boolean z, @Param(mo19058id = 4) boolean z2) {
        this.zzy = str;
