...
public class Feature extends AbstractSafeParcelable {
    ...
    @Field(getter = "getName", mo19055id = 1)
    private final String name;
    @Field(getter = "getOldVersion", mo19055id = 2)
    @Deprecated
    private final int zzk;
    @Field(defaultValue = "-1", getter = "getVersion", mo19055id = 3)
    ...
    @Constructor
    public Feature(@Param(mo19058id = 1) String str, @Param(mo19058id = 2) int i, @Param(mo19058id = 3) long j) {
        this.name = str;
        this.zzk = i;
        this.zzl = j;
    }
