...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @Field(getter = "getErrorCode", mo19055id = 2)
    private final int zzh;
    @Field(getter = "getResolution", mo19055id = 3)
    private final PendingIntent zzi;
    @Field(getter = "getErrorMessage", mo19055id = 4)
    private final String zzj;

    @Constructor
    ConnectionResult(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) int i2, @Param(mo19058id = 3) PendingIntent pendingIntent, @Param(mo19058id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
