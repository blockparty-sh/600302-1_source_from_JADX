...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @Field(getter = "getWidth", mo19055id = 3)
    private final int zane;
    @Field(getter = "getHeight", mo19055id = 4)
    private final int zanf;
    @Field(getter = "getUrl", mo19055id = 2)
    private final Uri zang;

    @Constructor
    WebImage(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) Uri uri, @Param(mo19058id = 3) int i2, @Param(mo19058id = 4) int i3) {
        this.zalf = i;
        this.zang = uri;
        this.zane = i2;
        this.zanf = i3;
