...
public final class zak extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo19055id = 2)
    private final ArrayList<zal> zaqw;
    @SafeParcelable.Field(getter = "getRootClassName", mo19055id = 3)
    private final String zaqx;

    @Constructor
    zak(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) ArrayList<zal> arrayList, @Param(mo19058id = 3) String str) {
        this.zalf = i;
        this.zaqw = null;
