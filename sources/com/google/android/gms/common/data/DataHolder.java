...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @VersionField(mo19061id = 1000)
    private final int zalf;
    @Field(getter = "getColumns", mo19055id = 1)
    private final String[] zalq;
    private Bundle zalr;
    @Field(getter = "getWindows", mo19055id = 2)
    private final CursorWindow[] zals;
    @Field(getter = "getStatusCode", mo19055id = 3)
    private final int zalt;
    @Field(getter = "getMetadata", mo19055id = 4)
    ...
    @Constructor
    DataHolder(@Param(mo19058id = 1000) int i, @Param(mo19058id = 1) String[] strArr, @Param(mo19058id = 2) CursorWindow[] cursorWindowArr, @Param(mo19058id = 3) int i2, @Param(mo19058id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalx = true;
        this.zalf = i;
        this.zalq = strArr;
