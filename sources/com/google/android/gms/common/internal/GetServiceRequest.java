...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    @Constructor
    GetServiceRequest(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) int i2, @Param(mo19058id = 3) int i3, @Param(mo19058id = 4) String str, @Param(mo19058id = 5) IBinder iBinder, @Param(mo19058id = 6) Scope[] scopeArr, @Param(mo19058id = 7) Bundle bundle, @Param(mo19058id = 8) Account account, @Param(mo19058id = 10) Feature[] featureArr, @Param(mo19058id = 11) Feature[] featureArr2, @Param(mo19058id = 12) boolean z) {
        this.version = i;
        this.zzdg = i2;
        this.zzdh = i3;
