...
public class ResolveAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getSessionId", mo19055id = 3)
    private final int zapa;
    @Field(getter = "getSignInAccountHint", mo19055id = 4)
    private final GoogleSignInAccount zapb;
    @Field(getter = "getAccount", mo19055id = 2)
    private final Account zax;

    @Constructor
    ResolveAccountRequest(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) Account account, @Param(mo19058id = 3) int i2, @Param(mo19058id = 4) GoogleSignInAccount googleSignInAccount) {
        this.zalf = i;
        this.zax = account;
        this.zapa = i2;
