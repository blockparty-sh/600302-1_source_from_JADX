            ...
            if (i != 1) {
                if (i == 2 || i == 3) {
                    ...
                    if (this.zzcj != 3 || getLocalStartServiceAction() == null) {
                        zzh = new zzh(getStartServicePackage(), getStartServiceAction(), false, ScriptOpCodes.OP_RIGHT);
                    } else {
                        zzh = new zzh(getContext().getPackageName(), getLocalStartServiceAction(), true, ScriptOpCodes.OP_RIGHT);
                    }
                    this.zzbz = zzh;
