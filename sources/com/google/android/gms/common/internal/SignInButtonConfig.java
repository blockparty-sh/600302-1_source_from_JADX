...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @Field(getter = "getScopes", mo19055id = 4)
    @Deprecated
    private final Scope[] zany;
    @Field(getter = "getButtonSize", mo19055id = 2)
    private final int zapd;
    @Field(getter = "getColorScheme", mo19055id = 3)
    private final int zape;

    @Constructor
    SignInButtonConfig(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) int i2, @Param(mo19058id = 3) int i3, @Param(mo19058id = 4) Scope[] scopeArr) {
        this.zalf = i;
        this.zapd = i2;
        this.zape = i3;
        this.zany = scopeArr;
