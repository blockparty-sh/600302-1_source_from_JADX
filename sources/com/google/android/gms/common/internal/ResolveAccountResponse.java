...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo19055id = 3)
    private ConnectionResult zadi;
    @Field(getter = "getSaveDefaultAccount", mo19055id = 4)
    private boolean zagg;
    @VersionField(mo19061id = 1)
    private final int zalf;
    @Field(mo19055id = 2)
    private IBinder zanx;
    @Field(getter = "isFromCrossClientAuth", mo19055id = 5)
    private boolean zapc;

    @Constructor
    ResolveAccountResponse(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) IBinder iBinder, @Param(mo19058id = 3) ConnectionResult connectionResult, @Param(mo19058id = 4) boolean z, @Param(mo19058id = 5) boolean z2) {
        this.zalf = i;
        this.zanx = iBinder;
