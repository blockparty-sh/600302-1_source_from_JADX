...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(mo19055id = 6, type = "android.accounts.Account")
    private Account zax;

    @Constructor
    AuthAccountRequest(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) IBinder iBinder, @Param(mo19058id = 3) Scope[] scopeArr, @Param(mo19058id = 4) Integer num, @Param(mo19058id = 5) Integer num2, @Param(mo19058id = 6) Account account) {
        this.zalf = i;
        this.zanx = iBinder;
        this.zany = scopeArr;
        this.zanz = num;
