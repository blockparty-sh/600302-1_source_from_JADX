...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @Field(getter = "getStatusCode", mo19055id = 1)
    private final int zzh;
    @Field(getter = "getPendingIntent", mo19055id = 3)
    @Nullable
    private final PendingIntent zzi;
    @Field(getter = "getStatusMessage", mo19055id = 2)
    @Nullable
    private final String zzj;

    @Constructor
    @KeepForSdk
    Status(@Param(mo19058id = 1000) int i, @Param(mo19058id = 1) int i2, @Param(mo19058id = 2) @Nullable String str, @Param(mo19058id = 3) @Nullable PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;
