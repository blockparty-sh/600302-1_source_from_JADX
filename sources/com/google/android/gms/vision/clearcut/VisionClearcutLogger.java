...
import com.google.android.gms.vision.C1432L;
...
public class VisionClearcutLogger {
    ...
    public final void zzb(int i, zzdu zzdu) {
        ...
        try {
            ...
            try {
                zzjt.zza(zzdu2, bArr);
                C1432L.zzc("Would have logged:\n%s", zzdu2.toString());
            } catch (Exception e) {
                C1432L.zza(e, "Parsing error", new Object[0]);
            }
        } catch (Exception e2) {
            zzct.zza(e2);
            C1432L.zza(e2, "Failed to log", new Object[0]);
        }
    }
}
