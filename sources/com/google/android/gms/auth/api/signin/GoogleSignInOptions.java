...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    @Field(getter = "isForceCodeForRefreshToken", mo19055id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @Field(getter = "getServerClientId", mo19055id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @Field(getter = "getHostedDomain", mo19055id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @Field(getter = "getExtensions", mo19055id = 9)
    ...
    /* access modifiers changed from: private */
    @Field(getter = "getScopes", mo19055id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @Field(getter = "getAccount", mo19055id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @Field(getter = "isIdTokenRequested", mo19055id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @Field(getter = "isServerAuthCodeRequested", mo19055id = 5)
    ...
    @Constructor
    GoogleSignInOptions(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) ArrayList<Scope> arrayList, @Param(mo19058id = 3) Account account, @Param(mo19058id = 4) boolean z, @Param(mo19058id = 5) boolean z2, @Param(mo19058id = 6) boolean z3, @Param(mo19058id = 7) String str, @Param(mo19058id = 8) String str2, @Param(mo19058id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
