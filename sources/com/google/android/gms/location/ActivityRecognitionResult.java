...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Constructor
    public ActivityRecognitionResult(@Param(mo19058id = 1) List<DetectedActivity> list, @Param(mo19058id = 2) long j, @Param(mo19058id = 3) long j2, @Param(mo19058id = 4) int i, @Param(mo19058id = 5) Bundle bundle) {
        boolean z = true;
    ...
    private static List<ActivityRecognitionResult> zza(Intent intent) {
        ...
        return SafeParcelableSerializer.deserializeIterableFromIntentExtra(intent, str, CREATOR);
    }
