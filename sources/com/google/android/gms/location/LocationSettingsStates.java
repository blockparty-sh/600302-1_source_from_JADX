...
public final class LocationSettingsStates extends AbstractSafeParcelable {
    ...
    @Field(getter = "isGpsUsable", mo19055id = 1)
    private final boolean zzbn;
    @Field(getter = "isNetworkLocationUsable", mo19055id = 2)
    private final boolean zzbo;
    @Field(getter = "isBleUsable", mo19055id = 3)
    private final boolean zzbp;
    @Field(getter = "isGpsPresent", mo19055id = 4)
    private final boolean zzbq;
    @Field(getter = "isNetworkLocationPresent", mo19055id = 5)
    private final boolean zzbr;
    @Field(getter = "isBlePresent", mo19055id = 6)
    private final boolean zzbs;

    @Constructor
    public LocationSettingsStates(@Param(mo19058id = 1) boolean z, @Param(mo19058id = 2) boolean z2, @Param(mo19058id = 3) boolean z3, @Param(mo19058id = 4) boolean z4, @Param(mo19058id = 5) boolean z5, @Param(mo19058id = 6) boolean z6) {
        this.zzbn = z;
        this.zzbo = z2;
        this.zzbp = z3;
        this.zzbq = z4;
