...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getTag", mo19055id = 2)
    @Nullable
    private final String tag;
    @Field(getter = "getActivityTransitions", mo19055id = 1)
    private final List<ActivityTransition> zzl;
    @Field(getter = "getClients", mo19055id = 3)
    ...
    @Constructor
    public ActivityTransitionRequest(@Param(mo19058id = 1) List<ActivityTransition> list, @Param(mo19058id = 2) @Nullable String str, @Param(mo19058id = 3) @Nullable List<ClientIdentity> list2) {
