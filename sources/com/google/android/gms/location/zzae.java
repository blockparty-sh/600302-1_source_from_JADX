...
public final class zzae extends AbstractSafeParcelable {
    ...
    @Field(defaultValue = "", getter = "getJustificationText", mo19055id = 1)
    private final String zzbd;
    @Field(defaultValue = "", getter = "getExperimentId", mo19055id = 2)
    private final String zzbe;
    @Field(defaultValue = "", getter = "getTitleText", mo19055id = 5)
    private final String zzbf;

    @Constructor
    zzae(@Param(mo19058id = 5) String str, @Param(mo19058id = 1) String str2, @Param(mo19058id = 2) String str3) {
        this.zzbf = str;
        this.zzbd = str2;
        this.zzbe = str3;
    }
