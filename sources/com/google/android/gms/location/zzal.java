...
public final class zzal extends AbstractSafeParcelable {
    ...
    @Field(defaultValue = "", getter = "getTag", mo19055id = 3)
    private final String tag;
    @Field(getter = "getGeofenceIds", mo19055id = 1)
    private final List<String> zzbu;
    @Field(getter = "getPendingIntent", mo19055id = 2)
    private final PendingIntent zzbv;

    @Constructor
    zzal(@Param(mo19058id = 1) @Nullable List<String> list, @Param(mo19058id = 2) @Nullable PendingIntent pendingIntent, @Param(mo19058id = 3) String str) {
