...
public final class zzaj extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", mo19055id = 2)
    private final int zzar;
    @Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", mo19055id = 1)
    private final int zzas;
    @Field(defaultValueUnchecked = "NetworkLocationStatus.STATUS_INVALID_TIMESTAMP", mo19055id = 4)
    private final long zzat;
    @Field(defaultValueUnchecked = "NetworkLocationStatus.STATUS_INVALID_TIMESTAMP", mo19055id = 3)
    private final long zzbt;

    @Constructor
    zzaj(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) int i2, @Param(mo19058id = 3) long j, @Param(mo19058id = 4) long j2) {
        this.zzas = i;
        this.zzar = i2;
        this.zzbt = j;
        this.zzat = j2;
