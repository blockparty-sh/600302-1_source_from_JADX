...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Deprecated
    private int zzas;
    @Field(defaultValueUnchecked = "0", mo19055id = 3)
    private long zzat;
    @Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNSUCCESSFUL", mo19055id = 4)
    private int zzau;
    @Field(mo19055id = 5)
    private zzaj[] zzav;

    @Constructor
    LocationAvailability(@Param(mo19058id = 4) int i, @Param(mo19058id = 1) int i2, @Param(mo19058id = 2) int i3, @Param(mo19058id = 3) long j, @Param(mo19058id = 5) zzaj[] zzajArr) {
        this.zzau = i;
        this.zzar = i2;
        this.zzas = i3;
        this.zzat = j;
