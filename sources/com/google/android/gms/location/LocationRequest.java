...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_PRIORITY", mo19055id = 1)
    private int priority;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPIRE_AT", mo19055id = 5)
    private long zzaf;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_INTERVAL", mo19055id = 2)
    private long zzaw;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_FASTEST_INTERVAL", mo19055id = 3)
    private long zzax;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_EXPLICIT_FASTEST_INTERVAL", mo19055id = 4)
    private boolean zzay;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_SMALLEST_DISPLACEMENT", mo19055id = 7)
    private float zzaz;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_MAX_WAIT_TIME", mo19055id = 8)
    private long zzba;
    @Field(defaultValueUnchecked = "LocationRequest.DEFAULT_NUM_UPDATES", mo19055id = 6)
    private int zzx;
    ...
    @Constructor
    LocationRequest(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) long j, @Param(mo19058id = 3) long j2, @Param(mo19058id = 4) boolean z, @Param(mo19058id = 5) long j3, @Param(mo19058id = 6) int i2, @Param(mo19058id = 7) float f, @Param(mo19058id = 8) long j4) {
        this.priority = i;
        this.zzaw = j;
        this.zzax = j2;
        this.zzay = z;
