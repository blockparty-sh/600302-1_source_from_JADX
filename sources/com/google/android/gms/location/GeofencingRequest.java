...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getParcelableGeofences", mo19055id = 1)
    private final List<zzbh> zzap;
    @Field(getter = "getInitialTrigger", mo19055id = 2)
    ...
    @Constructor
    GeofencingRequest(@Param(mo19058id = 1) List<zzbh> list, @Param(mo19058id = 2) int i, @Param(mo19058id = 3) String str) {
        this.zzap = list;
        this.zzaq = i;
        this.tag = str;
    }
