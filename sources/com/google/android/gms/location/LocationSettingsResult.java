...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @Field(getter = "getStatus", mo19055id = 1)
    private final Status zzbl;
    @Field(getter = "getLocationSettingsStates", mo19055id = 2)
    ...
    @Constructor
    public LocationSettingsResult(@Param(mo19058id = 1) Status status, @Param(mo19058id = 2) LocationSettingsStates locationSettingsStates) {
        this.zzbl = status;
