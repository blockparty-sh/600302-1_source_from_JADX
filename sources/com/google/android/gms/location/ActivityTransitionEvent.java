...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    @Field(getter = "getActivityType", mo19055id = 1)
    private final int zzi;
    @Field(getter = "getTransitionType", mo19055id = 2)
    private final int zzj;
    @Field(getter = "getElapsedRealTimeNanos", mo19055id = 3)
    private final long zzk;

    @Constructor
    public ActivityTransitionEvent(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) int i2, @Param(mo19058id = 3) long j) {
