...
public final class LocationSettingsRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getLocationRequests", mo19055id = 1)
    private final List<LocationRequest> zzbg;
    @Field(defaultValue = "false", getter = "alwaysShow", mo19055id = 2)
    private final boolean zzbh;
    @Field(getter = "needBle", mo19055id = 3)
    private final boolean zzbi;
    @Field(getter = "getConfiguration", mo19055id = 5)
    private zzae zzbj;
    ...
    @Constructor
    LocationSettingsRequest(@Param(mo19058id = 1) List<LocationRequest> list, @Param(mo19058id = 2) boolean z, @Param(mo19058id = 3) boolean z2, @Param(mo19058id = 5) zzae zzae) {
        this.zzbg = list;
        this.zzbh = z;
        this.zzbi = z2;
        this.zzbj = zzae;
