...
public final class zzj extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "DeviceOrientationRequest.DEFAULT_SHOULD_USE_MAG", mo19055id = 1)
    private boolean zzt;
    @Field(defaultValueUnchecked = "DeviceOrientationRequest.DEFAULT_MINIMUM_SAMPLING_PERIOD_MS", mo19055id = 2)
    private long zzu;
    @Field(defaultValueUnchecked = "DeviceOrientationRequest.DEFAULT_SMALLEST_ANGLE_CHANGE_RADIANS", mo19055id = 3)
    private float zzv;
    @Field(defaultValueUnchecked = "DeviceOrientationRequest.DEFAULT_EXPIRE_AT_MS", mo19055id = 4)
    private long zzw;
    @Field(defaultValueUnchecked = "DeviceOrientationRequest.DEFAULT_NUM_UPDATES", mo19055id = 5)
    private int zzx;
    ...
    @Constructor
    zzj(@Param(mo19058id = 1) boolean z, @Param(mo19058id = 2) long j, @Param(mo19058id = 3) float f, @Param(mo19058id = 4) long j2, @Param(mo19058id = 5) int i) {
        this.zzt = z;
        this.zzu = j;
        this.zzv = f;
        this.zzw = j2;
