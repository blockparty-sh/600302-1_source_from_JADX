...
public final class zzi extends AbstractSafeParcelable implements Comparable<zzi> {
    ...
    @Constructor
    public zzi(@Param(mo19058id = 2) String str, @Param(mo19058id = 3) long j, @Param(mo19058id = 4) boolean z, @Param(mo19058id = 5) double d, @Param(mo19058id = 6) String str2, @Param(mo19058id = 7) byte[] bArr, @Param(mo19058id = 8) int i, @Param(mo19058id = 9) int i2) {
        this.name = str;
        this.zzab = j;
        this.zzac = z;
        this.zzad = d;
