...
public final class zaj extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo19055id = 2)
    private final ConnectionResult zadi;
    @VersionField(mo19061id = 1)
    private final int zalf;
    @Field(getter = "getResolveAccountResponse", mo19055id = 3)
    private final ResolveAccountResponse zase;

    @Constructor
    zaj(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) ConnectionResult connectionResult, @Param(mo19058id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zalf = i;
