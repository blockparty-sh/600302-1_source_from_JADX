...
public final class zzm extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "null", mo19055id = 3)
    @Nullable
    private String tag;
    @Field(defaultValueUnchecked = "DeviceOrientationRequestInternal.DEFAULT_DEVICE_ORIENTATION_REQUEST", mo19055id = 1)
    private zzj zzcf;
    @Field(defaultValueUnchecked = "DeviceOrientationRequestInternal.DEFAULT_CLIENTS", mo19055id = 2)
    private List<ClientIdentity> zzm;

    @Constructor
    zzm(@Param(mo19058id = 1) zzj zzj, @Param(mo19058id = 2) List<ClientIdentity> list, @Param(mo19058id = 3) String str) {
        this.zzcf = zzj;
        this.zzm = list;
        this.tag = str;
    }
