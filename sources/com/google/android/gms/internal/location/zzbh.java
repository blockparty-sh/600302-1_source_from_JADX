...
public final class zzbh extends AbstractSafeParcelable implements Geofence {
    ...
    @Field(getter = "getRequestId", mo19055id = 1)
    private final String zzad;
    @Field(getter = "getTransitionTypes", mo19055id = 7)
    private final int zzae;
    @Field(getter = "getType", mo19055id = 3)
    private final short zzag;
    @Field(getter = "getLatitude", mo19055id = 4)
    private final double zzah;
    @Field(getter = "getLongitude", mo19055id = 5)
    private final double zzai;
    @Field(getter = "getRadius", mo19055id = 6)
    private final float zzaj;
    @Field(defaultValue = "0", getter = "getNotificationResponsiveness", mo19055id = 8)
    private final int zzak;
    @Field(defaultValue = "-1", getter = "getLoiteringDelay", mo19055id = 9)
    private final int zzal;
    @Field(getter = "getExpirationTime", mo19055id = 2)
    private final long zzdo;

    @Constructor
    public zzbh(@Param(mo19058id = 1) String str, @Param(mo19058id = 7) int i, @Param(mo19058id = 3) short s, @Param(mo19058id = 4) double d, @Param(mo19058id = 5) double d2, @Param(mo19058id = 6) float f, @Param(mo19058id = 2) long j, @Param(mo19058id = 8) int i2, @Param(mo19058id = 9) int i3) {
