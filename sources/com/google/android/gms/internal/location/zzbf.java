...
public final class zzbf extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "null", mo19055id = 4)
    private PendingIntent zzbv;
    @Field(defaultValueUnchecked = "LocationRequestUpdateData.OPERATION_ADD", mo19055id = 1)
    private int zzcg;
    @Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo19055id = 6, type = "android.os.IBinder")
    private zzaj zzcj;
    @Field(defaultValueUnchecked = "null", mo19055id = 2)
    private zzbd zzdl;
    @Field(defaultValueUnchecked = "null", getter = "getLocationListenerBinder", mo19055id = 3, type = "android.os.IBinder")
    private zzx zzdm;
    @Field(defaultValueUnchecked = "null", getter = "getLocationCallbackBinder", mo19055id = 5, type = "android.os.IBinder")
    private zzu zzdn;

    @Constructor
    zzbf(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) zzbd zzbd, @Param(mo19058id = 3) IBinder iBinder, @Param(mo19058id = 4) PendingIntent pendingIntent, @Param(mo19058id = 5) IBinder iBinder2, @Param(mo19058id = 6) IBinder iBinder3) {
        this.zzcg = i;
        this.zzdl = zzbd;
        zzaj zzaj = null;
