...
public final class zzo extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "DeviceOrientationRequestUpdateData.OPERATION_ADD", mo19055id = 1)
    private int zzcg;
    @Field(defaultValueUnchecked = "null", mo19055id = 2)
    private zzm zzch;
    @Field(defaultValueUnchecked = "null", getter = "getDeviceOrientationListenerBinder", mo19055id = 3, type = "android.os.IBinder")
    private zzr zzci;
    @Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo19055id = 4, type = "android.os.IBinder")
    private zzaj zzcj;

    @Constructor
    zzo(@Param(mo19058id = 1) int i, @Param(mo19058id = 2) zzm zzm, @Param(mo19058id = 3) IBinder iBinder, @Param(mo19058id = 4) IBinder iBinder2) {
        this.zzcg = i;
        this.zzch = zzm;
        zzaj zzaj = null;
