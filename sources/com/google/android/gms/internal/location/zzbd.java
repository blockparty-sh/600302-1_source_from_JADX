...
public final class zzbd extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "null", mo19055id = 10)
    @Nullable
    private String moduleId;
    @Field(defaultValueUnchecked = "null", mo19055id = 6)
    @Nullable
    private String tag;
    @Field(defaultValueUnchecked = "null", mo19055id = 1)
    private LocationRequest zzdg;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_HIDE_FROM_APP_OPS", mo19055id = 7)
    private boolean zzdh;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_FORCE_COARSE_LOCATION", mo19055id = 8)
    private boolean zzdi;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_EXEMPT_FROM_THROTTLE", mo19055id = 9)
    private boolean zzdj;
    private boolean zzdk = true;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_CLIENTS", mo19055id = 5)
    private List<ClientIdentity> zzm;

    @Constructor
    zzbd(@Param(mo19058id = 1) LocationRequest locationRequest, @Param(mo19058id = 5) List<ClientIdentity> list, @Param(mo19058id = 6) @Nullable String str, @Param(mo19058id = 7) boolean z, @Param(mo19058id = 8) boolean z2, @Param(mo19058id = 9) boolean z3, @Param(mo19058id = 10) String str2) {
