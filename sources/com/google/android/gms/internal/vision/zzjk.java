...
public final class zzjk {
    ...
    public final int zzdt() throws IOException {
        ...
        byte b2 = zzdy & Byte.MAX_VALUE;
        byte zzdy2 = zzdy();
        if (zzdy2 >= 0) {
            i = zzdy2 << 7;
        } else {
            b2 |= (zzdy2 & Byte.MAX_VALUE) << 7;
            byte zzdy3 = zzdy();
            if (zzdy3 >= 0) {
                i = zzdy3 << Ascii.f529SO;
            } else {
                b2 |= (zzdy3 & Byte.MAX_VALUE) << Ascii.f529SO;
                byte zzdy4 = zzdy();
                if (zzdy4 >= 0) {
                    i = zzdy4 << Ascii.NAK;
                } else {
                    byte b3 = b2 | ((zzdy4 & Byte.MAX_VALUE) << Ascii.NAK);
                    byte zzdy5 = zzdy();
                    b = b3 | (zzdy5 << Ascii.f522FS);
                    if (zzdy5 < 0) {
    ...
    public final int zzdv() throws IOException {
        return (zzdy() & 255) | ((zzdy() & 255) << 8) | ((zzdy() & 255) << 16) | ((zzdy() & 255) << Ascii.CAN);
    }
