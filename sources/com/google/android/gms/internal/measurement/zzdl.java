...
final class zzdl {
    ...
    static int zza(int i, byte[] bArr, int i2, zzdk zzdk) {
        ...
        byte b2 = bArr[i4];
        if (b2 >= 0) {
            zzdk.zzada = i5 | (b2 << Ascii.f529SO);
            return i6;
        }
        int i7 = i5 | ((b2 & Byte.MAX_VALUE) << Ascii.f529SO);
        int i8 = i6 + 1;
        byte b3 = bArr[i6];
        if (b3 >= 0) {
            zzdk.zzada = i7 | (b3 << Ascii.NAK);
            return i8;
        }
        ...
        byte b4 = bArr[i8];
        if (b4 >= 0) {
            zzdk.zzada = i9 | (b4 << Ascii.f522FS);
            return i10;
        }
        int i11 = i9 | ((b4 & Byte.MAX_VALUE) << Ascii.f522FS);
        while (true) {
            int i12 = i10 + 1;
            if (bArr[i10] >= 0) {
                zzdk.zzada = i11;
