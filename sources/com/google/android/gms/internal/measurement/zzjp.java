...
public final class zzjp implements zzjq {
    ...
    static {
        ...
        zzapx = zzct.zze("measurement.ad_id_cache_time", WorkRequest.MIN_BACKOFF_MILLIS);
        ...
        zzaqk = zzct.zze("measurement.upload.realtime_upload_interval", WorkRequest.MIN_BACKOFF_MILLIS);
        ...
        zzaqz = zzct.zze("measurement.upload.max_public_events_per_day", ListMessage.MAX_INVENTORY_ITEMS);
