...
public final class zzge {
    ...
    public static final class zza extends zzcg<zza, C3648zza> implements zzdq {
        ...
        public static final class C3648zza extends com.google.android.gms.internal.clearcut.zzcg.zza<zza, C3648zza> implements zzdq {
            private C3648zza() {
                super(zza.zzsm);
            }

            /* synthetic */ C3648zza(zzgf zzgf) {
                this();
            }
        }
    ...
    public static final class zzq extends com.google.android.gms.internal.clearcut.zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            GOOGLE_EXPRESS_STOREOMS_ANDROID_PRIMES(TorDiscovery.RESOLVE_ERROR),
            SENSE(83),
            ANDROID_BACKUP(84),
            VR(85),
            IME_COUNTERS(86),
            ...
            GRAPHICS_STATS(107),
            PROC_STATS(93),
            DROP_BOX(ScriptOpCodes.OP_INVERT),
            ...
            TAILORMADE(127),
            KEEP(128),
            GMM_BRIIM_COUNTERS(ScriptOpCodes.OP_RIGHT),
            CHROMECAST_APP_LOG(ScriptOpCodes.OP_SIZE),
            ADWORDS_MOBILE(133),
            ...
            CPANEL_ANDROID_PRIMES(C239114.DENSITY_TV),
            ...
            PDF_VIEWER(CipherSuite.TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA256),
            ...
            BOQ_WEB(241),
            ORCHESTRATION_CLIENT(Options.RSA_ECB_PKCS1PADDING_ENCRYPTION_BLOCK_SIZE_FOR_JELLY_BEAN),
            ...
            VR_SDK_ANDROID_PRIMES(HttpStatus.HTTP_NOT_FOUND),
            PHOTOS_SCANNER(406),
            BG_IN_OGB(407),
            BLOGGER(408),
            CORP_IOS_FOOD(409),
            ...
            PIGEON_EXPERIMENTAL(C239114.DENSITY_XXHIGH),
            ...
            ANDROID_GROWTH(498),
            GHS_CLIENT_LOGS(499),
            GOR_ANDROID_PRIMES(HttpStatus.HTTP_INTERNAL_SERVER_ERROR),
            NETREC(HttpStatus.HTTP_NOT_IMPLEMENTED),
            NETREC_COUNTERS(502),
            ...
            public static zzb zzax(int i) {
                switch (i) {
                    ...
                    case C239114.DENSITY_XXHIGH /*480*/:
