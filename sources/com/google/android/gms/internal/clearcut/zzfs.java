                    ...
                    if (i4 == length) {
                        ...
                        while (i4 < length) {
                            ...
                            if (charAt2 < 128 && i2 < i5) {
                                ...
                                int i8 = i2 + 1;
                                array[i2] = (byte) ((charAt2 >>> 12) | C239114.DENSITY_XXHIGH);
                                int i9 = i8 + 1;
                                ...
                                if (i10 != charSequence.length()) {
                                    ...
                                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                                        ...
                                        int i11 = i2 + 1;
                                        array[i2] = (byte) ((codePoint >>> 18) | TorDiscovery.RESOLVE_ERROR);
                                        int i12 = i11 + 1;
                ...
                while (i4 < length2) {
                    ...
                    if (charAt4 >= 128) {
                        if (charAt4 < 2048) {
                            ...
                            byteBuffer.put((byte) ((charAt4 >>> 12) | C239114.DENSITY_XXHIGH));
                            i = ((charAt4 >>> 6) & 63) | 128;
                        } else {
                            int i15 = i4 + 1;
                            if (i15 != charSequence.length()) {
                                ...
                                if (Character.isSurrogatePair(charAt4, charAt5)) {
                                    ...
                                    byteBuffer.put((byte) ((codePoint2 >>> 18) | TorDiscovery.RESOLVE_ERROR));
