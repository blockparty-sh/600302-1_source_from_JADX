    ...
    public static long zza(byte[] bArr) {
        ...
        if (length <= 32) {
            if (length > 16) {
                ...
                return zza(((((long) zza(bArr2, 0)) & TransactionInput.NO_SEQUENCE) << 3) + ((long) length), ((long) zza(bArr2, (length + 0) - 4)) & TransactionInput.NO_SEQUENCE, ((long) (length << 1)) - 7286425919675154353L);
            } else if (length <= 0) {
            ...
            return zza(Long.rotateRight(zzb9 + zzb10, 43) + Long.rotateRight(zzb11, 30) + ((zza + zzb(bArr3, i3 - 24)) * j4), zzb9 + Long.rotateRight(zzb10 + zzb6, 18) + zzb11, j5);
        } else {
            ...
            while (true) {
                ...
                if (i11 == i10) {
                    ...
                    zza(bArr, i7, jArr[1] * j8, jArr2[0] + rotateRight5, jArr);
