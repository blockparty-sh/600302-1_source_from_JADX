...
public class MaterialAlertDialogBuilder extends Builder {
    @AttrRes
    private static final int DEF_STYLE_ATTR = C1435R.attr.alertDialogStyle;
    @StyleRes
    private static final int DEF_STYLE_RES = C1435R.C1440style.MaterialAlertDialog_MaterialComponents;
    @AttrRes
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C1435R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C1435R.attr.colorSurface, getClass().getCanonicalName());
    ...
    public MaterialAlertDialogBuilder setBackgroundInsetStart(@C0045Px int i) {
    ...
    public MaterialAlertDialogBuilder setBackgroundInsetTop(@C0045Px int i) {
        this.backgroundInsets.top = i;
        return this;
    }

    public MaterialAlertDialogBuilder setBackgroundInsetEnd(@C0045Px int i) {
        if (VERSION.SDK_INT < 17 || getContext().getResources().getConfiguration().getLayoutDirection() != 1) {
            this.backgroundInsets.right = i;
        } else {
            this.backgroundInsets.left = i;
    ...
    public MaterialAlertDialogBuilder setBackgroundInsetBottom(@C0045Px int i) {
    ...
    public MaterialAlertDialogBuilder setPositiveButton(@StringRes int i, OnClickListener onClickListener) {
    ...
    public MaterialAlertDialogBuilder setNegativeButton(@StringRes int i, OnClickListener onClickListener) {
    ...
    public MaterialAlertDialogBuilder setNeutralButton(@StringRes int i, OnClickListener onClickListener) {
    ...
    public MaterialAlertDialogBuilder setItems(@ArrayRes int i, OnClickListener onClickListener) {
    ...
    public MaterialAlertDialogBuilder setMultiChoiceItems(@ArrayRes int i, boolean[] zArr, OnMultiChoiceClickListener onMultiChoiceClickListener) {
    ...
    public MaterialAlertDialogBuilder setSingleChoiceItems(@ArrayRes int i, int i2, OnClickListener onClickListener) {
