...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public BorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C1435R.C1436color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C1435R.C1436color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C1435R.C1436color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C1435R.C1436color.design_fab_stroke_end_outer_color));
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        ...
        if (this.usingDefaultCorner) {
            shapeAppearanceModel.setCornerRadius(((float) this.view.getSizeDimension()) / 2.0f);
        }
