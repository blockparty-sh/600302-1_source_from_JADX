...
public class BottomAppBar extends Toolbar implements AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C1435R.C1440style.Widget_MaterialComponents_BottomAppBar;
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        private final OnLayoutChangeListener fabLayoutListener = new OnLayoutChangeListener() {
            public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                ...
                if (bottomAppBar.setFabDiameter(Behavior.this.fabContentRect.height())) {
                    LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
                    if (layoutParams.bottomMargin == 0) {
                        layoutParams.bottomMargin = Math.max(0, bottomAppBar.getResources().getDimensionPixelOffset(C1435R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((floatingActionButton.getMeasuredHeight() - Behavior.this.fabContentRect.height()) / 2));
                    }
                }
            }
        };
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, int i) {
            ...
            View access$1400 = bottomAppBar.findDependentView();
            if (access$1400 != null && !ViewCompat.isLaidOut(access$1400)) {
                ((LayoutParams) access$1400.getLayoutParams()).anchorGravity = 49;
                if (access$1400 instanceof FloatingActionButton) {
                    FloatingActionButton floatingActionButton = (FloatingActionButton) access$1400;
    ...
    public BottomAppBar(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C1435R.attr.bottomAppBarStyle);
    }
    ...
    public BottomAppBar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1435R.styleable.BottomAppBar, i, DEF_STYLE_RES, new int[0]);
        ColorStateList colorStateList = MaterialResources.getColorStateList(context2, obtainStyledAttributes, C1435R.styleable.BottomAppBar_backgroundTint);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C1435R.styleable.BottomAppBar_elevation, 0);
        float dimensionPixelOffset = (float) obtainStyledAttributes.getDimensionPixelOffset(C1435R.styleable.BottomAppBar_fabCradleMargin, 0);
        float dimensionPixelOffset2 = (float) obtainStyledAttributes.getDimensionPixelOffset(C1435R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0);
        float dimensionPixelOffset3 = (float) obtainStyledAttributes.getDimensionPixelOffset(C1435R.styleable.BottomAppBar_fabCradleVerticalOffset, 0);
        this.fabAlignmentMode = obtainStyledAttributes.getInt(C1435R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.fabAnimationMode = obtainStyledAttributes.getInt(C1435R.styleable.BottomAppBar_fabAnimationMode, 0);
        this.hideOnScroll = obtainStyledAttributes.getBoolean(C1435R.styleable.BottomAppBar_hideOnScroll, false);
        obtainStyledAttributes.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C1435R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
        this.materialShapeDrawable.getShapeAppearanceModel().setTopEdge(new BottomAppBarTopEdgeTreatment(dimensionPixelOffset, dimensionPixelOffset2, dimensionPixelOffset3));
    ...
    /* access modifiers changed from: 0000 */
    public boolean setFabDiameter(@C0045Px int i) {
        float f = (float) i;
