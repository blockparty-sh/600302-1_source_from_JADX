...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Callback, TextDrawableDelegate {
    ...
    public static ChipDrawable createFromResource(Context context2, @XmlRes int i) {
        ...
        try {
            ...
            if (next != 2) {
                ...
                if (styleAttribute == 0) {
                    styleAttribute = C1435R.C1440style.Widget_MaterialComponents_Chip_Entry;
                }
                return createFromAttributes(context2, asAttributeSet, C1435R.attr.chipStandaloneStyle, styleAttribute);
            } else {
    ...
    private ChipDrawable(Context context2, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
    ...
    private void loadFromAttributes(AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, C1435R.styleable.Chip, i, i2, new int[0]);
        this.isShapeThemingEnabled = obtainStyledAttributes.hasValue(C1435R.styleable.Chip_shapeAppearance);
        setChipSurfaceColor(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, C1435R.styleable.Chip_chipSurfaceColor));
        setChipBackgroundColor(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, C1435R.styleable.Chip_chipBackgroundColor));
        setChipMinHeight(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_chipMinHeight, 0.0f));
        if (obtainStyledAttributes.hasValue(C1435R.styleable.Chip_chipCornerRadius)) {
            setChipCornerRadius(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_chipCornerRadius, 0.0f));
        }
        setChipStrokeColor(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, C1435R.styleable.Chip_chipStrokeColor));
        setChipStrokeWidth(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_chipStrokeWidth, 0.0f));
        setRippleColor(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, C1435R.styleable.Chip_rippleColor));
        setText(obtainStyledAttributes.getText(C1435R.styleable.Chip_android_text));
        setTextAppearance(MaterialResources.getTextAppearance(this.context, obtainStyledAttributes, C1435R.styleable.Chip_android_textAppearance));
        int i3 = obtainStyledAttributes.getInt(C1435R.styleable.Chip_android_ellipsize, 0);
        if (i3 == 1) {
        ...
        setChipIconVisible(obtainStyledAttributes.getBoolean(C1435R.styleable.Chip_chipIconVisible, false));
        ...
        if (!(attributeSet == null || attributeSet.getAttributeValue(str, "chipIconEnabled") == null || attributeSet.getAttributeValue(str, "chipIconVisible") != null)) {
            setChipIconVisible(obtainStyledAttributes.getBoolean(C1435R.styleable.Chip_chipIconEnabled, false));
        }
        setChipIcon(MaterialResources.getDrawable(this.context, obtainStyledAttributes, C1435R.styleable.Chip_chipIcon));
        setChipIconTint(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, C1435R.styleable.Chip_chipIconTint));
        setChipIconSize(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_chipIconSize, 0.0f));
        setCloseIconVisible(obtainStyledAttributes.getBoolean(C1435R.styleable.Chip_closeIconVisible, false));
        if (!(attributeSet == null || attributeSet.getAttributeValue(str, "closeIconEnabled") == null || attributeSet.getAttributeValue(str, "closeIconVisible") != null)) {
            setCloseIconVisible(obtainStyledAttributes.getBoolean(C1435R.styleable.Chip_closeIconEnabled, false));
        }
        setCloseIcon(MaterialResources.getDrawable(this.context, obtainStyledAttributes, C1435R.styleable.Chip_closeIcon));
        setCloseIconTint(MaterialResources.getColorStateList(this.context, obtainStyledAttributes, C1435R.styleable.Chip_closeIconTint));
        setCloseIconSize(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_closeIconSize, 0.0f));
        setCheckable(obtainStyledAttributes.getBoolean(C1435R.styleable.Chip_android_checkable, false));
        setCheckedIconVisible(obtainStyledAttributes.getBoolean(C1435R.styleable.Chip_checkedIconVisible, false));
        if (!(attributeSet == null || attributeSet.getAttributeValue(str, "checkedIconEnabled") == null || attributeSet.getAttributeValue(str, "checkedIconVisible") != null)) {
            setCheckedIconVisible(obtainStyledAttributes.getBoolean(C1435R.styleable.Chip_checkedIconEnabled, false));
        }
        setCheckedIcon(MaterialResources.getDrawable(this.context, obtainStyledAttributes, C1435R.styleable.Chip_checkedIcon));
        setShowMotionSpec(MotionSpec.createFromAttribute(this.context, obtainStyledAttributes, C1435R.styleable.Chip_showMotionSpec));
        setHideMotionSpec(MotionSpec.createFromAttribute(this.context, obtainStyledAttributes, C1435R.styleable.Chip_hideMotionSpec));
        setChipStartPadding(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_chipStartPadding, 0.0f));
        setIconStartPadding(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_iconStartPadding, 0.0f));
        setIconEndPadding(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_iconEndPadding, 0.0f));
        setTextStartPadding(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_textStartPadding, 0.0f));
        setTextEndPadding(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_textEndPadding, 0.0f));
        setCloseIconStartPadding(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_closeIconStartPadding, 0.0f));
        setCloseIconEndPadding(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_closeIconEndPadding, 0.0f));
        setChipEndPadding(obtainStyledAttributes.getDimension(C1435R.styleable.Chip_chipEndPadding, 0.0f));
        setMaxWidth(obtainStyledAttributes.getDimensionPixelSize(C1435R.styleable.Chip_android_maxWidth, Integer.MAX_VALUE));
    ...
    private void drawChipSurface(@NonNull Canvas canvas, Rect rect) {
        if (!this.isShapeThemingEnabled) {
    ...
    private boolean onStateChange(int[] r6, int[] r7) {
        ...
        L_0x00e7:
            ...
            r0 = r0 | r6
        L_0x00f6:
            boolean r6 = com.google.android.material.ripple.RippleUtils.USE_FRAMEWORK_RIPPLE
            if (r6 == 0) goto L_0x0109
            android.graphics.drawable.Drawable r6 = r5.closeIconRipple
            boolean r6 = isStateful(r6)
            if (r6 == 0) goto L_0x0109
            android.graphics.drawable.Drawable r6 = r5.closeIconRipple
            boolean r6 = r6.setState(r7)
    ...
    private void setChipSurfaceColor(@Nullable ColorStateList colorStateList) {
        if (this.chipSurfaceColor != colorStateList) {
            ...
            if (this.isShapeThemingEnabled && colorStateList != null) {
    ...
    private ColorStateList compositeSurfaceBackgroundColor(@NonNull ColorStateList colorStateList, @NonNull ColorStateList colorStateList2) {
    ...
    private void updateFrameworkCloseIconRipple() {
        this.closeIconRipple = new RippleDrawable(RippleUtils.convertToRippleDrawableColor(getRippleColor()), this.closeIcon, closeIconRippleMask);
    }
    ...
    public void setMaxWidth(@C0045Px int i) {
        this.maxWidth = i;
    }
