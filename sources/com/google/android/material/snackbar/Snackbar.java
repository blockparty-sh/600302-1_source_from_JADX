...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C1435R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(findSuitableParent.getContext()).inflate(hasSnackbarButtonStyleAttr(findSuitableParent.getContext()) ? C1435R.layout.mtrl_layout_snackbar_include : C1435R.layout.design_layout_snackbar_include, findSuitableParent, false);
    ...
    public Snackbar setBackgroundTint(@ColorInt int i) {
        ...
        if (background != null) {
            if (VERSION.SDK_INT >= 22) {
                ...
                background.setColorFilter(i, Mode.SRC_IN);
            }
        }
        return this;
    }
