...
public class BadgeUtils {
    public static final boolean USE_COMPAT_PARENT = (VERSION.SDK_INT < 18);
    ...
    public static void detachBadgeDrawable(@Nullable BadgeDrawable badgeDrawable, View view, FrameLayout frameLayout) {
