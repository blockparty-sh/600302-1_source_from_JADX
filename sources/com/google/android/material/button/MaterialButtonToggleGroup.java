...
public class MaterialButtonToggleGroup extends RelativeLayout {
    ...
    public MaterialButtonToggleGroup(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C1435R.attr.materialButtonToggleGroupStyle);
    }
    ...
    public MaterialButtonToggleGroup(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1435R.styleable.MaterialButtonToggleGroup, i, C1435R.C1440style.Widget_MaterialComponents_MaterialButtonToggleGroup, new int[0]);
        setSingleSelection(obtainStyledAttributes.getBoolean(C1435R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.checkedId = obtainStyledAttributes.getResourceId(C1435R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
    ...
    public void clearChecked() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            MaterialButton materialButton = (MaterialButton) this.childrenInOrder.get(i);
    ...
    private void adjustChildMarginsAndUpdateLayout() {
        for (int i = 1; i < getChildCount(); i++) {
            MaterialButton materialButton = (MaterialButton) this.childrenInOrder.get(i);
            MaterialButton materialButton2 = (MaterialButton) this.childrenInOrder.get(i - 1);
    ...
    private void resetFirstChildMargin() {
        if (!this.childrenInOrder.isEmpty()) {
            MaterialButton materialButton = (MaterialButton) this.childrenInOrder.get(0);
    ...
    public void updateCheckedStates(int i, boolean z) {
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            MaterialButton materialButton = (MaterialButton) this.childrenInOrder.get(i2);
            if (materialButton.isChecked()) {
    ...
    private RelativeLayout.LayoutParams buildEndAlignLayoutParams(@Nullable View view, View view2) {
        ...
        layoutParams2.addRule(z ? 1 : 0, view.getId());
        return layoutParams2;
    }
}
