...
class MaterialButtonHelper {
    ...
    public void loadFromAttributes(TypedArray typedArray) {
        this.insetLeft = typedArray.getDimensionPixelOffset(C1435R.styleable.MaterialButton_android_insetLeft, 0);
        this.insetRight = typedArray.getDimensionPixelOffset(C1435R.styleable.MaterialButton_android_insetRight, 0);
        this.insetTop = typedArray.getDimensionPixelOffset(C1435R.styleable.MaterialButton_android_insetTop, 0);
        this.insetBottom = typedArray.getDimensionPixelOffset(C1435R.styleable.MaterialButton_android_insetBottom, 0);
        if (typedArray.hasValue(C1435R.styleable.MaterialButton_cornerRadius)) {
            this.cornerRadius = typedArray.getDimensionPixelSize(C1435R.styleable.MaterialButton_cornerRadius, -1);
            this.shapeAppearanceModel.setCornerRadius((float) this.cornerRadius);
            this.cornerRadiusSet = true;
        }
        this.strokeWidth = typedArray.getDimensionPixelSize(C1435R.styleable.MaterialButton_strokeWidth, 0);
        this.backgroundTintMode = ViewUtils.parseTintMode(typedArray.getInt(C1435R.styleable.MaterialButton_backgroundTintMode, -1), Mode.SRC_IN);
        this.backgroundTint = MaterialResources.getColorStateList(this.materialButton.getContext(), typedArray, C1435R.styleable.MaterialButton_backgroundTint);
        this.strokeColor = MaterialResources.getColorStateList(this.materialButton.getContext(), typedArray, C1435R.styleable.MaterialButton_strokeColor);
        this.rippleColor = MaterialResources.getColorStateList(this.materialButton.getContext(), typedArray, C1435R.styleable.MaterialButton_rippleColor);
        this.checkable = typedArray.getBoolean(C1435R.styleable.MaterialButton_android_checkable, false);
        int dimensionPixelSize = typedArray.getDimensionPixelSize(C1435R.styleable.MaterialButton_elevation, 0);
    ...
    private Drawable createBackground() {
        ...
        materialShapeDrawable2.setStroke((float) this.strokeWidth, this.shouldDrawSurfaceColorStroke ? MaterialColors.getColor(this.materialButton, C1435R.attr.colorSurface) : 0);
    ...
    private void updateStroke() {
        ...
        if (materialShapeDrawable != null) {
            ...
            if (surfaceColorStrokeDrawable != null) {
                surfaceColorStrokeDrawable.setStroke((float) this.strokeWidth, this.shouldDrawSurfaceColorStroke ? MaterialColors.getColor(this.materialButton, C1435R.attr.colorSurface) : 0);
            }
            if (IS_LOLLIPOP) {
                ShapeAppearanceModel shapeAppearanceModel2 = new ShapeAppearanceModel(this.shapeAppearanceModel);
                adjustShapeAppearanceModelCornerRadius(shapeAppearanceModel2, ((float) this.strokeWidth) / 2.0f);
