...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C1435R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C1435R.C1437drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C1435R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C1435R.C1438id.icon);
        this.smallLabel = (TextView) findViewById(C1435R.C1438id.smallLabel);
        this.largeLabel = (TextView) findViewById(C1435R.C1438id.largeLabel);
