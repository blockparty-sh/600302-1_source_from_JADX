...
public final class zza {
    ...
    private final String zzc(String str) {
        ...
        if (notificationManager.getNotificationChannel(str3) == null) {
            notificationManager.createNotificationChannel(new NotificationChannel(str3, this.zzb.getString(this.zzb.getResources().getIdentifier("fcm_fallback_notification_channel_label", "string", this.zzc)), 3));
        }
        return str3;
    }
