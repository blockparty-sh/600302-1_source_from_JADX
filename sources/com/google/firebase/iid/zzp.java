...
final class zzp {
    ...
    private static PublicKey zza(String str) throws zzs {
        try {
            try {
                return KeyFactory.getInstance(Options.ALGORITHM_RSA).generatePublic(new X509EncodedKeySpec(Base64.decode(str, 8)));
    ...
    private static zzr zza(FileChannel fileChannel) throws zzs, IOException {
        ...
        try {
            ...
            String property = properties.getProperty(CommonProperties.f657ID);
            if (property == null) {
    ...
    private static zzr zza(SharedPreferences sharedPreferences, String str) throws zzs {
        ...
        String string = sharedPreferences.getString(zzaq.zza(str, CommonProperties.f657ID), null);
        if (string == null) {
    ...
    private final void zza(Context context, String str, zzr zzr) {
        ...
        edit.putString(zzaq.zza(str, CommonProperties.f657ID), zzr.zza());
