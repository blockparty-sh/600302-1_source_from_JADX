...
final /* synthetic */ class zzaa implements Runnable {
    ...
    public final void run() {
        ...
        L_0x0002:
            ...
            return
        L_0x000a:
            java.util.Queue<com.google.firebase.iid.zzae<?>> r1 = r0.zzd     // Catch:{ all -> 0x00ae }
            boolean r1 = r1.isEmpty()     // Catch:{ all -> 0x00ae }
            if (r1 == 0) goto L_0x0017
            r0.zza()     // Catch:{ all -> 0x00ae }
            monitor-exit(r0)     // Catch:{ all -> 0x00ae }
            return
        L_0x0017:
            java.util.Queue<com.google.firebase.iid.zzae<?>> r1 = r0.zzd     // Catch:{ all -> 0x00ae }
            ...
            android.util.SparseArray<com.google.firebase.iid.zzae<?>> r3 = r0.zze     // Catch:{ all -> 0x00ae }
            int r4 = r1.zza     // Catch:{ all -> 0x00ae }
            r3.put(r4, r1)     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzu r3 = r0.zzf     // Catch:{ all -> 0x00ae }
            java.util.concurrent.ScheduledExecutorService r3 = r3.zzc     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.zzz r4 = new com.google.firebase.iid.zzz     // Catch:{ all -> 0x00ae }
        ...
        L_0x0066:
            ...
            r4.putBundle(r3, r1)
            r5.setData(r4)
            com.google.firebase.iid.zzac r1 = r0.zzc     // Catch:{ RemoteException -> 0x00a4 }
