...
public class IntentIntegrator {
    ...
    public Intent createScanIntent() {
        ...
        if (this.desiredBarcodeFormats != null) {
            ...
            intent.putExtra(Scan.FORMATS, sb.toString());
        }
    ...
    public static IntentResult parseActivityResult(int i, Intent intent) {
        ...
        IntentResult intentResult = new IntentResult(stringExtra, stringExtra2, byteArrayExtra, num, intent.getStringExtra(Scan.RESULT_ERROR_CORRECTION_LEVEL), intent.getStringExtra(Scan.RESULT_BARCODE_IMAGE_PATH));
        return intentResult;
    }
