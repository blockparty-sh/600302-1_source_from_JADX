...
final class DecodedBitStreamParser {
    ...
    /* renamed from: AL */
    private static final int f620AL = 28;

    /* renamed from: AS */
    private static final int f621AS = 27;
    ...
    /* renamed from: LL */
    private static final int f622LL = 27;
    private static final int MACRO_PDF417_TERMINATOR = 922;
    private static final int MAX_NUMERIC_CODEWORDS = 15;
    private static final char[] MIXED_CHARS = "0123456789&\r\t,:#-.$/+%*=^".toCharArray();

    /* renamed from: ML */
    private static final int f623ML = 28;
    ...
    /* renamed from: PL */
    private static final int f624PL = 25;

    /* renamed from: PS */
    private static final int f625PS = 29;
            ...
            if (i4 == MACRO_PDF417_TERMINATOR) {
                ...
                while (i5 < iArr[0] && !z) {
                    ...
                    if (i8 < TEXT_COMPACTION_MODE_LATCH) {
                        ...
                        i5 = i7;
                        i6 = i9;
                    } else if (i8 == MACRO_PDF417_TERMINATOR) {
                        pDF417ResultMetadata.setLastSegment(true);
                        i5 = i7 + 1;
                        z = true;
                    } else {
    ...
    private static void decodeTextCompaction(int[] r12, int[] r13, int r14, java.lang.StringBuilder r15) {
        ...
        L_0x0008:
            ...
            r4 = r12[r0]
            int[] r5 = com.google.zxing.pdf417.decoder.DecodedBitStreamParser.C22301.f626x45bba1d
            int r6 = r1.ordinal()
            r5 = r5[r6]
            r6 = 32
            r7 = 29
