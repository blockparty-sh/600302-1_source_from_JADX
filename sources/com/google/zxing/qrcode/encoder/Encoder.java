...
public final class Encoder {
    ...
    static /* synthetic */ class C22421 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.qrcode.encoder.Encoder.C22421.<clinit>():void");
        }
    }
    ...
    public static QRCode encode(String str, ErrorCorrectionLevel errorCorrectionLevel, Map<EncodeHintType, ?> map) throws WriterException {
        ...
        String obj = z2 ? map.get(EncodeHintType.CHARACTER_SET).toString() : str2;
        Mode chooseMode = chooseMode(str, obj);
        BitArray bitArray = new BitArray();
        if (chooseMode == Mode.BYTE && (z2 || !str2.equals(obj))) {
    ...
    static void appendBytes(String str, Mode mode, BitArray bitArray, String str2) throws WriterException {
        int i = C22421.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
