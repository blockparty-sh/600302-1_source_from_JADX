...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f611FS = '\u001c';

    /* renamed from: GS */
    private static final char f612GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f613NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f614RS = '\u001e';
    ...
    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f531US, 32});
    }

    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{Framer.ENTER_FRAME_PREFIX, 34, 35, 36, Ascii.f520EM, Ascii.SUB, Ascii.ESC, Ascii.f522FS, Ascii.f523GS, Ascii.f527RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f519CR, Ascii.f529SO, Ascii.f528SI, 16, 17, Ascii.DC2, 7, 8, 9, 10, Ascii.f532VT, Ascii.f521FF, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f531US, 32})), SETS[0].charAt(getInt(bArr, new byte[]{Framer.ENTER_FRAME_PREFIX, 34, 35, 36, Ascii.f520EM, Ascii.SUB})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.f522FS, Ascii.f523GS, Ascii.f527RS, 19, Ascii.DC4})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f519CR, Ascii.f529SO})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.f528SI, 16, 17, Ascii.DC2, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, Ascii.f532VT, Ascii.f521FF, 1, 2}))});
    }
