...
public final class InetAddresses {
    ...
    private static final Splitter IPV4_SPLITTER = Splitter.m108on('.').limit(4);
    private static final int IPV6_PART_COUNT = 8;
    private static final Splitter IPV6_SPLITTER = Splitter.m108on(':').limit(10);
    ...
    private static byte parseOctet(String str) {
        ...
        if (parseInt <= 255 && (!str.startsWith(BuildConfig.BUILD_NUMBER) || str.length() <= 1)) {
