...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    /* renamed from: C1 */
    private static final int f568C1 = -862048943;

    /* renamed from: C2 */
    private static final int f569C2 = 461845907;
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i, long j) {
            long j2 = this.buffer;
            long j3 = j & TransactionInput.NO_SEQUENCE;
            int i2 = this.shift;
            this.buffer = (j3 << i2) | j2;
            this.shift = i2 + (i * 8);
            this.length += i;
            if (this.shift >= 32) {
                this.f570h1 = Murmur3_32HashFunction.mixH1(this.f570h1, Murmur3_32HashFunction.mixK1((int) this.buffer));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            this.f570h1 ^= Murmur3_32HashFunction.mixK1((int) this.buffer);
            return Murmur3_32HashFunction.fmix(this.f570h1, this.length);
        }
    }

    /* access modifiers changed from: private */
    public static long charToThreeUtf8Bytes(char c) {
        return (long) ((((c & '?') | 128) << 16) | (((c >>> 12) | C239114.DENSITY_XXHIGH) & 255) | ((((c >>> 6) & 63) | 128) << 8));
    }
    ...
    public static int mixK1(int i) {
        return Integer.rotateLeft(i * f568C1, 15) * f569C2;
    }
