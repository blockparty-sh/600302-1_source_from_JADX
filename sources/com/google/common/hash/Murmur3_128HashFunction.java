...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f564C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f565C2 = 5545529020109919103L;
        ...
        private void bmix64(long j, long j2) {
            this.f566h1 = mixK1(j) ^ this.f566h1;
            this.f566h1 = Long.rotateLeft(this.f566h1, 27);
            long j3 = this.f566h1;
            long j4 = this.f567h2;
            this.f566h1 = j3 + j4;
            this.f566h1 = (this.f566h1 * 5) + 1390208809;
            this.f567h2 = mixK2(j2) ^ j4;
            this.f567h2 = Long.rotateLeft(this.f567h2, 31);
            this.f567h2 += this.f566h1;
            this.f567h2 = (this.f567h2 * 5) + 944331445;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00f6, code lost:
            r11.f566h1 = mixK1(r2) ^ r11.f566h1;
            r11.f567h2 = mixK2(r0) ^ r11.f567h2;
         */
        ...
        public HashCode makeHash() {
            ...
            long j4 = this.f566h1;
            this.f567h2 = j3 + j4;
            this.f566h1 = fmix64(j4);
            this.f567h2 = fmix64(this.f567h2);
            long j5 = this.f566h1;
            long j6 = this.f567h2;
            this.f566h1 = j5 + j6;
            this.f567h2 = j6 + this.f566h1;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f566h1).putLong(this.f567h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f564C1, 31) * f565C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f565C2, 33) * f564C1;
        }
    }
