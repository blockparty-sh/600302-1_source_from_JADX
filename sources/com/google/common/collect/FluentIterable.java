...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return (Iterable) this.iterableDelegate.mo25234or(this);
    }
    ...
    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m116of() {
        return from((Iterable<E>) ImmutableList.m126of());
    }

    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m117of(@NullableDecl E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m97of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m97of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m97of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m97of(next);
    }
