...
public final class Collections2 {
    ...
    private static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        PermutationIterator(List<E> list2) {
            ...
            int size = list2.size();
            this.f553c = new int[size];
            this.f555o = new int[size];
            Arrays.fill(this.f553c, 0);
            Arrays.fill(this.f555o, 1);
        }
        ...
        /* access modifiers changed from: 0000 */
        public void calculateNextPermutation() {
            this.f554j = this.list.size() - 1;
            if (this.f554j != -1) {
                int i = 0;
                while (true) {
                    int[] iArr = this.f553c;
                    int i2 = this.f554j;
                    int i3 = iArr[i2] + this.f555o[i2];
                    if (i3 >= 0) {
                        if (i3 != i2 + 1) {
                            Collections.swap(this.list, (i2 - iArr[i2]) + i, (i2 - i3) + i);
                            this.f553c[this.f554j] = i3;
                            break;
                        } else if (i2 == 0) {
                            break;
                        } else {
