...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    private static final class Any extends NamedFastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo25267or(CharMatcher charMatcher) {
    ...
    private static final class C1583Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo25267or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo25267or(charMatcher);
        }
    ...
    private static final class C1584Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C1584Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    /* renamed from: is */
    public static CharMatcher m89is(char c) {
        return new C1583Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m89is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo25267or(CharMatcher charMatcher) {
        return new C1584Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m89is((char) bitSet.nextSetBit(0));
        }
        if (i != 2) {
