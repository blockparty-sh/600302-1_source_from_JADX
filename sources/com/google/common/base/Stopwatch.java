...
public final class Stopwatch {
    ...
    static /* synthetic */ class C16101 {
        ...
        static {
            ...
            L_0x0056:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.base.Stopwatch.C16101.<clinit>():void");
        }
    }
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (C16101.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
            case 3:
                return "ms";
            case 4:
                return BuildConfig.LEANPLUM_PACKAGE_IDENTIFIER;
            case 5:
                return "min";
            case 6:
                return "h";
