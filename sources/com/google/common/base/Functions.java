...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f533f;

        /* renamed from: g */
        private final Function<B, C> f534g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f534g = (Function) Preconditions.checkNotNull(function);
            this.f533f = (Function) Preconditions.checkNotNull(function2);
        }

        public C apply(@NullableDecl A a) {
            return this.f534g.apply(this.f533f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f533f.equals(functionComposition.f533f) || !this.f534g.equals(functionComposition.f534g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f533f.hashCode() ^ this.f534g.hashCode();
        }
