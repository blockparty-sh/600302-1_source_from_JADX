...
public enum CaseFormat {
    LOWER_HYPHEN(CharMatcher.m89is('-'), HelpFormatter.DEFAULT_OPT_PREFIX) {
    ...
    LOWER_UNDERSCORE(CharMatcher.m89is('_'), r4) {
        /* access modifiers changed from: 0000 */
        public String normalizeWord(String str) {
            return Ascii.toLowerCase(str);
        }
    ...
    LOWER_CAMEL(CharMatcher.inRange('A', Matrix.MATRIX_TYPE_ZERO), r8) {
        /* access modifiers changed from: 0000 */
        public String normalizeWord(String str) {
            return CaseFormat.firstCharOnlyToUpper(str);
        }
    },
    UPPER_CAMEL(CharMatcher.inRange('A', Matrix.MATRIX_TYPE_ZERO), r8) {
        /* access modifiers changed from: 0000 */
        public String normalizeWord(String str) {
            return CaseFormat.firstCharOnlyToUpper(str);
        }
    },
    UPPER_UNDERSCORE(CharMatcher.m89is('_'), r4) {
        /* access modifiers changed from: 0000 */
        public String normalizeWord(String str) {
            return Ascii.toUpperCase(str);
        }
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doForward(String str) {
            return this.sourceFormat.mo25246to(this.targetFormat, str);
        }

        /* access modifiers changed from: protected */
        public String doBackward(String str) {
            return this.targetFormat.mo25246to(this.sourceFormat, str);
        }
    ...
    /* renamed from: to */
    public final String mo25246to(CaseFormat caseFormat, String str) {
