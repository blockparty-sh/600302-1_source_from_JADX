...
public final class Predicates {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f535f;

        /* renamed from: p */
        final Predicate<B> f536p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f536p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f535f = (Function) Preconditions.checkNotNull(function);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f536p.apply(this.f535f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f535f.equals(compositionPredicate.f535f) || !this.f536p.equals(compositionPredicate.f536p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f535f.hashCode() ^ this.f536p.hashCode();
        }
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m103or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m104or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy((T[]) predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m102or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m101in(Collection<? extends T> collection) {
