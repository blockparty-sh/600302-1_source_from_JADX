...
public class PolystarShape implements ContentModel {
    ...
    public enum C0868Type {
        STAR(1),
        POLYGON(2);
        
        private final int value;

        private C0868Type(int i) {
            this.value = i;
        }

        public static C0868Type forValue(int i) {
            C0868Type[] values;
            for (C0868Type type : values()) {
                if (type.value == i) {
                    return type;
                }
            }
    ...
    public PolystarShape(String str, C0868Type type2, AnimatableFloatValue animatableFloatValue, AnimatableValue<PointF, PointF> animatableValue, AnimatableFloatValue animatableFloatValue2, AnimatableFloatValue animatableFloatValue3, AnimatableFloatValue animatableFloatValue4, AnimatableFloatValue animatableFloatValue5, AnimatableFloatValue animatableFloatValue6, boolean z) {
        this.name = str;
        this.type = type2;
