...
public class DocumentData {
    ...
    public DocumentData(String str, String str2, double d, Justification justification2, int i, double d2, double d3, @ColorInt int i2, @ColorInt int i3, double d4, boolean z) {
        this.text = str;
        this.fontName = str2;
        this.size = d;
