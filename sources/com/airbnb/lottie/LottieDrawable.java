...
public class LottieDrawable extends Drawable implements Callback, Animatable {
    ...
    public void setColorFilter(@Nullable ColorFilter colorFilter) {
        Log.w(C0824L.TAG, "Use addColorFilter instead.");
    }
    ...
    public void setMaxProgress(@FloatRange(from = 0.0d, mo626to = 1.0d) final float f) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() {
                public void run(LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxProgress(@FloatRange(from = 0.0d, mo626to = 1.0d) final float f, @FloatRange(from = 0.0d, mo626to = 1.0d) final float f2) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() {
                public void run(LottieComposition lottieComposition) {
    ...
    public void setProgress(@FloatRange(from = 0.0d, mo626to = 1.0d) final float f) {
        LottieComposition lottieComposition = this.composition;
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() {
                public void run(LottieComposition lottieComposition) {
    ...
    public List<KeyPath> resolveKeyPath(KeyPath keyPath) {
        if (this.compositionLayer == null) {
            Log.w(C0824L.TAG, "Cannot resolve KeyPath. Composition is not set yet.");
    ...
    public Bitmap updateBitmap(String str, @Nullable Bitmap bitmap) {
        ...
        if (imageAssetManager2 == null) {
            Log.w(C0824L.TAG, "Cannot update bitmap. Most likely the drawable is not added to a View which prevents Lottie from getting a Context.");
            return null;
        }
