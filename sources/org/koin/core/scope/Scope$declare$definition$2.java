...
public final class Scope$declare$definition$2 extends Lambda implements Function2<Scope, DefinitionParameters, T> {
    ...
    public final T invoke(@NotNull Scope scope, @NotNull DefinitionParameters definitionParameters) {
        Intrinsics.checkParameterIsNotNull(scope, "$this$createScoped");
