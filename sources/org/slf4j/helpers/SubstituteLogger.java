...
public class SubstituteLogger implements Logger {
    ...
    public SubstituteLogger(String str, Queue<SubstituteLoggingEvent> queue) {
        this.name = str;
    ...
    public boolean equals(Object obj) {
        ...
        return this.name.equals(((SubstituteLogger) obj).name);
    }
    ...
    public Logger delegate() {
        return this._delegate != null ? this._delegate : getEventRecordingLogger();
    }
    ...
    public boolean isDelegateEventAware() {
        ...
        try {
            this.logMethodCache = this._delegate.getClass().getMethod(Methods.LOG, new Class[]{LoggingEvent.class});
