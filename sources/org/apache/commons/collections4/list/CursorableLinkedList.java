...
public class CursorableLinkedList<E> extends AbstractLinkedList<E> implements Serializable {
    ...
    public static class Cursor<E> extends LinkedListIterator<E> {
        ...
        public void nodeChanged(Node<E> node) {
        }
        ...
        public int nextIndex() {
            if (!this.nextIndexValid) {
                if (this.next == this.parent.header) {
                    ...
                    int i = 0;
                    for (Node<E> node = this.parent.header.next; node != this.next; node = node.next) {
                        i++;
                    }
                    this.nextIndex = i;
                }
        ...
        /* access modifiers changed from: protected */
        public void nodeRemoved(Node<E> node) {
        ...
        /* access modifiers changed from: protected */
        public void nodeInserted(Node<E> node) {
    ...
    protected static class SubCursor<E> extends Cursor<E> {
        ...
        protected SubCursor(LinkedSubList<E> linkedSubList, int i) {
    ...
    public void unregisterCursor(Cursor<E> cursor) {
        ...
        while (it.hasNext()) {
            ...
            Cursor<E> cursor2 = (Cursor) weakReference.get();
            if (cursor2 == null) {
                it.remove();
    ...
    /* access modifiers changed from: protected */
    public void broadcastNodeChanged(Node<E> node) {
        Iterator it = this.cursors.iterator();
        while (it.hasNext()) {
    ...
    /* access modifiers changed from: protected */
    public void broadcastNodeRemoved(Node<E> node) {
        Iterator it = this.cursors.iterator();
        while (it.hasNext()) {
            Cursor cursor = (Cursor) ((WeakReference) it.next()).get();
            if (cursor == null) {
    ...
    /* access modifiers changed from: protected */
    public void broadcastNodeInserted(Node<E> node) {
        Iterator it = this.cursors.iterator();
        while (it.hasNext()) {
            Cursor cursor = (Cursor) ((WeakReference) it.next()).get();
            if (cursor == null) {
