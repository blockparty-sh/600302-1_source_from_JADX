...
public abstract class AbstractLinkedList<E> implements List<E> {
    ...
    protected static class LinkedSubList<E> extends AbstractList<E> {
        ...
        public void rangeCheck(int i, int i2) {
            if (i < 0 || i >= i2) {
                ...
                sb.append("Index '");
                sb.append(i);
                sb.append("' out of bounds for size '");
                sb.append(this.size);
                sb.append("'");
                throw new IndexOutOfBoundsException(sb.toString());
            }
    ...
    public Node<E> getNode(int i, boolean z) throws IndexOutOfBoundsException {
        String str = "Couldn't get the node: index (";
        if (i < 0) {
            StringBuilder sb = new StringBuilder();
            sb.append(str);
            sb.append(i);
            sb.append(") less than zero.");
            throw new IndexOutOfBoundsException(sb.toString());
            ...
            if (i > i2) {
                ...
                sb2.append(str);
                sb2.append(i);
                sb2.append(") greater than the size of the list (");
            ...
            sb3.append(str);
            sb3.append(i);
            sb3.append(") is the size of the list.");
