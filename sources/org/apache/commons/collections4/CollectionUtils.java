...
public class CollectionUtils {
    ...
    private static class SetOperationCardinalityHelper<O> extends CardinalityHelper<O> implements Iterable<O> {
        private final Set<O> elements = new HashSet();
        private final List<O> newList;

        public SetOperationCardinalityHelper(Iterable<? extends O> iterable, Iterable<? extends O> iterable2) {
            super(iterable, iterable2);
            CollectionUtils.addAll((Collection<C>) this.elements, iterable);
            CollectionUtils.addAll((Collection<C>) this.elements, iterable2);
    ...
    public static boolean isEqualCollection(Collection<?> collection, Collection<?> collection2) {
        ...
        for (Object next : cardinalityHelper.cardinalityA.keySet()) {
            if (cardinalityHelper.freqA(next) != cardinalityHelper.freqB(next)) {
                return false;
            }
        }
    ...
    public static <E> boolean isEqualCollection(Collection<? extends E> collection, Collection<? extends E> collection2, final Equator<? super E> equator) {
        if (equator == null) {
            ...
            C33271 r0 = new Transformer() {
                public EquatorWrapper<?> transform(Object obj) {
                    return new EquatorWrapper<>(equator, obj);
                }
            };
            return isEqualCollection(collect((Iterable<I>) collection, (Transformer<? super I, ? extends O>) r0), collect((Iterable<I>) collection2, (Transformer<? super I, ? extends O>) r0));
        }
    }
    ...
    public static <C> void transform(Collection<C> collection, Transformer<? super C, ? extends C> transformer) {
        if (collection != null && transformer != null) {
            ...
            Collection collect = collect((Iterable<I>) collection, transformer);
            collection.clear();
    ...
    public static <I, O> Collection<O> collect(Iterable<I> iterable, Transformer<? super I, ? extends O> transformer) {
        return collect(iterable, transformer, (R) iterable instanceof Collection ? new ArrayList(((Collection) iterable).size()) : new ArrayList());
    }

    public static <I, O> Collection<O> collect(Iterator<I> it, Transformer<? super I, ? extends O> transformer) {
        return collect(it, transformer, (R) new ArrayList());
    }
    ...
    static void checkIndexBounds(int i) {
        if (i < 0) {
            ...
            sb.append("Index cannot be negative: ");
            sb.append(i);
        ...
        if (i < 0) {
            ...
            if (obj != null) {
                try {
                    ...
                    sb2.append("Unsupported object type: ");
    ...
    public static <K, V> Entry<K, V> get(Map<K, V> map, int i) {
        checkIndexBounds(i);
        return (Entry) get((Iterable<T>) map.entrySet(), i);
    }
    ...
    public static int size(Object obj) {
        ...
        if (obj instanceof Map) {
            ...
            try {
                ...
                StringBuilder sb = new StringBuilder();
                sb.append("Unsupported object type: ");
    ...
    public static <E> Collection<E> retainAll(Iterable<E> iterable, Iterable<? extends E> iterable2, final Equator<? super E> equator) {
        Set set = (Set) collect(iterable2, (Transformer<? super I, ? extends O>) new Transformer<E, EquatorWrapper<E>>() {
