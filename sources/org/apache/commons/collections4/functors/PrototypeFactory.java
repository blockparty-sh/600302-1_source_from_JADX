...
public class PrototypeFactory {
    ...
    static class PrototypeSerializationFactory<T extends Serializable> implements Factory<T> {
        ...
        /* JADX WARNING: Can't wrap try/catch for region: R(6:11|12|(2:26|27)|28|29|30) */
        /* JADX WARNING: Can't wrap try/catch for region: R(9:1|2|3|4|5|6|7|8|9) */
        /* JADX WARNING: Failed to process nested try/catch */
        /* JADX WARNING: Missing exception handler attribute for start block: B:28:0x0051 */
        ...
        public T create() {
            /*
                ...
                r0.<init>(r1)
                r1 = 0
                java.io.ObjectOutputStream r2 = new java.io.ObjectOutputStream     // Catch:{ ClassNotFoundException -> 0x0045, IOException -> 0x003e }
                r2.<init>(r0)     // Catch:{ ClassNotFoundException -> 0x0045, IOException -> 0x003e }
                T r3 = r5.iPrototype     // Catch:{ ClassNotFoundException -> 0x0045, IOException -> 0x003e }
                r2.writeObject(r3)     // Catch:{ ClassNotFoundException -> 0x0045, IOException -> 0x003e }
                java.io.ByteArrayInputStream r2 = new java.io.ByteArrayInputStream     // Catch:{ ClassNotFoundException -> 0x0045, IOException -> 0x003e }
                byte[] r3 = r0.toByteArray()     // Catch:{ ClassNotFoundException -> 0x0045, IOException -> 0x003e }
                r2.<init>(r3)     // Catch:{ ClassNotFoundException -> 0x0045, IOException -> 0x003e }
                java.io.ObjectInputStream r1 = new java.io.ObjectInputStream     // Catch:{ ClassNotFoundException -> 0x0037, IOException -> 0x0032, all -> 0x002d }
                r1.<init>(r2)     // Catch:{ ClassNotFoundException -> 0x0037, IOException -> 0x0032, all -> 0x002d }
                java.lang.Object r1 = r1.readObject()     // Catch:{ ClassNotFoundException -> 0x0037, IOException -> 0x0032, all -> 0x002d }
                java.io.Serializable r1 = (java.io.Serializable) r1     // Catch:{ ClassNotFoundException -> 0x0037, IOException -> 0x0032, all -> 0x002d }
            ...
            L_0x003e:
                r2 = move-exception
            L_0x003f:
                org.apache.commons.collections4.FunctorException r3 = new org.apache.commons.collections4.FunctorException     // Catch:{ all -> 0x003c }
                r3.<init>(r2)     // Catch:{ all -> 0x003c }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0045, code lost:
        if ((r7 instanceof java.io.Serializable) != false) goto L_0x0047;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x004e, code lost:
        return new org.apache.commons.collections4.functors.PrototypeFactory.PrototypeSerializationFactory((java.io.Serializable) r7, null);
     */
    ...
    public static <T> org.apache.commons.collections4.Factory<T> prototypeFactory(T r7) {
        ...
        L_0x0008:
            ...
            java.lang.reflect.Method r1 = r1.getMethod(r2, r3)     // Catch:{ NoSuchMethodException -> 0x001b }
