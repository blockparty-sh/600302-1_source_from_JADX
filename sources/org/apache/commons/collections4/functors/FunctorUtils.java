        ...
        if (predicateArr != null) {
            ...
            while (i < predicateArr.length) {
                if (predicateArr[i] != null) {
                    ...
                    sb.append("The predicate array must not contain a null predicate, index ");
                    sb.append(i);
                    sb.append(" was null");
        ...
        if (collection != null) {
            ...
            for (Predicate<? super T> predicate : collection) {
                ...
                if (predicateArr[i] != null) {
                    ...
                    StringBuilder sb = new StringBuilder();
                    sb.append("The predicate collection must not contain a null predicate, index ");
                    sb.append(i);
                    sb.append(" was null");
                    throw new NullPointerException(sb.toString());
                }
        ...
        if (closureArr != null) {
            ...
            while (i < closureArr.length) {
                if (closureArr[i] != null) {
                    ...
                    StringBuilder sb = new StringBuilder();
                    sb.append("The closure array must not contain a null closure, index ");
                    sb.append(i);
                    sb.append(" was null");
                    throw new NullPointerException(sb.toString());
                }
        ...
        if (transformerArr != null) {
            ...
            while (i < transformerArr.length) {
                if (transformerArr[i] != null) {
                    ...
                    StringBuilder sb = new StringBuilder();
                    sb.append("The transformer array must not contain a null transformer, index ");
                    sb.append(i);
                    sb.append(" was null");
                    throw new NullPointerException(sb.toString());
                }
