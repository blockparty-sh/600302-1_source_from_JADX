...
public class MultiKeyMap<K, V> extends AbstractMapDecorator<MultiKey<? extends K>, V> implements Serializable, Cloneable {
    ...
    public V get(Object obj, Object obj2) {
        ...
        for (HashEntry<K, V> hashEntry = decorated().data[decorated().hashIndex(hash, decorated().data.length)]; hashEntry != null; hashEntry = hashEntry.next) {
    ...
    public V put(K k, K k2, V v) {
        ...
        HashEntry<K, V> hashEntry = decorated().data[hashIndex];
    ...
    /* access modifiers changed from: protected */
    public boolean isEqualKey(HashEntry<MultiKey<? extends K>, V> hashEntry, Object obj, Object obj2) {
        MultiKey multiKey = (MultiKey) hashEntry.getKey();
        if (multiKey.size() == 2 && (obj == multiKey.getKey(0) || (obj != null && obj.equals(multiKey.getKey(0))))) {
            if (obj2 == multiKey.getKey(1)) {
                return true;
            }
            if (obj2 != null && obj2.equals(multiKey.getKey(1))) {
                return true;
            }
        }
        return false;
    ...
    /* access modifiers changed from: protected */
    public boolean isEqualKey(HashEntry<MultiKey<? extends K>, V> hashEntry, Object obj, Object obj2, Object obj3) {
        MultiKey multiKey = (MultiKey) hashEntry.getKey();
        if (multiKey.size() == 3 && ((obj == multiKey.getKey(0) || (obj != null && obj.equals(multiKey.getKey(0)))) && (obj2 == multiKey.getKey(1) || (obj2 != null && obj2.equals(multiKey.getKey(1)))))) {
            if (obj3 == multiKey.getKey(2)) {
                return true;
            }
            if (obj3 != null && obj3.equals(multiKey.getKey(2))) {
                return true;
            }
        }
        return false;
    ...
    /* access modifiers changed from: protected */
    public boolean isEqualKey(HashEntry<MultiKey<? extends K>, V> hashEntry, Object obj, Object obj2, Object obj3, Object obj4) {
        MultiKey multiKey = (MultiKey) hashEntry.getKey();
        if (multiKey.size() == 4 && ((obj == multiKey.getKey(0) || (obj != null && obj.equals(multiKey.getKey(0)))) && ((obj2 == multiKey.getKey(1) || (obj2 != null && obj2.equals(multiKey.getKey(1)))) && (obj3 == multiKey.getKey(2) || (obj3 != null && obj3.equals(multiKey.getKey(2))))))) {
            if (obj4 == multiKey.getKey(3)) {
                return true;
            }
            if (obj4 != null && obj4.equals(multiKey.getKey(3))) {
                return true;
            }
        }
        return false;
    ...
    public V put(K k, K k2, K k3, K k4, K k5, V v) {
        ...
        AbstractHashedMap decorated = decorated();
        MultiKey multiKey = new MultiKey(k, k2, k3, k4, k5);
        decorated.addMapping(hashIndex, hash, multiKey, v2);
        return null;
    }
    ...
    /* access modifiers changed from: protected */
    public boolean isEqualKey(HashEntry<MultiKey<? extends K>, V> hashEntry, Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        MultiKey multiKey = (MultiKey) hashEntry.getKey();
        if (multiKey.size() == 5 && ((obj == multiKey.getKey(0) || (obj != null && obj.equals(multiKey.getKey(0)))) && ((obj2 == multiKey.getKey(1) || (obj2 != null && obj2.equals(multiKey.getKey(1)))) && ((obj3 == multiKey.getKey(2) || (obj3 != null && obj3.equals(multiKey.getKey(2)))) && (obj4 == multiKey.getKey(3) || (obj4 != null && obj4.equals(multiKey.getKey(3)))))))) {
            if (obj5 == multiKey.getKey(4)) {
                return true;
            }
            if (obj5 != null && obj5.equals(multiKey.getKey(4))) {
                return true;
            }
        }
        return false;
