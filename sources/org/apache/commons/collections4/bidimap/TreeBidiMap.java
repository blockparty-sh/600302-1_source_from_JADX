...
public class TreeBidiMap<K extends Comparable<K>, V extends Comparable<V>> implements OrderedBidiMap<K, V>, Serializable {
    ...
    /* renamed from: org.apache.commons.collections4.bidimap.TreeBidiMap$1 */
    static /* synthetic */ class C33551 {

        /* renamed from: $SwitchMap$org$apache$commons$collections4$bidimap$TreeBidiMap$DataElement */
        static final /* synthetic */ int[] f785x1c87639 = new int[DataElement.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f785x1c87639 = r0
                int[] r0 = f785x1c87639     // Catch:{ NoSuchFieldError -> 0x0014 }
                org.apache.commons.collections4.bidimap.TreeBidiMap$DataElement r1 = org.apache.commons.collections4.bidimap.TreeBidiMap.DataElement.KEY     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = f785x1c87639     // Catch:{ NoSuchFieldError -> 0x001f }
                org.apache.commons.collections4.bidimap.TreeBidiMap$DataElement r1 = org.apache.commons.collections4.bidimap.TreeBidiMap.DataElement.VALUE     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.collections4.bidimap.TreeBidiMap.C33551.<clinit>():void");
        }
    }
    ...
    class Inverse implements OrderedBidiMap<V, K> {
        ...
        public void putAll(Map<? extends V, ? extends K> map) {
            for (Entry entry : map.entrySet()) {
                put((V) (Comparable) entry.getKey(), (K) (Comparable) entry.getValue());
            }
        }
    ...
    class InverseViewMapEntryIterator extends ViewIterator implements OrderedIterator<Entry<V, K>> {
        ...
        private Entry<V, K> createEntry(Node<K, V> node) {
    ...
    static class Node<K extends Comparable<K>, V extends Comparable<V>> implements Entry<K, V>, KeyValue<K, V> {
        ...
        public Object getData(DataElement dataElement) {
            int i = C33551.f785x1c87639[dataElement.ordinal()];
            if (i == 1) {
                return getKey();
            }
            if (i == 2) {
    ...
    public void putAll(Map<? extends K, ? extends V> map) {
        for (Entry entry : map.entrySet()) {
            put((K) (Comparable) entry.getKey(), (V) (Comparable) entry.getValue());
        }
    }
    ...
    public void doRedBlackDelete(Node<K, V> node) {
        ...
        for (int i = 0; i < length; i++) {
            DataElement dataElement = values[i];
    ...
    private void insertValue(Node<K, V> node) throws IllegalArgumentException {
        ...
        while (true) {
            ...
            if (compare == 0) {
                ...
                sb.append(node.getData(DataElement.VALUE));
                sb.append("\") in this Map");
                throw new IllegalArgumentException(sb.toString());
            } else if (compare < 0) {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        for (int i = 0; i < readInt; i++) {
            put((K) (Comparable) objectInputStream.readObject(), (V) (Comparable) objectInputStream.readObject());
        }
    }
