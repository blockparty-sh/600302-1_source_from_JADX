...
public abstract class Pack {
    ...
    public static long bigEndianToLong(byte[] bArr, int i) {
        ...
        return (((long) bigEndianToInt(bArr, i + 4)) & TransactionInput.NO_SEQUENCE) | ((((long) bigEndianToInt) & TransactionInput.NO_SEQUENCE) << 32);
    }
    ...
    public static void longToBigEndian(long j, byte[] bArr, int i) {
        ...
        intToBigEndian((int) (j & TransactionInput.NO_SEQUENCE), bArr, i + 4);
    }
    ...
    public static long littleEndianToLong(byte[] bArr, int i) {
        return ((((long) littleEndianToInt(bArr, i + 4)) & TransactionInput.NO_SEQUENCE) << 32) | (((long) littleEndianToInt(bArr, i)) & TransactionInput.NO_SEQUENCE);
    }
    ...
    public static void longToLittleEndian(long j, byte[] bArr, int i) {
        intToLittleEndian((int) (TransactionInput.NO_SEQUENCE & j), bArr, i);
