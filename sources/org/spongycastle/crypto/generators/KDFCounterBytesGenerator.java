...
public class KDFCounterBytesGenerator implements MacDerivationFunction {
    ...
    /* renamed from: k */
    private byte[] f1189k = new byte[this.f1188h];
    private int maxSizeExcl;
    private final Mac prf;

    public KDFCounterBytesGenerator(Mac mac) {
        this.prf = mac;
        this.f1188h = mac.getMacSize();
    }
    ...
    public void init(DerivationParameters derivationParameters) {
        if (derivationParameters instanceof KDFCounterParameters) {
            ...
            BigInteger multiply = TWO.pow(r).multiply(BigInteger.valueOf((long) this.f1188h));
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f1189k, i7, bArr, i, min);
        ...
        while (true) {
            ...
            generateNext();
            min = Math.min(this.f1188h, i8);
            System.arraycopy(this.f1189k, 0, bArr, i, min);
            this.generatedBytes += min;
            i8 -= min;
        }
    }
    ...
    private void generateNext() {
        int i = (this.generatedBytes / this.f1188h) + 1;
        byte[] bArr = this.ios;
        ...
        this.prf.doFinal(this.f1189k, 0);
    }
}
