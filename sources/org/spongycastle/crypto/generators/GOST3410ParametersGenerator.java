...
public class GOST3410ParametersGenerator {
    ...
    private int procedure_A(int i, int i2, BigInteger[] bigIntegerArr, int i3) {
        ...
        while (i12 < i9) {
            ...
            while (true) {
                ...
                BigInteger bigInteger6 = new BigInteger(BuildConfig.BUILD_NUMBER);
    ...
    private void procedure_B(int i, int i2, BigInteger[] bigIntegerArr) {
        ...
        while (true) {
            ...
            BigInteger bigInteger5 = new BigInteger(BuildConfig.BUILD_NUMBER);
    ...
    public GOST3410Parameters generateParameters() {
        ...
        String str = "Ooops! key size 512 or 1024 bit.";
        if (this.typeproc == 1) {
