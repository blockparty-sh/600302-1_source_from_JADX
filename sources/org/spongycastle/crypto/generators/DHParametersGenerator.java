...
public class DHParametersGenerator {
    ...
    public DHParameters generateParameters() {
        ...
        DHParameters dHParameters = new DHParameters(bigInteger, DHParametersHelper.selectGenerator(bigInteger, bigInteger2, this.random), bigInteger2, TWO, (DHValidationParameters) null);
        return dHParameters;
    }
}
