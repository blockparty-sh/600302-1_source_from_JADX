...
public class ThreefishEngine implements BlockCipher {
    ...
    /* renamed from: kw */
    private long[] f1175kw;

    /* renamed from: t */
    private long[] f1176t = new long[5];
    ...
    private static final class Threefish256Cipher extends ThreefishCipher {
        ...
        public void encryptBlock(long[] jArr, long[] jArr2) {
            long[] jArr3 = this.f1177kw;
            long[] jArr4 = this.f1178t;
        ...
        public void decryptBlock(long[] jArr, long[] jArr2) {
            ...
            if (jArr3.length != 9) {
                ...
                for (int i2 = 1; i >= i2; i2 = 1) {
                    ...
                    int i7 = i4 + 1;
                    int i8 = i3 + 3;
                    long j9 = j5 - (jArr3[i8] + jArr4[i4 + 2]);
                    long j10 = j6 - (jArr3[i6] + jArr4[i7]);
                    long j11 = (long) i;
                    int[] iArr = access$000;
                    int[] iArr2 = access$100;
                    long xorRotr = ThreefishEngine.xorRotr(j4 - ((jArr3[i3 + 4] + j11) + 1), 32, j8);
                    long j12 = j8 - xorRotr;
                    long xorRotr2 = ThreefishEngine.xorRotr(j10, 32, j9);
                    long j13 = j9 - xorRotr2;
                    long j14 = j12;
                    long xorRotr3 = ThreefishEngine.xorRotr(xorRotr2, 58, j14);
                    long j15 = j14 - xorRotr3;
                    long xorRotr4 = ThreefishEngine.xorRotr(xorRotr, 22, j13);
                    long j16 = j13 - xorRotr4;
                    long xorRotr5 = ThreefishEngine.xorRotr(xorRotr4, 46, j15);
                    long j17 = j15 - xorRotr5;
                    long xorRotr6 = ThreefishEngine.xorRotr(xorRotr3, 12, j16);
                    long j18 = j16 - xorRotr6;
                    long xorRotr7 = ThreefishEngine.xorRotr(xorRotr6, 25, j17);
                    long j19 = j17 - xorRotr7;
                    long xorRotr8 = ThreefishEngine.xorRotr(xorRotr5, 33, j18);
                    long j20 = j19 - jArr3[i3];
                    long j21 = xorRotr7 - (jArr3[i5] + jArr4[i4]);
                    long j22 = (j18 - xorRotr8) - (jArr3[i6] + jArr4[i7]);
                    long xorRotr9 = ThreefishEngine.xorRotr(xorRotr8 - (jArr3[i8] + j11), 5, j20);
                    long j23 = j20 - xorRotr9;
                    long xorRotr10 = ThreefishEngine.xorRotr(j21, 37, j22);
                    long j24 = j22 - xorRotr10;
                    long xorRotr11 = ThreefishEngine.xorRotr(xorRotr10, 23, j23);
                    long j25 = j23 - xorRotr11;
                    long xorRotr12 = ThreefishEngine.xorRotr(xorRotr9, 40, j24);
                    long j26 = j24 - xorRotr12;
                    long xorRotr13 = ThreefishEngine.xorRotr(xorRotr12, 52, j25);
                    long j27 = j25 - xorRotr13;
                    long xorRotr14 = ThreefishEngine.xorRotr(xorRotr11, 57, j26);
                    long j28 = j26 - xorRotr14;
                    long xorRotr15 = ThreefishEngine.xorRotr(xorRotr14, 14, j27);
                    long j29 = j27 - xorRotr15;
                    j4 = ThreefishEngine.xorRotr(xorRotr13, 16, j28);
                    j5 = j28 - j4;
                    i -= 2;
                    j6 = xorRotr15;
                    j7 = j29;
                ...
                long j30 = j6 - (jArr3[1] + jArr4[0]);
                long j31 = j5 - (jArr3[2] + jArr4[1]);
                long j32 = j4 - jArr3[3];
                jArr2[0] = j7 - jArr3[0];
                jArr2[1] = j30;
                jArr2[2] = j31;
    ...
    private static abstract class ThreefishCipher {
        ...
        /* renamed from: kw */
        protected final long[] f1177kw;

        /* renamed from: t */
        protected final long[] f1178t;
    ...
    public ThreefishEngine(int i) {
        ...
        this.f1175kw = new long[((i2 * 2) + 1)];
        if (i == 256) {
            this.cipher = new Threefish256Cipher(this.f1175kw, this.f1176t);
        } else if (i == 512) {
            this.cipher = new Threefish512Cipher(this.f1175kw, this.f1176t);
        } else if (i == 1024) {
            this.cipher = new Threefish1024Cipher(this.f1175kw, this.f1176t);
        } else {
    ...
    private void setKey(long[] jArr) {
        if (jArr.length == this.blocksizeWords) {
            ...
            while (true) {
                int i2 = this.blocksizeWords;
                if (i < i2) {
                    long[] jArr2 = this.f1175kw;
                    jArr2[i] = jArr[i];
                    j ^= jArr2[i];
                    i++;
                } else {
                    long[] jArr3 = this.f1175kw;
                    jArr3[i2] = j;
