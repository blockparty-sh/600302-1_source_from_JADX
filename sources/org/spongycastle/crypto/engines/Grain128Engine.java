...
public class Grain128Engine implements StreamCipher {
    ...
    private int getOutputNFSR() {
        int[] iArr = this.nfsr;
        return (((((((iArr[3] ^ (((iArr[0] ^ ((iArr[0] >>> 26) | (iArr[1] << 6))) ^ ((iArr[1] >>> 24) | (iArr[2] << 8))) ^ ((iArr[2] >>> 27) | (iArr[3] << 5)))) ^ (((iArr[0] >>> 3) | (iArr[1] << 29)) & ((iArr[2] >>> 3) | (iArr[3] << 29)))) ^ (((iArr[0] >>> 11) | (iArr[1] << 21)) & ((iArr[0] >>> 13) | (iArr[1] << 19)))) ^ (((iArr[0] >>> 17) | (iArr[1] << 15)) & ((iArr[0] >>> 18) | (iArr[1] << 14)))) ^ (((iArr[0] >>> 27) | (iArr[1] << 5)) & ((iArr[1] >>> 27) | (iArr[2] << 5)))) ^ (((iArr[1] >>> 8) | (iArr[2] << 24)) & ((iArr[1] >>> 16) | (iArr[2] << 16)))) ^ (((iArr[1] >>> 29) | (iArr[2] << 3)) & ((iArr[2] >>> 1) | (iArr[3] << 31)))) ^ (((iArr[2] >>> 4) | (iArr[3] << 28)) & ((iArr[2] >>> 20) | (iArr[3] << 12)));
    }
    ...
    private int getOutput() {
        ...
        int[] iArr2 = this.lfsr;
        return ((((((((((i9 & i2) & ((iArr2[2] >>> 31) | (iArr2[3] << 1))) ^ ((((((iArr2[0] >>> 13) | (iArr2[1] << 19)) & ((iArr2[0] >>> 20) | (iArr2[1] << 12))) ^ (i2 & ((iArr2[0] >>> 8) | (iArr2[1] << 24)))) ^ (i9 & ((iArr2[1] >>> 10) | (iArr2[2] << 22)))) ^ (((iArr2[1] >>> 28) | (iArr2[2] << 4)) & ((iArr2[2] >>> 15) | (iArr2[3] << 17))))) ^ ((iArr2[2] >>> 29) | (iArr2[3] << 3))) ^ i) ^ i3) ^ i4) ^ i5) ^ i6) ^ i7) ^ i8;
    }
