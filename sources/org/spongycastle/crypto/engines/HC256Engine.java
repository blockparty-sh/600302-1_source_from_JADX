...
public class HC256Engine implements StreamCipher {
    ...
    /* renamed from: p */
    private int[] f1142p = new int[1024];

    /* renamed from: q */
    private int[] f1143q = new int[1024];
    ...
    private void init() {
        ...
        if (bArr.length != 32 && bArr.length != 16) {
        ...
        } else if (this.f1141iv.length >= 16) {
            byte[] bArr2 = this.key;
            if (bArr2.length != 32) {
            ...
            byte[] bArr5 = this.f1141iv;
            if (bArr5.length < 32) {
                byte[] bArr6 = new byte[32];
                System.arraycopy(bArr5, 0, bArr6, 0, bArr5.length);
                byte[] bArr7 = this.f1141iv;
            ...
            for (int i3 = 0; i3 < 32; i3++) {
                int i4 = (i3 >> 2) + 8;
                iArr[i4] = iArr[i4] | ((this.f1141iv[i3] & 255) << ((i3 & 3) * 8));
            }
            ...
            System.arraycopy(iArr, 512, this.f1142p, 0, 1024);
            System.arraycopy(iArr, 1536, this.f1143q, 0, 1024);
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f1141iv = parametersWithIV.getIV();
            cipherParameters2 = parametersWithIV.getParameters();
        } else {
            this.f1141iv = new byte[0];
