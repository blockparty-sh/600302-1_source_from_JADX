...
public class Shacal2Engine implements BlockCipher {
        ...
        if (bArr.length != 0 && bArr.length <= 64) {
            if (bArr.length >= 16 && bArr.length % 8 == 0) {
                ...
                for (int i = 16; i < 64; i++) {
                    ...
                    int i2 = i - 2;
                    int i3 = ((iArr[i2] >>> 10) ^ (((iArr[i2] >>> 17) | (iArr[i2] << -17)) ^ ((iArr[i2] >>> 19) | (iArr[i2] << -19)))) + iArr[i - 7];
                    int i4 = i - 15;
                    iArr[i] = i3 + ((iArr[i4] >>> 3) ^ (((iArr[i4] >>> 7) | (iArr[i4] << -7)) ^ ((iArr[i4] >>> 18) | (iArr[i4] << -18)))) + iArr[i - 16];
                }
                return;
            }
        }
    ...
    public void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = 0; i3 < 64; i3++) {
            int i4 = ((((iArr[4] >>> 6) | (iArr[4] << -6)) ^ ((iArr[4] >>> 11) | (iArr[4] << -11))) ^ ((iArr[4] >>> 25) | (iArr[4] << -25))) + ((iArr[4] & iArr[5]) ^ ((~iArr[4]) & iArr[6])) + iArr[7] + f1170K[i3] + this.workingKey[i3];
            iArr[7] = iArr[6];
            iArr[6] = iArr[5];
            iArr[5] = iArr[4];
            iArr[4] = iArr[3] + i4;
    ...
    public void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = 63; i3 > -1; i3--) {
            ...
            iArr[5] = iArr[6];
            iArr[6] = iArr[7];
            iArr[7] = (((i4 - f1170K[i3]) - this.workingKey[i3]) - ((((iArr[4] >>> 6) | (iArr[4] << -6)) ^ ((iArr[4] >>> 11) | (iArr[4] << -11))) ^ ((iArr[4] >>> 25) | (iArr[4] << -25)))) - (((~iArr[4]) & iArr[6]) ^ (iArr[5] & iArr[4]));
        }
        ints2bytes(iArr, bArr2, i2);
    }
