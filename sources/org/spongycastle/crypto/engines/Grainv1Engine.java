...
public class Grainv1Engine implements StreamCipher {
    ...
    private int getOutputNFSR() {
        ...
        int i14 = i13 & i11;
        int i15 = i11 & i10;
        int i16 = ((((i ^ (((((((((i12 ^ i11) ^ i10) ^ i9) ^ i8) ^ i7) ^ i6) ^ i5) ^ i3) ^ i2)) ^ i14) ^ (i8 & i7)) ^ (i4 & i2)) ^ (i15 & i9);
        int i17 = i7 & i6 & i5;
        return (((((((((i13 & i9) & i6) & i2) ^ (i16 ^ i17)) ^ ((i15 & i8) & i7)) ^ ((i14 & i5) & i4)) ^ (((i14 & i10) & i9) & i8)) ^ ((i4 & i17) & i2)) ^ (((((i10 & i9) & i8) & i7) & i6) & i5)) & 65535;
    }

    private int getOutputLFSR() {
        int[] iArr = this.lfsr;
        return (((iArr[4] << 2) | (iArr[3] >>> 14)) ^ ((((((iArr[0] >>> 13) | (iArr[1] << 3)) ^ iArr[0]) ^ ((iArr[1] >>> 7) | (iArr[2] << 9))) ^ ((iArr[2] >>> 6) | (iArr[3] << 10))) ^ ((iArr[3] >>> 3) | (iArr[4] << 13)))) & 65535;
    }
