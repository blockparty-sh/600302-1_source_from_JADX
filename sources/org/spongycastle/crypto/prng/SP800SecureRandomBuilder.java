...
public class SP800SecureRandomBuilder {
    ...
    private static class CTRDRBGProvider implements DRBGProvider {
        ...
        public SP80090DRBG get(EntropySource entropySource) {
            CTRSP800DRBG ctrsp800drbg = new CTRSP800DRBG(this.blockCipher, this.keySizeInBits, this.securityStrength, entropySource, this.personalizationString, this.nonce);
            return ctrsp800drbg;
        }
    }
    ...
    private static class ConfigurableDualECDRBGProvider implements DRBGProvider {
        ...
        public SP80090DRBG get(EntropySource entropySource) {
            DualECSP800DRBG dualECSP800DRBG = new DualECSP800DRBG(this.pointSet, this.digest, this.securityStrength, entropySource, this.personalizationString, this.nonce);
    ...
    private static class DualECDRBGProvider implements DRBGProvider {
        ...
        public SP80090DRBG get(EntropySource entropySource) {
            DualECSP800DRBG dualECSP800DRBG = new DualECSP800DRBG(this.digest, this.securityStrength, entropySource, this.personalizationString, this.nonce);
            return dualECSP800DRBG;
        }
    }
    ...
    private static class HMacDRBGProvider implements DRBGProvider {
        ...
        public SP80090DRBG get(EntropySource entropySource) {
            HMacSP800DRBG hMacSP800DRBG = new HMacSP800DRBG(this.hMac, this.securityStrength, entropySource, this.personalizationString, this.nonce);
    ...
    private static class HashDRBGProvider implements DRBGProvider {
        ...
        public SP80090DRBG get(EntropySource entropySource) {
            HashSP800DRBG hashSP800DRBG = new HashSP800DRBG(this.digest, this.securityStrength, entropySource, this.personalizationString, this.nonce);
    ...
    public SP800SecureRandom buildCTR(BlockCipher blockCipher, int i, byte[] bArr, boolean z) {
        ...
        CTRDRBGProvider cTRDRBGProvider = new CTRDRBGProvider(blockCipher, i, bArr, this.personalizationString, this.securityStrength);
    ...
    public SP800SecureRandom buildDualEC(DualECPoints[] dualECPointsArr, Digest digest, byte[] bArr, boolean z) {
        SecureRandom secureRandom = this.random;
        EntropySource entropySource = this.entropySourceProvider.get(this.entropyBitsRequired);
        ConfigurableDualECDRBGProvider configurableDualECDRBGProvider = new ConfigurableDualECDRBGProvider(dualECPointsArr, digest, bArr, this.personalizationString, this.securityStrength);
