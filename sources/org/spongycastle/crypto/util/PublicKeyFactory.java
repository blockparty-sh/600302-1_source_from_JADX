...
public class PublicKeyFactory {
    ...
    /* JADX WARNING: type inference failed for: r3v3, types: [org.spongycastle.crypto.params.DSAParameters] */
    /* JADX WARNING: type inference failed for: r3v4, types: [org.spongycastle.crypto.params.DSAParameters] */
    /* JADX WARNING: type inference failed for: r7v0, types: [org.spongycastle.crypto.params.ECDomainParameters] */
    ...
    /* JADX WARNING: type inference failed for: r9v0, types: [org.spongycastle.crypto.params.DHValidationParameters] */
    ...
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r3v2
      assigns: [?[int, float, boolean, short, byte, char, OBJECT, ARRAY], org.spongycastle.crypto.params.DHValidationParameters, org.spongycastle.crypto.params.DSAParameters]
      uses: [org.spongycastle.crypto.params.DSAParameters, ?[OBJECT, ARRAY]]
      mth insns count: 146
    ...
    public static org.spongycastle.crypto.params.AsymmetricKeyParameter createKey(org.spongycastle.asn1.x509.SubjectPublicKeyInfo r10) throws java.io.IOException {
        ...
        L_0x001f:
            org.spongycastle.asn1.ASN1ObjectIdentifier r1 = r0.getAlgorithm()
            org.spongycastle.asn1.ASN1ObjectIdentifier r3 = org.spongycastle.asn1.p022x9.X9ObjectIdentifiers.dhpublicnumber
            boolean r1 = r1.equals(r3)
            r3 = 0
            if (r1 == 0) goto L_0x0099
            org.spongycastle.asn1.ASN1Primitive r10 = r10.parsePublicKey()
            org.spongycastle.asn1.x9.DHPublicKey r10 = org.spongycastle.asn1.p022x9.DHPublicKey.getInstance(r10)
            ...
            org.spongycastle.asn1.x9.DHDomainParameters r0 = org.spongycastle.asn1.p022x9.DHDomainParameters.getInstance(r0)
        ...
        L_0x0106:
            org.spongycastle.asn1.ASN1ObjectIdentifier r1 = r0.getAlgorithm()
            org.spongycastle.asn1.ASN1ObjectIdentifier r2 = org.spongycastle.asn1.p022x9.X9ObjectIdentifiers.id_dsa
            boolean r1 = r1.equals(r2)
        ...
        L_0x0120:
            org.spongycastle.asn1.ASN1ObjectIdentifier r1 = r0.getAlgorithm()
            org.spongycastle.asn1.ASN1ObjectIdentifier r2 = org.spongycastle.asn1.p022x9.X9ObjectIdentifiers.id_ecPublicKey
            boolean r1 = r1.equals(r2)
            ...
            org.spongycastle.asn1.x9.X9ECParameters r0 = org.spongycastle.crypto.p023ec.CustomNamedCurves.getByOID(r2)
            if (r0 != 0) goto L_0x014b
            org.spongycastle.asn1.x9.X9ECParameters r0 = org.spongycastle.asn1.p022x9.ECNamedCurveTable.getByOID(r2)
        L_0x014b:
        ...
        L_0x0167:
            org.spongycastle.asn1.ASN1Primitive r0 = r0.getParameters()
            org.spongycastle.asn1.x9.X9ECParameters r0 = org.spongycastle.asn1.p022x9.X9ECParameters.getInstance(r0)
