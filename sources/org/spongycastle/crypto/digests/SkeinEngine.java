...
public class SkeinEngine implements Memoable {
    ...
    private static class UbiTweak {
        ...
        public void advancePosition(int i) {
            if (this.extendedPosition) {
                long[] jArr = this.tweak;
                long[] jArr2 = {jArr[0] & TransactionInput.NO_SEQUENCE, (jArr[0] >>> 32) & TransactionInput.NO_SEQUENCE, jArr[1] & TransactionInput.NO_SEQUENCE};
                long j = (long) i;
                ...
                jArr3[0] = ((jArr2[1] & TransactionInput.NO_SEQUENCE) << 32) | (jArr2[0] & TransactionInput.NO_SEQUENCE);
                jArr3[1] = (jArr3[1] & -4294967296L) | (jArr2[2] & TransactionInput.NO_SEQUENCE);
                return;
            }
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        sb.append(this.outputSizeBytes);
        sb.append(" bytes");
