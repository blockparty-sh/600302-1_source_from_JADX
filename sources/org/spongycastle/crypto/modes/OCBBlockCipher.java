...
public class OCBBlockCipher implements AEADBlockCipher {
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (bArr.length <= 15) {
            ...
            this.f1249L = new Vector();
            this.f1249L.addElement(OCB_double(this.L_Dollar));
            ...
            if (i2 == 0) {
                ...
                for (int i5 = 0; i5 < 16; i5++) {
                    ...
                    byte b = bArr3[i4] & 255;
                    i4++;
                    this.OffsetMAIN_0[i5] = (byte) (((bArr3[i4] & 255) >>> (8 - i2)) | (b << i2));
                }
            }
            this.hashBlockPos = 0;
            this.mainBlockPos = 0;
    ...
    public byte[] getLSub(int i) {
        while (i >= this.f1249L.size()) {
            Vector vector = this.f1249L;
            vector.addElement(OCB_double((byte[]) vector.lastElement()));
        }
        return (byte[]) this.f1249L.elementAt(i);
    }
