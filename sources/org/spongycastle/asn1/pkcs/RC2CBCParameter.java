...
public class RC2CBCParameter extends ASN1Object {
    ...
    public RC2CBCParameter(byte[] bArr) {
        this.version = null;
        this.f871iv = new DEROctetString(bArr);
    }
    ...
    private RC2CBCParameter(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 1) {
            this.version = null;
            this.f871iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
            return;
        }
        this.version = (ASN1Integer) aSN1Sequence.getObjectAt(0);
        this.f871iv = (ASN1OctetString) aSN1Sequence.getObjectAt(1);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f871iv);
