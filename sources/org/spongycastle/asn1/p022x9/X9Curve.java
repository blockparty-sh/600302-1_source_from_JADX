...
public class X9Curve extends ASN1Object implements X9ObjectIdentifiers {
    ...
    public X9Curve(X9FieldID x9FieldID, ASN1Sequence aSN1Sequence) {
        ...
        if (this.fieldIdentifier.equals(prime_field)) {
            ...
            this.curve = new C3639Fp(value, new X9FieldElement(value, (ASN1OctetString) aSN1Sequence.getObjectAt(0)).getValue().toBigInteger(), new X9FieldElement(value, (ASN1OctetString) aSN1Sequence.getObjectAt(1)).getValue().toBigInteger());
            ...
            int i6 = i3;
            int i7 = i2;
            X9FieldElement x9FieldElement = new X9FieldElement(i4, i5, i6, i7, (ASN1OctetString) aSN1Sequence.getObjectAt(0));
            X9FieldElement x9FieldElement2 = new X9FieldElement(i4, i5, i6, i7, (ASN1OctetString) aSN1Sequence.getObjectAt(1));
            F2m f2m = new F2m(i4, i5, i6, i7, x9FieldElement.getValue().toBigInteger(), x9FieldElement2.getValue().toBigInteger());
            this.curve = f2m;
        } else {
