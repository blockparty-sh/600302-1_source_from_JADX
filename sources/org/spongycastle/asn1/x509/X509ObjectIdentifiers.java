...
public interface X509ObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_ad_caIssuers = id_ad.branch(ExifInterface.GPS_MEASUREMENT_2D);
    ...
    static {
        String str = "1";
        id_pe = id_pkix.branch(str);
        id_ad_ocsp = id_ad.branch(str);
    }
}
