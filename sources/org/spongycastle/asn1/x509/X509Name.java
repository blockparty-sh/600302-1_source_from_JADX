...
public class X509Name extends ASN1Object {
    ...
    /* renamed from: C */
    public static final ASN1ObjectIdentifier f906C = new ASN1ObjectIdentifier("2.5.4.6");

    /* renamed from: CN */
    public static final ASN1ObjectIdentifier f907CN = new ASN1ObjectIdentifier("2.5.4.3");
    ...
    /* renamed from: DC */
    public static final ASN1ObjectIdentifier f908DC = new ASN1ObjectIdentifier("0.9.2342.19200300.100.1.25");
    ...
    /* renamed from: E */
    public static final ASN1ObjectIdentifier f909E = EmailAddress;
    ...
    /* renamed from: L */
    public static final ASN1ObjectIdentifier f910L = new ASN1ObjectIdentifier("2.5.4.7");
    public static final ASN1ObjectIdentifier NAME = X509ObjectIdentifiers.id_at_name;
    public static final ASN1ObjectIdentifier NAME_AT_BIRTH = new ASN1ObjectIdentifier("1.3.36.8.3.14");

    /* renamed from: O */
    public static final ASN1ObjectIdentifier f911O = new ASN1ObjectIdentifier("2.5.4.10");
    public static final Hashtable OIDLookUp = DefaultSymbols;

    /* renamed from: OU */
    public static final ASN1ObjectIdentifier f912OU = new ASN1ObjectIdentifier("2.5.4.11");
    ...
    public static final ASN1ObjectIdentifier SERIALNUMBER = f913SN;

    /* renamed from: SN */
    public static final ASN1ObjectIdentifier f913SN = new ASN1ObjectIdentifier("2.5.4.5");

    /* renamed from: ST */
    public static final ASN1ObjectIdentifier f914ST = new ASN1ObjectIdentifier("2.5.4.8");
    public static final ASN1ObjectIdentifier STREET = new ASN1ObjectIdentifier("2.5.4.9");
    public static final ASN1ObjectIdentifier SURNAME = new ASN1ObjectIdentifier("2.5.4.4");
    public static final Hashtable SymbolLookUp = DefaultLookUp;

    /* renamed from: T */
    public static final ASN1ObjectIdentifier f915T = new ASN1ObjectIdentifier("2.5.4.12");
    ...
    static {
        String str = "C";
        DefaultSymbols.put(f906C, str);
        String str2 = "O";
        DefaultSymbols.put(f911O, str2);
        DefaultSymbols.put(f915T, ExifInterface.GPS_DIRECTION_TRUE);
        String str3 = "OU";
        DefaultSymbols.put(f912OU, str3);
        String str4 = "CN";
        DefaultSymbols.put(f907CN, str4);
        String str5 = "L";
        DefaultSymbols.put(f910L, str5);
        String str6 = "ST";
        DefaultSymbols.put(f914ST, str6);
        DefaultSymbols.put(f913SN, "SERIALNUMBER");
        DefaultSymbols.put(EmailAddress, ExifInterface.LONGITUDE_EAST);
        String str7 = "DC";
        DefaultSymbols.put(f908DC, str7);
        String str8 = "UID";
        DefaultSymbols.put(UID, str8);
        String str9 = "STREET";
        DefaultSymbols.put(STREET, str9);
        ...
        RFC2253Symbols.put(f906C, str);
        RFC2253Symbols.put(f911O, str2);
        RFC2253Symbols.put(f912OU, str3);
        RFC2253Symbols.put(f907CN, str4);
        RFC2253Symbols.put(f910L, str5);
        RFC2253Symbols.put(f914ST, str6);
        RFC2253Symbols.put(STREET, str9);
        RFC2253Symbols.put(f908DC, str7);
        RFC2253Symbols.put(UID, str8);
        RFC1779Symbols.put(f906C, str);
        RFC1779Symbols.put(f911O, str2);
        RFC1779Symbols.put(f912OU, str3);
        RFC1779Symbols.put(f907CN, str4);
        RFC1779Symbols.put(f910L, str5);
        RFC1779Symbols.put(f914ST, str6);
        RFC1779Symbols.put(STREET, str9);
        DefaultLookUp.put("c", f906C);
        DefaultLookUp.put("o", f911O);
        DefaultLookUp.put("t", f915T);
        DefaultLookUp.put("ou", f912OU);
        DefaultLookUp.put("cn", f907CN);
        DefaultLookUp.put("l", f910L);
        DefaultLookUp.put("st", f914ST);
        DefaultLookUp.put("sn", f913SN);
        DefaultLookUp.put("serialnumber", f913SN);
        DefaultLookUp.put("street", STREET);
        DefaultLookUp.put("emailaddress", f909E);
        DefaultLookUp.put("dc", f908DC);
        DefaultLookUp.put("e", f909E);
    ...
    private void appendValue(StringBuffer stringBuffer, Hashtable hashtable, ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        int i;
        String str2;
        String str3 = (String) hashtable.get(aSN1ObjectIdentifier);
        if (str3 != null) {
