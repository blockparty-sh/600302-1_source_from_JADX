...
public class SecP384R1Field {
    ...
    /* renamed from: M */
    private static final long f1406M = 4294967295L;

    /* renamed from: P */
    static final int[] f1407P = {-1, 0, 0, -1, -2, -1, -1, -1, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat.add(12, iArr, iArr2, iArr3) != 0 || (iArr3[11] == -1 && Nat.gte(12, iArr3, f1407P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(12, iArr, iArr2) != 0 || (iArr2[11] == -1 && Nat.gte(12, iArr2, f1407P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (fromBigInteger[11] == -1 && Nat.gte(12, fromBigInteger, f1407P)) {
            Nat.subFrom(12, f1407P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(12, iArr2, Nat.add(12, iArr, f1407P, iArr2));
        }
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j15 = j3 - j7;
        long j16 = j5 - j7;
        long j17 = (((long) iArr[0]) & 4294967295L) + j9 + j15 + 0;
        iArr3[0] = (int) j17;
        long j18 = (j17 >> 32) + (((((long) iArr[1]) & 4294967295L) + j7) - j9) + j11;
        iArr3[1] = (int) j18;
        long j19 = (j18 >> 32) + (((((long) iArr[2]) & 4294967295L) - j3) - j11) + j12;
        iArr3[2] = (int) j19;
        long j20 = (j19 >> 32) + (((((long) iArr[3]) & 4294967295L) + j9) - j12) + j13 + j15;
        iArr3[3] = (int) j20;
        long j21 = (j20 >> 32) + ((((((((long) iArr[4]) & 4294967295L) + j8) + j3) + j9) + j11) - j13) + j15;
        iArr3[4] = (int) j21;
        long j22 = (j21 >> 32) + ((((long) iArr[5]) & 4294967295L) - j8) + j11 + j12 + j14;
        iArr3[5] = (int) j22;
        long j23 = (j22 >> 32) + (((((long) iArr[6]) & 4294967295L) + j6) - j) + j12 + j13;
        iArr3[6] = (int) j23;
        long j24 = (j23 >> 32) + ((((((long) iArr[7]) & 4294967295L) + j8) + j4) - j6) + j13;
        iArr3[7] = (int) j24;
        long j25 = (j24 >> 32) + (((((((long) iArr[8]) & 4294967295L) + j8) + j) + j10) - j4);
        iArr3[8] = (int) j25;
        long j26 = (j25 >> 32) + (((((long) iArr[9]) & 4294967295L) + j6) - j10) + j14;
        iArr3[9] = (int) j26;
        long j27 = (j26 >> 32) + ((((((long) iArr[10]) & 4294967295L) + j6) + j4) - j15) + j16;
        iArr3[10] = (int) j27;
        long j28 = (j27 >> 32) + ((((((long) iArr[11]) & 4294967295L) + j4) + j10) - j16);
        iArr3[11] = (int) j28;
        reduce32((int) ((j28 >> 32) + 1), iArr3);
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if ((j != 0 && Nat.incAt(12, iArr, 5) != 0) || (iArr[11] == -1 && Nat.gte(12, iArr, f1407P))) {
            addPInvTo(iArr);
        }
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(12, iArr, 0, iArr2) != 0 || (iArr2[11] == -1 && Nat.gte(12, iArr2, f1407P))) {
            addPInvTo(iArr2);
        }
    }
