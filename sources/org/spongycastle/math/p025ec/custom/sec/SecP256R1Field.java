...
public class SecP256R1Field {
    ...
    /* renamed from: M */
    private static final long f1400M = 4294967295L;

    /* renamed from: P */
    static final int[] f1401P = {-1, -1, -1, 0, 0, 0, 1, -1};

    /* renamed from: P7 */
    private static final int f1402P7 = -1;
    static final int[] PExt = {1, 0, 0, -2, -1, -1, -2, 1, -2, 1, -2, 1, 1, -2, 2, -2};
    private static final int PExt15 = -1;

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.add(iArr, iArr2, iArr3) != 0 || (iArr3[7] == -1 && Nat256.gte(iArr3, f1401P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(8, iArr, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1401P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (fromBigInteger[7] == -1 && Nat256.gte(fromBigInteger, f1401P)) {
            Nat256.subFrom(f1401P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(8, iArr2, Nat256.add(iArr, f1401P, iArr2));
        }
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j15 = j6 + j7;
        long j16 = j8;
        long j17 = ((((((long) iArr[0]) & 4294967295L) + j9) - j12) - j14) + 0;
        iArr3[0] = (int) j17;
        long j18 = (j17 >> 32) + ((((((long) iArr[1]) & 4294967295L) + j10) - j13) - j15);
        iArr3[1] = (int) j18;
        long j19 = (j18 >> 32) + (((((long) iArr[2]) & 4294967295L) + j11) - j14);
        iArr3[2] = (int) j19;
        long j20 = (j19 >> 32) + (((((((long) iArr[3]) & 4294967295L) + (j12 << 1)) + j5) - j7) - j9);
        iArr3[3] = (int) j20;
        long j21 = (j20 >> 32) + ((((((long) iArr[4]) & 4294967295L) + (j13 << 1)) + j6) - j10);
        iArr3[4] = (int) j21;
        long j22 = (j21 >> 32) + (((((long) iArr[5]) & 4294967295L) + (j14 << 1)) - j11);
        iArr3[5] = (int) j22;
        long j23 = (j22 >> 32) + ((((((long) iArr[6]) & 4294967295L) + (j15 << 1)) + j14) - j9);
        iArr3[6] = (int) j23;
        long j24 = (j23 >> 32) + (((((((long) iArr[7]) & 4294967295L) + (j7 << 1)) + j16) - j11) - j13);
        iArr3[7] = (int) j24;
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (j != 0 || (iArr[7] == -1 && Nat256.gte(iArr, f1401P))) {
            addPInvTo(iArr);
        }
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(8, iArr, 0, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1401P))) {
            addPInvTo(iArr2);
        }
    }
