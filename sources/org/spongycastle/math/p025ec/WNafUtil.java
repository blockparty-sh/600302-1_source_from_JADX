...
public abstract class WNafUtil {
    ...
    public static ECPoint mapPointWithPrecomp(ECPoint eCPoint, int i, boolean z, ECPointMap eCPointMap) {
        ...
        String str = PRECOMP_NAME;
        WNafPreCompInfo wNafPreCompInfo = getWNafPreCompInfo(curve.getPreCompInfo(map, str));
        ...
        curve.setPreCompInfo(map, str, wNafPreCompInfo);
        return map;
    }
    ...
    public static WNafPreCompInfo precompute(ECPoint eCPoint, int i, boolean z) {
        ECCurve curve = eCPoint.getCurve();
        String str = PRECOMP_NAME;
        WNafPreCompInfo wNafPreCompInfo = getWNafPreCompInfo(curve.getPreCompInfo(eCPoint, str));
        ...
        curve.setPreCompInfo(eCPoint, str, wNafPreCompInfo);
