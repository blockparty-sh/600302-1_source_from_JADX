...
public class FixedPointUtil {
    ...
    public static FixedPointPreCompInfo precompute(ECPoint eCPoint, int i) {
        ...
        FixedPointPreCompInfo fixedPointPreCompInfo = getFixedPointPreCompInfo(curve.getPreCompInfo(eCPoint, str));
        ...
        if (preComp == null || preComp.length < i2) {
            ...
            curve.setPreCompInfo(eCPoint, str, fixedPointPreCompInfo);
        }
