...
class LongArray {
    private static final int[] INTERLEAVE2_TABLE = {0, 1, 4, 5, 16, 17, 20, 21, 64, 65, 68, 69, 80, 81, 84, 85, 256, InputDeviceCompat.SOURCE_KEYBOARD, 260, 261, 272, 273, 276, 277, 320, 321, 324, 325, 336, 337, 340, 341, 1024, InputDeviceCompat.SOURCE_GAMEPAD, 1028, 1029, 1040, 1041, 1044, 1045, 1088, 1089, 1092, 1093, 1104, 1105, 1108, 1109, 1280, 1281, 1284, 1285, 1296, 1297, 1300, 1301, 1344, 1345, 1348, 1349, 1360, 1361, 1364, 1365, 4096, FragmentTransaction.TRANSIT_FRAGMENT_OPEN, 4100, 4101, 4112, 4113, 4116, 4117, 4160, 4161, 4164, 4165, 4176, 4177, 4180, 4181, 4352, 4353, 4356, 4357, 4368, ShadowLayout.ALL, 4372, 4373, 4416, 4417, 4420, 4421, 4432, 4433, 4436, 4437, 5120, 5121, 5124, 5125, 5136, 5137, 5140, 5141, 5184, 5185, 5188, 5189, 5200, 5201, 5204, 5205, 5376, 5377, 5380, 5381, 5392, 5393, 5396, 5397, 5440, 5441, 5444, 5445, 5456, 5457, 5460, 5461, 16384, 16385, 16388, 16389, 16400, 16401, 16404, 16405, 16448, 16449, 16452, 16453, 16464, 16465, 16468, 16469, 16640, 16641, 16644, 16645, 16656, 16657, 16660, 16661, 16704, 16705, 16708, 16709, 16720, 16721, 16724, 16725, 17408, 17409, 17412, 17413, 17424, 17425, 17428, 17429, 17472, 17473, 17476, 17477, 17488, 17489, 17492, 17493, 17664, 17665, 17668, 17669, 17680, 17681, 17684, 17685, 17728, 17729, 17732, 17733, 17744, 17745, 17748, 17749, 20480, 20481, 20484, 20485, 20496, 20497, 20500, 20501, 20544, 20545, 20548, 20549, 20560, 20561, 20564, 20565, 20736, 20737, 20740, 20741, 20752, 20753, 20756, 20757, 20800, 20801, 20804, 20805, 20816, 20817, 20820, 20821, 21504, 21505, 21508, 21509, 21520, 21521, 21524, 21525, 21568, 21569, 21572, 21573, 21584, 21585, 21588, 21589, 21760, 21761, 21764, 21765, 21776, 21777, 21780, 21781, 21824, 21825, 21828, 21829, 21840, 21841, 21844, 21845};
    ...
    private static int bitLength(long r3) {
        ...
        L_0x002e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.math.p025ec.LongArray.bitLength(long):int");
    }
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        for (int i10 = 56; i10 >= 0; i10 -= 8) {
            ...
            while (i11 < i4) {
                ...
                int i14 = (i12 >>> 4) & 15;
                int i15 = i11;
                addBoth(jArr7, i11 - 1, jArr4, iArr3[i13], jArr5, iArr3[i14], i7);
                i11 = i15 + 2;
            }
        ...
        for (int i16 = 56; i16 >= 0; i16 -= 8) {
            ...
            while (i17 < i4) {
                ...
                int i20 = (i18 >>> 4) & 15;
                int i21 = i17;
                addBoth(jArr7, i17, jArr4, iArr3[i19], jArr5, iArr3[i20], i7);
                i17 = i21 + 2;
            }
            if (i16 > 0) {
                shiftUp(jArr7, 0, i6, 8);
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        for (int i10 = 0; i10 < i4; i10++) {
            ...
            while (true) {
                ...
                int i12 = ((int) j3) & 15;
                long j4 = j3;
                addBoth(jArr7, i11, jArr4, iArr3[((int) j2) & 15], jArr5, iArr3[i12], i7);
                j2 = j4 >>> 4;
                if (j2 == 0) {
                    break;
                }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        long[] jArr2 = new long[(i11 + i6 + 1)];
        long[] jArr3 = longArray3.m_ints;
        long[] jArr4 = jArr2;
        int[] iArr4 = iArr3;
        int i13 = i9;
        interleave(jArr3, 0, jArr4, 0, i4, 4);
        System.arraycopy(longArray2.m_ints, 0, jArr4, i4, i5);
        int i14 = i4;
        int i15 = 1;
        while (i15 < 8) {
            int i16 = i14 + i8;
            shiftUp(jArr4, i4, jArr4, i16, i8, i15);
            i15++;
            i14 = i16;
        }
        int i17 = 0;
        while (true) {
            int i18 = 0;
            do {
                long j2 = jArr4[i18] >>> i17;
                int i19 = i4;
                int i20 = 0;
                while (true) {
                    int i21 = ((int) j2) & i7;
                    if (i21 != 0) {
                        add(jArr4, iArr4[i21] + i18, jArr4, i19, i8);
                    }
                    i20++;
                    if (i20 == 8) {
                        break;
        ...
        while (true) {
            length--;
            if (length <= 1) {
                return reduceResult(jArr4, iArr4[1], i6, i2, iArr2);
            }
            if ((((long) length) & 1) == 0) {
                addShiftedUp(jArr4, iArr4[length >>> 1], jArr4, iArr4[length], i6, 16);
            } else {
                distribute(jArr4, iArr4[length], iArr4[length - 1], iArr4[1], i6);
            }
        }
    }
    ...
    public LongArray multiply(LongArray longArray, int i, int[] iArr) {
        ...
        for (int i9 = 0; i9 < i3; i9++) {
            ...
            while (true) {
                ...
                int i11 = ((int) j3) & 15;
                long j4 = j3;
                addBoth(jArr7, i10, jArr4, iArr2[((int) j2) & 15], jArr5, iArr2[i11], i6);
                j2 = j4 >>> 4;
                if (j2 == 0) {
                    break;
                }
    ...
    private static long interleave3_21to63(int i) {
        ...
        int i2 = iArr[i & 127];
        int i3 = iArr[(i >>> 7) & 127];
        return (((long) i2) & TransactionInput.NO_SEQUENCE) | ((((long) iArr[i >>> 14]) & TransactionInput.NO_SEQUENCE) << 42) | ((((long) i3) & TransactionInput.NO_SEQUENCE) << 21);
    }
    ...
    private static long interleave3_13to65(int i) {
        ...
        return (((long) iArr[i & 127]) & TransactionInput.NO_SEQUENCE) | ((((long) iArr[i >>> 7]) & TransactionInput.NO_SEQUENCE) << 35);
    }
    ...
    private static long interleave4_16to64(int i) {
        ...
        return (((long) iArr[i & 255]) & TransactionInput.NO_SEQUENCE) | ((((long) iArr[i >>> 8]) & TransactionInput.NO_SEQUENCE) << 32);
    }

    private static long interleave2_32to64(int i) {
        int[] iArr = INTERLEAVE2_TABLE;
        int i2 = iArr[i & 255] | (iArr[(i >>> 8) & 255] << 16);
        int i3 = iArr[(i >>> 16) & 255];
        return (((long) i2) & TransactionInput.NO_SEQUENCE) | ((((long) ((iArr[i >>> 24] << 16) | i3)) & TransactionInput.NO_SEQUENCE) << 32);
    }
    ...
    public LongArray modInverse(int i, int[] iArr) {
        ...
        if (degree == 0) {
            ...
            int[] iArr3 = {1, 0};
            LongArray[] longArrayArr2 = {longArray3, new LongArray(i2)};
            int i3 = iArr2[1];
            int i4 = i3 - iArr2[0];
            int i5 = iArr3[1];
            int i6 = i3;
            ...
            while (true) {
                ...
                int i8 = 1 - i7;
                longArrayArr[i7].addShiftedByBitsSafe(longArrayArr[i8], iArr2[i8], i4);
                int degreeFrom = longArrayArr[i7].degreeFrom(i6);
                if (degreeFrom == 0) {
                    return longArrayArr2[i8];
                }
                int i9 = iArr3[i8];
                longArrayArr2[i7].addShiftedByBitsSafe(longArrayArr2[i8], i9, i4);
                int i10 = i9 + i4;
                if (i10 > i5) {
                    i5 = i10;
                } else if (i10 == i5) {
                    i5 = longArrayArr2[i7].degreeFrom(i5);
                }
                i4 += degreeFrom - i6;
                i6 = degreeFrom;
            }
