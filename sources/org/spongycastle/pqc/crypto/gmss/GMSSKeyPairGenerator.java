...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            bArr[i4] = (byte[][]) Array.newInstance(byte.class, new int[]{this.heightOfTrees[i4], this.mdLength});
            int[] iArr = this.heightOfTrees;
            treehashArr[i4] = new Treehash[(iArr[i4] - this.f1438K[i4])];
            if (i4 > 0) {
                int i5 = i4 - 1;
                bArr2[i5] = (byte[][]) Array.newInstance(byte.class, new int[]{iArr[i4], this.mdLength});
                treehashArr2[i5] = new Treehash[(this.heightOfTrees[i4] - this.f1438K[i4])];
            }
        ...
        byte[][] bArr3 = (byte[][]) Array.newInstance(byte.class, new int[]{i, this.mdLength});
        byte[][] bArr4 = (byte[][]) Array.newInstance(byte.class, new int[]{this.numLayer - 1, this.mdLength});
        ...
        while (i7 >= 0) {
            GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i7], this.f1438K[i7], this.digestProvider);
            try {
                if (i7 == this.numLayer - 1) {
                    generateCurrentAuthpathAndRoot = generateCurrentAuthpathAndRoot(null, vectorArr[i7], bArr5[i7], i7);
                } else {
                    generateCurrentAuthpathAndRoot = generateCurrentAuthpathAndRoot(bArr3[i7 + 1], vectorArr[i7], bArr5[i7], i7);
                }
                gMSSRootCalc = generateCurrentAuthpathAndRoot;
            } catch (Exception e) {
                e.printStackTrace();
        ...
        while (i9 >= 0) {
            ...
            System.arraycopy(generateNextAuthpathAndRoot.getRoot(), 0, bArr7[i9], 0, this.mdLength);
        ...
        byte[][] bArr11 = this.currentSeeds;
        byte[][] bArr12 = this.nextNextSeeds;
        byte[][] bArr13 = this.currentRootSigs;
        ...
        GMSSPrivateKeyParameters gMSSPrivateKeyParameters2 = new GMSSPrivateKeyParameters(bArr11, bArr12, bArr10, bArr2, treehashArr, treehashArr2, vectorArr7, vectorArr2, vectorArr10, vectorArr4, bArr7, bArr13, gMSSParameters, gMSSDigestProvider);
    ...
    private GMSSRootCalc generateCurrentAuthpathAndRoot(byte[] bArr, Vector vector, byte[] bArr2, int i) {
        ...
        GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i], this.f1438K[i], this.digestProvider);
        ...
        while (true) {
            ...
            if (i3 == i4 && i5 < iArr[i] - this.f1438K[i]) {
    ...
    private GMSSRootCalc generateNextAuthpathAndRoot(Vector vector, byte[] bArr, int i) {
        ...
        while (true) {
            ...
            if (i2 == i3 && i4 < iArr[i] - this.f1438K[i]) {
