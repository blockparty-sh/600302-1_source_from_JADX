...
public class GMSSRootCalc {
    ...
    public GMSSRootCalc(int i, int i2, GMSSDigestProvider gMSSDigestProvider) {
        ...
        this.retain = new Vector[(this.f1444K - 1)];
    ...
    public void initialize(Vector vector) {
        int i;
        this.treehash = new Treehash[(this.heightOfTree - this.f1444K)];
        int i2 = 0;
        while (true) {
            i = this.heightOfTree;
            if (i2 >= i - this.f1444K) {
        ...
        this.retain = new Vector[(this.f1444K - 1)];
        for (int i4 = 0; i4 < this.f1444K - 1; i4++) {
    ...
    public void update(byte[] bArr, byte[] bArr2) {
        ...
        if (i < this.heightOfTree - this.f1444K && this.indexForNextSeed - 2 == this.index[0]) {
    ...
    public void update(byte[] bArr) {
        if (this.isFinished) {
            ...
            } else if (iArr[0] == 3 && this.heightOfTree > this.f1444K) {
                this.treehash[0].setFirstNode(bArr);
            }
            int[] iArr2 = this.index;
            if ((iArr2[0] - 3) % 2 == 0 && iArr2[0] >= 3 && this.heightOfTree == this.f1444K) {
            ...
            if (this.index[0] == 0) {
                ...
                while (this.tailStack.size() > 0 && i2 == ((Integer) this.heightOfNodes.lastElement()).intValue()) {
                    ...
                    if (i2 < this.heightOfTree) {
                        ...
                        if (i2 >= this.heightOfTree - this.f1444K) {
                            if (i2 == 0) {
                                System.out.println("M���P");
                            }
                            int[] iArr4 = this.index;
                            if ((iArr4[i2] - 3) % 2 == 0 && iArr4[i2] >= 3) {
                                this.retain[i2 - (this.heightOfTree - this.f1444K)].insertElementAt(bArr2, 0);
                            }
    ...
    public byte[][] getStatByte() {
        ...
        byte[][] bArr = (byte[][]) Array.newInstance(byte.class, new int[]{this.heightOfTree + 1 + i, 64});
        bArr[0] = this.root;
        int i2 = 0;
