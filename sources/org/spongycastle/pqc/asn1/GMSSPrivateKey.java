...
public class GMSSPrivateKey extends ASN1Object {
    ...
    public GMSSPrivateKey(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, byte[][][] bArr5, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier algorithmIdentifier) {
        ...
        this.primitive = encode(iArr3, bArr8, bArr9, bArr10, bArr11, bArr12, treehashArr3, treehashArr4, vectorArr5, vectorArr6, vectorArr7, vectorArr8, gMSSLeafArr4, gMSSLeafArr5, gMSSLeafArr6, iArr4, bArr13, gMSSRootCalcArr2, bArr14, gMSSRootSigArr2, gMSSParameters2, algorithmIdentifierArr2);
    }
    ...
    private ASN1Primitive encode(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier[] algorithmIdentifierArr) {
        ...
        while (i29 < gMSSRootCalcArr2.length) {
            ...
            if (gMSSRootCalcArr2[i29].getTreehash() != null) {
                ...
                while (i36 < gMSSRootCalcArr2[i29].getTreehash().length) {
                    ...
                    ASN1EncodableVector aSN1EncodableVector90 = aSN1EncodableVector81;
                    ...
                    aSN1EncodableVector81 = aSN1EncodableVector90;
                    algorithmIdentifierArr3 = algorithmIdentifierArr;
                    aSN1EncodableVector68 = aSN1EncodableVector91;
                }
            }
            ASN1EncodableVector aSN1EncodableVector92 = aSN1EncodableVector68;
            ASN1EncodableVector aSN1EncodableVector93 = aSN1EncodableVector80;
            ASN1EncodableVector aSN1EncodableVector94 = aSN1EncodableVector81;
            ...
            if (gMSSRootCalcArr2[i29].getRetain() != null) {
                ASN1EncodableVector aSN1EncodableVector96 = aSN1EncodableVector95;
                for (int i40 = 0; i40 < gMSSRootCalcArr2[i29].getRetain().length; i40++) {
                    for (int i41 = 0; i41 < gMSSRootCalcArr2[i29].getRetain()[i40].size(); i41++) {
                        aSN1EncodableVector96.add(new DEROctetString((byte[]) gMSSRootCalcArr2[i29].getRetain()[i40].elementAt(i41)));
                    }
                    aSN1EncodableVector76.add(new DERSequence(aSN1EncodableVector96));
            ...
            i29++;
            aSN1EncodableVector77 = aSN1EncodableVector93;
            aSN1EncodableVector78 = aSN1EncodableVector94;
            algorithmIdentifierArr3 = algorithmIdentifierArr;
            aSN1EncodableVector68 = aSN1EncodableVector92;
        }
        ASN1EncodableVector aSN1EncodableVector97 = aSN1EncodableVector68;
        DERSequence dERSequence = new DERSequence(aSN1EncodableVector71);
        ASN1EncodableVector aSN1EncodableVector98 = aSN1EncodableVector97;
        aSN1EncodableVector98.add(dERSequence);
        ASN1EncodableVector aSN1EncodableVector99 = new ASN1EncodableVector();
        byte[][] bArr18 = bArr7;
        for (byte[] dEROctetString7 : bArr18) {
            aSN1EncodableVector99.add(new DEROctetString(dEROctetString7));
        }
        aSN1EncodableVector98.add(new DERSequence(aSN1EncodableVector99));
        ...
        ASN1EncodableVector aSN1EncodableVector104 = aSN1EncodableVector101;
        GMSSRootSig[] gMSSRootSigArr2 = gMSSRootSigArr;
        for (int i42 = 0; i42 < gMSSRootSigArr2.length; i42++) {
            aSN1EncodableVector104.add(new DERSequence((ASN1Encodable) algorithmIdentifierArr[0]));
            new ASN1EncodableVector();
            aSN1EncodableVector102.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[0]));
            aSN1EncodableVector102.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[1]));
            aSN1EncodableVector102.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[2]));
            aSN1EncodableVector102.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[3]));
            aSN1EncodableVector102.add(new DEROctetString(gMSSRootSigArr2[i42].getStatByte()[4]));
            aSN1EncodableVector104.add(new DERSequence(aSN1EncodableVector102));
            aSN1EncodableVector102 = new ASN1EncodableVector();
            aSN1EncodableVector103.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[0]));
            aSN1EncodableVector103.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[1]));
            aSN1EncodableVector103.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[2]));
            aSN1EncodableVector103.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[3]));
            aSN1EncodableVector103.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[4]));
            aSN1EncodableVector103.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[5]));
            aSN1EncodableVector103.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[6]));
            aSN1EncodableVector103.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[7]));
            aSN1EncodableVector103.add(new ASN1Integer((long) gMSSRootSigArr2[i42].getStatInt()[8]));
            aSN1EncodableVector104.add(new DERSequence(aSN1EncodableVector103));
            aSN1EncodableVector103 = new ASN1EncodableVector();
            aSN1EncodableVector100.add(new DERSequence(aSN1EncodableVector104));
            aSN1EncodableVector104 = new ASN1EncodableVector();
        }
        AlgorithmIdentifier[] algorithmIdentifierArr4 = algorithmIdentifierArr;
        aSN1EncodableVector98.add(new DERSequence(aSN1EncodableVector100));
        ...
        ASN1EncodableVector aSN1EncodableVector108 = new ASN1EncodableVector();
        for (int i43 = 0; i43 < gMSSParameters.getHeightOfTrees().length; i43++) {
            aSN1EncodableVector106.add(new ASN1Integer((long) gMSSParameters.getHeightOfTrees()[i43]));
            aSN1EncodableVector107.add(new ASN1Integer((long) gMSSParameters.getWinternitzParameter()[i43]));
            aSN1EncodableVector108.add(new ASN1Integer((long) gMSSParameters.getK()[i43]));
        }
        aSN1EncodableVector105.add(new ASN1Integer((long) gMSSParameters.getNumOfLayers()));
        aSN1EncodableVector105.add(new DERSequence(aSN1EncodableVector106));
        aSN1EncodableVector105.add(new DERSequence(aSN1EncodableVector107));
        aSN1EncodableVector105.add(new DERSequence(aSN1EncodableVector108));
        aSN1EncodableVector98.add(new DERSequence(aSN1EncodableVector105));
        ASN1EncodableVector aSN1EncodableVector109 = new ASN1EncodableVector();
        for (AlgorithmIdentifier add : algorithmIdentifierArr4) {
            aSN1EncodableVector109.add(add);
        }
        aSN1EncodableVector98.add(new DERSequence(aSN1EncodableVector109));
        return new DERSequence(aSN1EncodableVector98);
    }
