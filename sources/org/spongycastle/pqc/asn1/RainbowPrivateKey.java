...
public class RainbowPrivateKey extends ASN1Object {
    ...
    /* renamed from: b1 */
    private byte[] f1435b1;

    /* renamed from: b2 */
    private byte[] f1436b2;
    private byte[][] invA1;
    private byte[][] invA2;
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f1435b1 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence2.getObjectAt(2)).getObjectAt(0)).getOctets();
        ...
        this.f1436b2 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence2.getObjectAt(4)).getObjectAt(0)).getOctets();
        this.f1437vi = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence2.getObjectAt(5)).getObjectAt(0)).getOctets();
        ...
        int length = this.f1437vi.length - 1;
        this.layers = new Layer[length];
        int i10 = 0;
        while (i10 < length) {
            byte[] bArr5 = this.f1437vi;
            int i11 = i10 + 1;
            Layer layer = new Layer(bArr5[i10], bArr5[i11], RainbowUtil.convertArray(bArr[i10]), RainbowUtil.convertArray(bArr2[i10]), RainbowUtil.convertArray(bArr3[i10]), RainbowUtil.convertArray(bArr4[i10]));
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f1435b1 = RainbowUtil.convertArray(sArr2);
        this.invA2 = RainbowUtil.convertArray(sArr3);
        this.f1436b2 = RainbowUtil.convertArray(sArr4);
        this.f1437vi = RainbowUtil.convertIntArray(iArr);
    ...
    public short[] getB1() {
        return RainbowUtil.convertArray(this.f1435b1);
    }

    public short[] getB2() {
        return RainbowUtil.convertArray(this.f1436b2);
    }
    ...
    public int[] getVi() {
        return RainbowUtil.convertArraytoInt(this.f1437vi);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector3.add(new DEROctetString(this.f1435b1));
        ...
        aSN1EncodableVector5.add(new DEROctetString(this.f1436b2));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector5));
        ASN1EncodableVector aSN1EncodableVector6 = new ASN1EncodableVector();
        aSN1EncodableVector6.add(new DEROctetString(this.f1437vi));
