...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        /* renamed from: h */
        private GF2Matrix f1548h;

        /* renamed from: p */
        private Permutation f1549p;

        /* renamed from: s */
        private GF2Matrix f1550s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f1550s = gF2Matrix;
            this.f1548h = gF2Matrix2;
            this.f1549p = permutation;
        }
    ...
    public static class MatrixSet {
        ...
        /* renamed from: g */
        private GF2Matrix f1551g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f1551g = gF2Matrix;
            this.setJ = iArr;
        }
