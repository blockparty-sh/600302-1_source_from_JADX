...
public class IntegerPolynomial implements Polynomial {
    ...
    public Resultant resultant() {
        ...
        while (true) {
            ...
            mod = bigInteger2.multiply(calculate.f1554x.multiply(bigInteger3)).add(resultant.res.multiply(calculate.f1555y.multiply(bigInteger))).mod(multiply);
