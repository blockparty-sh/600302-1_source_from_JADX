...
public class SparseTernaryPolynomial implements TernaryPolynomial {
    ...
    public SparseTernaryPolynomial(int[] iArr) {
        this.f1561N = iArr.length;
        int i = this.f1561N;
        this.ones = new int[i];
        this.negOnes = new int[i];
        int i2 = 0;
        int i3 = 0;
        for (int i4 = 0; i4 < this.f1561N; i4++) {
            int i5 = iArr[i4];
            if (i5 == -1) {
                int i6 = i3 + 1;
                this.negOnes[i3] = i4;
    ...
    public BigIntPolynomial mult(BigIntPolynomial bigIntPolynomial) {
        ...
        if (length == i) {
            ...
            int i2 = 0;
            for (int i3 = 0; i3 < this.f1561N; i3++) {
    ...
    public int hashCode() {
        return ((((this.f1561N + 31) * 31) + Arrays.hashCode(this.negOnes)) * 31) + Arrays.hashCode(this.ones);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f1561N == sparseTernaryPolynomial.f1561N && Arrays.areEqual(this.negOnes, sparseTernaryPolynomial.negOnes) && Arrays.areEqual(this.ones, sparseTernaryPolynomial.ones);
    }
}
