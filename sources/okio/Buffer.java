...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public long readLong() {
        if (this.size >= 8) {
            ...
            int i2 = segment.limit;
            if (i2 - i < 8) {
                return ((((long) readInt()) & TransactionInput.NO_SEQUENCE) << 32) | (TransactionInput.NO_SEQUENCE & ((long) readInt()));
            }
            byte[] bArr = segment.data;
            int i3 = i + 1;
            int i4 = i3 + 1;
                ...
                if (charAt < 128) {
                    ...
                    if (charAt < 2048) {
                        ...
                        if (charAt > 56319 || c < 56320 || c > 57343) {
                            ...
                            writeByte((i8 >> 18) | TorDiscovery.RESOLVE_ERROR);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writeByte((i >> 18) | TorDiscovery.RESOLVE_ERROR);
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m329of(instance.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m329of(instance.doFinal());
        } catch (NoSuchAlgorithmException unused) {
            throw new AssertionError();
